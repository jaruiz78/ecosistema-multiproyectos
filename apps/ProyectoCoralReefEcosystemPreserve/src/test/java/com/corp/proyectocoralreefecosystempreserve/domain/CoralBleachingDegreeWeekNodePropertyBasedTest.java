package com.corp.proyectocoralreefecosystempreserve.domain;
...
class CoralBleachingDegreeWeekNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CoralBleachingDegreeWeekNode entity = new CoralBleachingDegreeWeekNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CoralBleachingDegreeWeekNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

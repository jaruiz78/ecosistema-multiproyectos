package com.corp.proyectocoralreefecosystempreserve.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CoralBleachingDegreeWeekNode.
 * 
 ...
 */
public record CoralBleachingDegreeWeekNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CoralBleachingDegreeWeekNode {
    ...
    public CoralBleachingDegreeWeekNode withStatus(String newStatus) {
        return new CoralBleachingDegreeWeekNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

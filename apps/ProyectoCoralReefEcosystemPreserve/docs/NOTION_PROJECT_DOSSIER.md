# 🏛️ NOTION DOSSIER: ProyectoCoralReefEcosystemPreserve

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCoralReefEcosystemPreserve
* **Entidad Dominio**: CoralBleachingDegreeWeekNode
* **Descripción**: Proteccion de Arrecifes de Coral y Mitigacion de Blanqueamiento por Estres Termico

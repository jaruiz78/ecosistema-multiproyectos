# 🏛️ NOTION DOSSIER: ProyectoThresholdBlsOracleNetwork

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoThresholdBlsOracleNetwork
* **Entidad Dominio**: BlsAggregatedSignatureDataFeedToken
* **Descripción**: Red de Oraculos Descentralizados con Firmas Umbral BLS Agregadas

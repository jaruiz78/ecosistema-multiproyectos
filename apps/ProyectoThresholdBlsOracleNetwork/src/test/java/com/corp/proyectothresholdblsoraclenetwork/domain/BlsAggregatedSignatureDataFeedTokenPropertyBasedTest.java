package com.corp.proyectothresholdblsoraclenetwork.domain;
...
class BlsAggregatedSignatureDataFeedTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BlsAggregatedSignatureDataFeedToken entity = new BlsAggregatedSignatureDataFeedToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BlsAggregatedSignatureDataFeedToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

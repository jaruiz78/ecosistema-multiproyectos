package com.corp.proyectothresholdblsoraclenetwork.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: BlsAggregatedSignatureDataFeedToken.
 * 
 ...
 */
public record BlsAggregatedSignatureDataFeedToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BlsAggregatedSignatureDataFeedToken {
    ...
    public BlsAggregatedSignatureDataFeedToken withStatus(String newStatus) {
        return new BlsAggregatedSignatureDataFeedToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

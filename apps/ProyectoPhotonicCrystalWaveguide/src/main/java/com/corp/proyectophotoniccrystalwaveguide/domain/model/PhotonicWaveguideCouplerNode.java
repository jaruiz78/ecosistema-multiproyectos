package com.corp.proyectophotoniccrystalwaveguide.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PhotonicWaveguideCouplerNode.
 * 
 ...
 */
public record PhotonicWaveguideCouplerNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PhotonicWaveguideCouplerNode {
    ...
    public PhotonicWaveguideCouplerNode withStatus(String newStatus) {
        return new PhotonicWaveguideCouplerNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectophotoniccrystalwaveguide.domain;
...
class PhotonicWaveguideCouplerNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PhotonicWaveguideCouplerNode entity = new PhotonicWaveguideCouplerNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PhotonicWaveguideCouplerNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoliquidhydrogenlogistics.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CryoHydrogenTankTelemetryNode.
 * 
 ...
 */
public record CryoHydrogenTankTelemetryNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CryoHydrogenTankTelemetryNode {
    ...
    public CryoHydrogenTankTelemetryNode withStatus(String newStatus) {
        return new CryoHydrogenTankTelemetryNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

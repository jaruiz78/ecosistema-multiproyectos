package com.corp.proyectodiscretevariableqkdmesh.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DvQkdDecoyStateKeyStreamToken.
 * 
 ...
 */
public record DvQkdDecoyStateKeyStreamToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DvQkdDecoyStateKeyStreamToken {
    ...
    public DvQkdDecoyStateKeyStreamToken withStatus(String newStatus) {
        return new DvQkdDecoyStateKeyStreamToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

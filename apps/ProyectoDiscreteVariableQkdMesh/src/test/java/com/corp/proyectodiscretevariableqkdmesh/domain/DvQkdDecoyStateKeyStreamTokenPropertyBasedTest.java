package com.corp.proyectodiscretevariableqkdmesh.domain;
...
class DvQkdDecoyStateKeyStreamTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DvQkdDecoyStateKeyStreamToken entity = new DvQkdDecoyStateKeyStreamToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DvQkdDecoyStateKeyStreamToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

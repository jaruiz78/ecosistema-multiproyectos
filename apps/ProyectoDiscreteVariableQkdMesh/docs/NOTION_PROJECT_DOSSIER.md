# 🏛️ NOTION DOSSIER: ProyectoDiscreteVariableQkdMesh

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoDiscreteVariableQkdMesh
* **Entidad Dominio**: DvQkdDecoyStateKeyStreamToken
* **Descripción**: Redes Metropolitanas de Distribucion Cuantica de Claves DV-QKD

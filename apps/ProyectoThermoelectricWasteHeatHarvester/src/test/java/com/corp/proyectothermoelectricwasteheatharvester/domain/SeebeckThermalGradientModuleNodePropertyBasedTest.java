package com.corp.proyectothermoelectricwasteheatharvester.domain;
...
class SeebeckThermalGradientModuleNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SeebeckThermalGradientModuleNode entity = new SeebeckThermalGradientModuleNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SeebeckThermalGradientModuleNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectothermoelectricwasteheatharvester.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SeebeckThermalGradientModuleNode.
 * 
 ...
 */
public record SeebeckThermalGradientModuleNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SeebeckThermalGradientModuleNode {
    ...
    public SeebeckThermalGradientModuleNode withStatus(String newStatus) {
        return new SeebeckThermalGradientModuleNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

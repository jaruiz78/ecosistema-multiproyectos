package com.corp.proyectorecursivesnarkverifier.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: Halo2ProofAggregationBatchToken.
 * 
 ...
 */
public record Halo2ProofAggregationBatchToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public Halo2ProofAggregationBatchToken {
    ...
    public Halo2ProofAggregationBatchToken withStatus(String newStatus) {
        return new Halo2ProofAggregationBatchToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

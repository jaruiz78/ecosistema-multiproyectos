package com.corp.proyectorecursivesnarkverifier.domain;
...
class Halo2ProofAggregationBatchTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            Halo2ProofAggregationBatchToken entity = new Halo2ProofAggregationBatchToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new Halo2ProofAggregationBatchToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoevtolurbanaircorridors.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EvtolFlightTrajectorySlotToken.
 * 
 ...
 */
public record EvtolFlightTrajectorySlotToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EvtolFlightTrajectorySlotToken {
    ...
    public EvtolFlightTrajectorySlotToken withStatus(String newStatus) {
        return new EvtolFlightTrajectorySlotToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

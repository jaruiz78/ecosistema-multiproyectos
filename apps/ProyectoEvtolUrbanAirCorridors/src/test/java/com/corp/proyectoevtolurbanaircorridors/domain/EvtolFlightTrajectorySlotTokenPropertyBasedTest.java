package com.corp.proyectoevtolurbanaircorridors.domain;
...
class EvtolFlightTrajectorySlotTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EvtolFlightTrajectorySlotToken entity = new EvtolFlightTrajectorySlotToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EvtolFlightTrajectorySlotToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

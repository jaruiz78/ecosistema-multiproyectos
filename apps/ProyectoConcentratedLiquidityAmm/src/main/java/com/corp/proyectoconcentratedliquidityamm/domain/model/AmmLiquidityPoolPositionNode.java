package com.corp.proyectoconcentratedliquidityamm.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AmmLiquidityPoolPositionNode.
 * 
 ...
 */
public record AmmLiquidityPoolPositionNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AmmLiquidityPoolPositionNode {
    ...
    public AmmLiquidityPoolPositionNode withStatus(String newStatus) {
        return new AmmLiquidityPoolPositionNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

...
class AmmLiquidityPoolPositionNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AmmLiquidityPoolPositionNode entity = new AmmLiquidityPoolPositionNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AmmLiquidityPoolPositionNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

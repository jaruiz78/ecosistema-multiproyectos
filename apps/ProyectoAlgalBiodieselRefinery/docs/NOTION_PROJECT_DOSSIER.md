# 🏛️ NOTION DOSSIER: ProyectoAlgalBiodieselRefinery

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoAlgalBiodieselRefinery
* **Entidad Dominio**: LipidToBiodieselYieldConversionToken
* **Descripción**: Refinerias de Biodiesel Sostenible a partir de Biomasa de Microalgas

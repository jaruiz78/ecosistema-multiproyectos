package com.corp.proyectoalgalbiodieselrefinery.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: LipidToBiodieselYieldConversionToken.
 * 
 ...
 */
public record LipidToBiodieselYieldConversionToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public LipidToBiodieselYieldConversionToken {
    ...
    public LipidToBiodieselYieldConversionToken withStatus(String newStatus) {
        return new LipidToBiodieselYieldConversionToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoalgalbiodieselrefinery.domain;
...
class LipidToBiodieselYieldConversionTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            LipidToBiodieselYieldConversionToken entity = new LipidToBiodieselYieldConversionToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new LipidToBiodieselYieldConversionToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

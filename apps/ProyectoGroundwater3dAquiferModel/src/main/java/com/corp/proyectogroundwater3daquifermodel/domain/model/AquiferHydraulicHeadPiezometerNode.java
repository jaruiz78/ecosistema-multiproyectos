package com.corp.proyectogroundwater3daquifermodel.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AquiferHydraulicHeadPiezometerNode.
 * 
 ...
 */
public record AquiferHydraulicHeadPiezometerNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AquiferHydraulicHeadPiezometerNode {
    ...
    public AquiferHydraulicHeadPiezometerNode withStatus(String newStatus) {
        return new AquiferHydraulicHeadPiezometerNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectogroundwater3daquifermodel.domain;
...
class AquiferHydraulicHeadPiezometerNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AquiferHydraulicHeadPiezometerNode entity = new AquiferHydraulicHeadPiezometerNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AquiferHydraulicHeadPiezometerNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

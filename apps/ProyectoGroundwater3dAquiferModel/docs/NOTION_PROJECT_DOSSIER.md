# 🏛️ NOTION DOSSIER: ProyectoGroundwater3dAquiferModel

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoGroundwater3dAquiferModel
* **Entidad Dominio**: AquiferHydraulicHeadPiezometerNode
* **Descripción**: Simulacion Hidrogeologica 3D de Flujo en Acuiferos y Balance Hidrico

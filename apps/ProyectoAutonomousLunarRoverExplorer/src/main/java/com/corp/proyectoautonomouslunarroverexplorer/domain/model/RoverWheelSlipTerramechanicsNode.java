package com.corp.proyectoautonomouslunarroverexplorer.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: RoverWheelSlipTerramechanicsNode.
 * 
 ...
 */
public record RoverWheelSlipTerramechanicsNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public RoverWheelSlipTerramechanicsNode {
    ...
    public RoverWheelSlipTerramechanicsNode withStatus(String newStatus) {
        return new RoverWheelSlipTerramechanicsNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

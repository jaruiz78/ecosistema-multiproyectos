package com.corp.proyectoorganonachippharmascreen.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MicrofluidicPerfusionChannelNode.
 * 
 ...
 */
public record MicrofluidicPerfusionChannelNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MicrofluidicPerfusionChannelNode {
    ...
    public MicrofluidicPerfusionChannelNode withStatus(String newStatus) {
        return new MicrofluidicPerfusionChannelNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoorganonachippharmascreen.domain;
...
class MicrofluidicPerfusionChannelNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MicrofluidicPerfusionChannelNode entity = new MicrofluidicPerfusionChannelNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MicrofluidicPerfusionChannelNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

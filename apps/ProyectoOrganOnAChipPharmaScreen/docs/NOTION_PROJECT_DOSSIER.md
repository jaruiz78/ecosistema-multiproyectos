# 🏛️ NOTION DOSSIER: ProyectoOrganOnAChipPharmaScreen

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoOrganOnAChipPharmaScreen
* **Entidad Dominio**: MicrofluidicPerfusionChannelNode
* **Descripción**: Plataforma Organ-on-a-Chip para Cribado Farmacologico sin Ensayos en Animales

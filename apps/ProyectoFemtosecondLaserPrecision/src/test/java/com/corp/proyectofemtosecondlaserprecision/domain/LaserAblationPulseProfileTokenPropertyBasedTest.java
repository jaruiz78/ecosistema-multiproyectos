package com.corp.proyectofemtosecondlaserprecision.domain;
...
class LaserAblationPulseProfileTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            LaserAblationPulseProfileToken entity = new LaserAblationPulseProfileToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new LaserAblationPulseProfileToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

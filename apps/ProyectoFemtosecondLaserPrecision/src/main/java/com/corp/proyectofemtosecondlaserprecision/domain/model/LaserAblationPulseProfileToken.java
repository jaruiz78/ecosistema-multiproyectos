package com.corp.proyectofemtosecondlaserprecision.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: LaserAblationPulseProfileToken.
 * 
 ...
 */
public record LaserAblationPulseProfileToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public LaserAblationPulseProfileToken {
    ...
    public LaserAblationPulseProfileToken withStatus(String newStatus) {
        return new LaserAblationPulseProfileToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

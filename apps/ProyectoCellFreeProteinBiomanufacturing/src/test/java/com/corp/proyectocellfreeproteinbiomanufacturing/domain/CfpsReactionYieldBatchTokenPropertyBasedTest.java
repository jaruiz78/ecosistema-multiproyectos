package com.corp.proyectocellfreeproteinbiomanufacturing.domain;
...
class CfpsReactionYieldBatchTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CfpsReactionYieldBatchToken entity = new CfpsReactionYieldBatchToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CfpsReactionYieldBatchToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

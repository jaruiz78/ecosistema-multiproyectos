package com.corp.proyectocellfreeproteinbiomanufacturing.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CfpsReactionYieldBatchToken.
 * 
 ...
 */
public record CfpsReactionYieldBatchToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CfpsReactionYieldBatchToken {
    ...
    public CfpsReactionYieldBatchToken withStatus(String newStatus) {
        return new CfpsReactionYieldBatchToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

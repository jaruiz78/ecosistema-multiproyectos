package com.corp.proyectodnaarchivaldatastorage.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DnaOligonucleotideDataBlockToken.
 * 
 ...
 */
public record DnaOligonucleotideDataBlockToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DnaOligonucleotideDataBlockToken {
    ...
    public DnaOligonucleotideDataBlockToken withStatus(String newStatus) {
        return new DnaOligonucleotideDataBlockToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectodnaarchivaldatastorage.domain;
...
class DnaOligonucleotideDataBlockTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DnaOligonucleotideDataBlockToken entity = new DnaOligonucleotideDataBlockToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DnaOligonucleotideDataBlockToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

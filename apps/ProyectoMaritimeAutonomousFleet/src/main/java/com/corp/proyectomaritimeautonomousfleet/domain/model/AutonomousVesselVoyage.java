package com.corp.proyectomaritimeautonomousfleet.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AutonomousVesselVoyage.
 * 
 ...
 */
public record AutonomousVesselVoyage(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AutonomousVesselVoyage withStatus(String newStatus) {
        return new AutonomousVesselVoyage(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

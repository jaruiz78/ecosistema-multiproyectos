package com.corp.proyectomaritimeautonomousfleet.domain;
...
class AutonomousVesselVoyagePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AutonomousVesselVoyage entity = new AutonomousVesselVoyage(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AutonomousVesselVoyage(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

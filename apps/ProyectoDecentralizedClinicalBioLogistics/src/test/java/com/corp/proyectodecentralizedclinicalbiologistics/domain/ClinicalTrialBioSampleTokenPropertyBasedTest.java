...
class ClinicalTrialBioSampleTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ClinicalTrialBioSampleToken entity = new ClinicalTrialBioSampleToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ClinicalTrialBioSampleToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

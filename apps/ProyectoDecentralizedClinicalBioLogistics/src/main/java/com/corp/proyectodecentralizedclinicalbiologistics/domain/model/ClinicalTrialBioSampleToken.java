package com.corp.proyectodecentralizedclinicalbiologistics.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ClinicalTrialBioSampleToken.
 * 
 ...
 */
public record ClinicalTrialBioSampleToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ClinicalTrialBioSampleToken {
    ...
    public ClinicalTrialBioSampleToken withStatus(String newStatus) {
        return new ClinicalTrialBioSampleToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

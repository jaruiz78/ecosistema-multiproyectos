# 🏛️ NOTION DOSSIER: ProyectoDesertDustAirQualityGrid

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoDesertDustAirQualityGrid
* **Entidad Dominio**: MineralDustAerosolOpticalDepthNode
* **Descripción**: Pronostico de Calimas y Tormentas de Polvo Desertico para Sector Solar

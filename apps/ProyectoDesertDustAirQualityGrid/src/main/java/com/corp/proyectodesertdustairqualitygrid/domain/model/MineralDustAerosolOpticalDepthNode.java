package com.corp.proyectodesertdustairqualitygrid.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MineralDustAerosolOpticalDepthNode.
 * 
 ...
 */
public record MineralDustAerosolOpticalDepthNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MineralDustAerosolOpticalDepthNode {
    ...
    public MineralDustAerosolOpticalDepthNode withStatus(String newStatus) {
        return new MineralDustAerosolOpticalDepthNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

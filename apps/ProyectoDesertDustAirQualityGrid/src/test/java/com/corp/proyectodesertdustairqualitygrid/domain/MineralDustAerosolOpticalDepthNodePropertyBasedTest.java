package com.corp.proyectodesertdustairqualitygrid.domain;
...
class MineralDustAerosolOpticalDepthNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MineralDustAerosolOpticalDepthNode entity = new MineralDustAerosolOpticalDepthNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MineralDustAerosolOpticalDepthNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

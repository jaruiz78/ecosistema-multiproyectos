package com.corp.proyectoestuarinesalinityintrusiontwin.domain;
...
class EstuarineSalinityIsohalineDistanceNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EstuarineSalinityIsohalineDistanceNode entity = new EstuarineSalinityIsohalineDistanceNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EstuarineSalinityIsohalineDistanceNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

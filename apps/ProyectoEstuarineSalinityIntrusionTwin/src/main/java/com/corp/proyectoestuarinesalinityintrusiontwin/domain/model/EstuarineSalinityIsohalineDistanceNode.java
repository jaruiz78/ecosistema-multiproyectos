package com.corp.proyectoestuarinesalinityintrusiontwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EstuarineSalinityIsohalineDistanceNode.
 * 
 ...
 */
public record EstuarineSalinityIsohalineDistanceNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EstuarineSalinityIsohalineDistanceNode {
    ...
    public EstuarineSalinityIsohalineDistanceNode withStatus(String newStatus) {
        return new EstuarineSalinityIsohalineDistanceNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

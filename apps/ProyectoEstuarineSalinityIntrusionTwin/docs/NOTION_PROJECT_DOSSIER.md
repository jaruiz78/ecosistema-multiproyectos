# 🏛️ NOTION DOSSIER: ProyectoEstuarineSalinityIntrusionTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoEstuarineSalinityIntrusionTwin
* **Entidad Dominio**: EstuarineSalinityIsohalineDistanceNode
* **Descripción**: Control de Intrusion Salina en Deltas y Tomas de Riego Costeras

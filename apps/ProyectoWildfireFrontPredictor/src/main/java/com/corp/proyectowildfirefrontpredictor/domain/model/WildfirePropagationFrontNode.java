package com.corp.proyectowildfirefrontpredictor.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: WildfirePropagationFrontNode.
 * 
 ...
 */
public record WildfirePropagationFrontNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public WildfirePropagationFrontNode {
    ...
    public WildfirePropagationFrontNode withStatus(String newStatus) {
        return new WildfirePropagationFrontNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectowildfirefrontpredictor.domain;
...
class WildfirePropagationFrontNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            WildfirePropagationFrontNode entity = new WildfirePropagationFrontNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new WildfirePropagationFrontNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

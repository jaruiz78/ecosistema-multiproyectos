# 🏛️ NOTION DOSSIER: ProyectoOceanPlasticCleanupRouter

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoOceanPlasticCleanupRouter
* **Entidad Dominio**: MicroplasticDensityConcentrationNode
* **Descripción**: Modelizacion Lagrangiana de Microplasticos Marinos y Ruteo de Barcos de Limpieza

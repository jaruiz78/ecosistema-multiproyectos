package com.corp.proyectooceanplasticcleanuprouter.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MicroplasticDensityConcentrationNode.
 * 
 ...
 */
public record MicroplasticDensityConcentrationNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MicroplasticDensityConcentrationNode {
    ...
    public MicroplasticDensityConcentrationNode withStatus(String newStatus) {
        return new MicroplasticDensityConcentrationNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

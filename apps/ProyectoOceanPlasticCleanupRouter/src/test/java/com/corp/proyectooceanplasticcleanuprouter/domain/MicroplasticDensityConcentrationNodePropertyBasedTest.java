package com.corp.proyectooceanplasticcleanuprouter.domain;
...
class MicroplasticDensityConcentrationNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MicroplasticDensityConcentrationNode entity = new MicroplasticDensityConcentrationNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MicroplasticDensityConcentrationNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

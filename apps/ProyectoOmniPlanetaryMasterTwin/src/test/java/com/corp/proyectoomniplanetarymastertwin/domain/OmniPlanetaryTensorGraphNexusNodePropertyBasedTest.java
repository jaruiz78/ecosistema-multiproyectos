...
class OmniPlanetaryTensorGraphNexusNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            OmniPlanetaryTensorGraphNexusNode entity = new OmniPlanetaryTensorGraphNexusNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new OmniPlanetaryTensorGraphNexusNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

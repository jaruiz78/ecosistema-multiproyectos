package com.corp.proyectoomniplanetarymastertwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: OmniPlanetaryTensorGraphNexusNode.
 * 
 ...
 */
public record OmniPlanetaryTensorGraphNexusNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public OmniPlanetaryTensorGraphNexusNode {
    ...
    public OmniPlanetaryTensorGraphNexusNode withStatus(String newStatus) {
        return new OmniPlanetaryTensorGraphNexusNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

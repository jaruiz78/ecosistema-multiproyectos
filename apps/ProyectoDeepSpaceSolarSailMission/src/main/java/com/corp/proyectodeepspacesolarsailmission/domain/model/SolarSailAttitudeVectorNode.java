package com.corp.proyectodeepspacesolarsailmission.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SolarSailAttitudeVectorNode.
 * 
 ...
 */
public record SolarSailAttitudeVectorNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SolarSailAttitudeVectorNode {
    ...
    public SolarSailAttitudeVectorNode withStatus(String newStatus) {
        return new SolarSailAttitudeVectorNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectodeepspacesolarsailmission.domain;
...
class SolarSailAttitudeVectorNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SolarSailAttitudeVectorNode entity = new SolarSailAttitudeVectorNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SolarSailAttitudeVectorNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

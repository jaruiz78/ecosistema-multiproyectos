package com.corp.proyectospaceagriregenerativehabitat.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SpaceHabitatEclssLoopNode.
 * 
 ...
 */
public record SpaceHabitatEclssLoopNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SpaceHabitatEclssLoopNode {
    ...
    public SpaceHabitatEclssLoopNode withStatus(String newStatus) {
        return new SpaceHabitatEclssLoopNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

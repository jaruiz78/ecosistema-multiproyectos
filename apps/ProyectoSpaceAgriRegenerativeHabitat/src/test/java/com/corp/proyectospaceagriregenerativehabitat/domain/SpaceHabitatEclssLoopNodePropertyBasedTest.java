...
class SpaceHabitatEclssLoopNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SpaceHabitatEclssLoopNode entity = new SpaceHabitatEclssLoopNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SpaceHabitatEclssLoopNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

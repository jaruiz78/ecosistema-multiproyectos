package com.corp.proyectoionpropulsionorbitalmaneuver.domain;
...
class IonThrusterManeuverPlanTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            IonThrusterManeuverPlanToken entity = new IonThrusterManeuverPlanToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new IonThrusterManeuverPlanToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

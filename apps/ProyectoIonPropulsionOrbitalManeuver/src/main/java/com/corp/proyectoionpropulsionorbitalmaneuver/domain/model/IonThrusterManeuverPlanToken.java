package com.corp.proyectoionpropulsionorbitalmaneuver.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: IonThrusterManeuverPlanToken.
 * 
 ...
 */
public record IonThrusterManeuverPlanToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public IonThrusterManeuverPlanToken {
    ...
    public IonThrusterManeuverPlanToken withStatus(String newStatus) {
        return new IonThrusterManeuverPlanToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

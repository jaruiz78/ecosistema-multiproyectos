package com.corp.proyectometabolicoptknockengineering.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GeneDeletionTargetVectorToken.
 * 
 ...
 */
public record GeneDeletionTargetVectorToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public GeneDeletionTargetVectorToken {
    ...
    public GeneDeletionTargetVectorToken withStatus(String newStatus) {
        return new GeneDeletionTargetVectorToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

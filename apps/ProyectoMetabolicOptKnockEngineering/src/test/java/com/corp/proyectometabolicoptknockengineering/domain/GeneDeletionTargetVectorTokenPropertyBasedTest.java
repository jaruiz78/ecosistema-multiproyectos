package com.corp.proyectometabolicoptknockengineering.domain;
...
class GeneDeletionTargetVectorTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            GeneDeletionTargetVectorToken entity = new GeneDeletionTargetVectorToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new GeneDeletionTargetVectorToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

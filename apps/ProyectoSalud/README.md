# 🚀 ProyectoSalud: Gemelo Fisiológico y Epidemiología Espacial
...
## 1. Visión General
Vertical para la modelización de propagación de patógenos y optimización de recursos hospitalarios.

### Bounded Context & Dominio
* **Dominio Principal:** Centros de salud, vectores de contagio, dotación de camas UCI.

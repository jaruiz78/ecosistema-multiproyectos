 ...
 * Verifica invariantes y comportamiento de ClinicalTrialSubject sin dependencias externas.
 */
class ClinicalTrialSubjectDomainTest {
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new ClinicalTrialSubject(
            "item-002",
            "tenant-alpha",
            "Invalid Asset",
            -10.0,

...
@Entity
@Table(name = "proyectosalud_data")
public class ProyectoSaludEntity {
    ...
    public ProyectoSaludEntity() {}
    public ProyectoSaludEntity(String tenantId, double predictiveScore) {

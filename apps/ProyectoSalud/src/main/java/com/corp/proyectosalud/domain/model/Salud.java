...
public record Salud(
    ...
    public Salud withStatus(String newStatus) {
        return new Salud(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

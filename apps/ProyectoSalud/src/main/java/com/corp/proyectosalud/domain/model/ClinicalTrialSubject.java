...
/**
 * Entidad de Dominio Puro: ClinicalTrialSubject.
 * 
 ...
 */
public record ClinicalTrialSubject(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ClinicalTrialSubject withStatus(String newStatus) {
        return new ClinicalTrialSubject(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

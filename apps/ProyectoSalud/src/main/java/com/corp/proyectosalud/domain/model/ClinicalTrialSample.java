...
/**
 * Entidad de Dominio Puro: ClinicalTrialSample.
 * 
 ...
 */
public record ClinicalTrialSample(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ClinicalTrialSample withStatus(String newStatus) {
        return new ClinicalTrialSample(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoterahertzmolecularscanner.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: TerahertzAbsorptionSpectrumNode.
 * 
 ...
 */
public record TerahertzAbsorptionSpectrumNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public TerahertzAbsorptionSpectrumNode {
    ...
    public TerahertzAbsorptionSpectrumNode withStatus(String newStatus) {
        return new TerahertzAbsorptionSpectrumNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

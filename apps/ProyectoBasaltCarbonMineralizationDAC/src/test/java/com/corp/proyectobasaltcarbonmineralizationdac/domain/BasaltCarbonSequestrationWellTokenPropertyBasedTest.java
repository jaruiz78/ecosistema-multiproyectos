package com.corp.proyectobasaltcarbonmineralizationdac.domain;
...
class BasaltCarbonSequestrationWellTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BasaltCarbonSequestrationWellToken entity = new BasaltCarbonSequestrationWellToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BasaltCarbonSequestrationWellToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

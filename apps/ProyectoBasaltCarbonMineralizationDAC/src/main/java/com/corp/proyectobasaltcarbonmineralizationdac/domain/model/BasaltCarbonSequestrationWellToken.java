package com.corp.proyectobasaltcarbonmineralizationdac.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: BasaltCarbonSequestrationWellToken.
 * 
 ...
 */
public record BasaltCarbonSequestrationWellToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BasaltCarbonSequestrationWellToken {
    ...
    public BasaltCarbonSequestrationWellToken withStatus(String newStatus) {
        return new BasaltCarbonSequestrationWellToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

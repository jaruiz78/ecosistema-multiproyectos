# 🏛️ NOTION DOSSIER: ProyectoBasaltCarbonMineralizationDAC

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoBasaltCarbonMineralizationDAC
* **Entidad Dominio**: BasaltCarbonSequestrationWellToken
* **Descripción**: Captura Directa de Aire (DAC) y Mineralizacion In-Situ de Carbono en Formaciones de Basalto

...
/**
 * Entidad de Dominio Puro: TokenRWA.
...
public record TokenRWA(
    ...
    public TokenRWA withStatus(String newStatus) {
        return new TokenRWA(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

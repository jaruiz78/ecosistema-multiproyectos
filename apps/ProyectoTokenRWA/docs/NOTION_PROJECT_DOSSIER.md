# Notion Project Dossier: ProyectoTokenRWA (Tokenización de Activos del Mundo Real (RWA))
...
* **Stack Tecnológico**: Java 25 / Spring Boot 4.0 / Stripe Escrow

---

## 2. Visión General y Objetivos de Negocio
Custodia y liquidación fraccionada de activos tangibles.

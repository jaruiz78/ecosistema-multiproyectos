package com.corp.proyectoundergroundfreighttubenetwork.domain;
...
class UndergroundFreightCapsuleTrackNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            UndergroundFreightCapsuleTrackNode entity = new UndergroundFreightCapsuleTrackNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new UndergroundFreightCapsuleTrackNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

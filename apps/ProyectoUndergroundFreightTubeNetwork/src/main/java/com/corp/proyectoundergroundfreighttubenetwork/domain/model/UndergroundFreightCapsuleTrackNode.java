package com.corp.proyectoundergroundfreighttubenetwork.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: UndergroundFreightCapsuleTrackNode.
 * 
 ...
 */
public record UndergroundFreightCapsuleTrackNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public UndergroundFreightCapsuleTrackNode {
    ...
    public UndergroundFreightCapsuleTrackNode withStatus(String newStatus) {
        return new UndergroundFreightCapsuleTrackNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectogeneralista.domain;
...
class GeneralistaDomainTest {

    @Test
    @DisplayName("Debe crear la entidad Generalista con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new Generalista(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

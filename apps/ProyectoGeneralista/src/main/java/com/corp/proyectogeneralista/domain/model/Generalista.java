package com.corp.proyectogeneralista.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: Generalista.
...
public record Generalista(
    ...
    public Generalista withStatus(String newStatus) {
        return new Generalista(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

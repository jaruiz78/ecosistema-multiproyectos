# 🚀 ProyectoGeneralista: Módulo de Integración Multiproyecto Transversal
...
## 1. Visión General
Vertical de servicios comunes y adaptadores genéricos para nuevos dominios del ecosistema.

### Bounded Context & Dominio
* **Dominio Principal:** Adaptadores base, pasarelas de eventos, orquestación.
* **Integración Base:** Hereda de [`corp-spring-boot-starter`](file:///home/jaruiz/Desarrollo/corp-spring-boot-starter).
* **Enlace de Estado / Ledger:** `corp-spring-boot-starter`.

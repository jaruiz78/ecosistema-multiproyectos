package com.corp.proyectoseismicresilienceinfrastructure.domain;
...
class SeismicBaseIsolatorDisplacementNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SeismicBaseIsolatorDisplacementNode entity = new SeismicBaseIsolatorDisplacementNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SeismicBaseIsolatorDisplacementNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

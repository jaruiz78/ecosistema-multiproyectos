package com.corp.proyectoseismicresilienceinfrastructure.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SeismicBaseIsolatorDisplacementNode.
 * 
 ...
 */
public record SeismicBaseIsolatorDisplacementNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SeismicBaseIsolatorDisplacementNode {
    ...
    public SeismicBaseIsolatorDisplacementNode withStatus(String newStatus) {
        return new SeismicBaseIsolatorDisplacementNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectolitertedgeinferencehub.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: LiteRtQuantizedModelExecutionNode.
 * 
 ...
 */
public record LiteRtQuantizedModelExecutionNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public LiteRtQuantizedModelExecutionNode {
    ...
    public LiteRtQuantizedModelExecutionNode withStatus(String newStatus) {
        return new LiteRtQuantizedModelExecutionNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

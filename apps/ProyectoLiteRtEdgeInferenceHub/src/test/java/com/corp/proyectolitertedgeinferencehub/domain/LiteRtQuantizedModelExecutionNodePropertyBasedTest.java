package com.corp.proyectolitertedgeinferencehub.domain;
...
class LiteRtQuantizedModelExecutionNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            LiteRtQuantizedModelExecutionNode entity = new LiteRtQuantizedModelExecutionNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new LiteRtQuantizedModelExecutionNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

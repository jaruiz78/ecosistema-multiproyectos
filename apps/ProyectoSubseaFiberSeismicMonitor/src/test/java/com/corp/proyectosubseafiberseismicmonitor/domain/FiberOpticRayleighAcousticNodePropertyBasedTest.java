package com.corp.proyectosubseafiberseismicmonitor.domain;
...
class FiberOpticRayleighAcousticNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            FiberOpticRayleighAcousticNode entity = new FiberOpticRayleighAcousticNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new FiberOpticRayleighAcousticNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

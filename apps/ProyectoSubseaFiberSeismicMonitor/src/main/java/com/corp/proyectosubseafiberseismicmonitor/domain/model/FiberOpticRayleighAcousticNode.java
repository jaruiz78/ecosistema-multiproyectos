package com.corp.proyectosubseafiberseismicmonitor.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: FiberOpticRayleighAcousticNode.
 * 
 ...
 */
public record FiberOpticRayleighAcousticNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public FiberOpticRayleighAcousticNode {
    ...
    public FiberOpticRayleighAcousticNode withStatus(String newStatus) {
        return new FiberOpticRayleighAcousticNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

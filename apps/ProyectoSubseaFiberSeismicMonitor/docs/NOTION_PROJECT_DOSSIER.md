# 🏛️ NOTION DOSSIER: ProyectoSubseaFiberSeismicMonitor

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoSubseaFiberSeismicMonitor
* **Entidad Dominio**: FiberOpticRayleighAcousticNode
* **Descripción**: Monitorizacion Sismica Marina mediante Deteccion Acustica Distribuida (DAS) en Fibra

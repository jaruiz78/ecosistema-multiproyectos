...
class CubesatAttitudeQuaternionPointingNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CubesatAttitudeQuaternionPointingNode entity = new CubesatAttitudeQuaternionPointingNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CubesatAttitudeQuaternionPointingNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

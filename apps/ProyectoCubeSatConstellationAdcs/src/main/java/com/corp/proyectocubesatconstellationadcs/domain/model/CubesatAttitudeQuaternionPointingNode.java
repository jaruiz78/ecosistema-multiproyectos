package com.corp.proyectocubesatconstellationadcs.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CubesatAttitudeQuaternionPointingNode.
 * 
 ...
 */
public record CubesatAttitudeQuaternionPointingNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CubesatAttitudeQuaternionPointingNode {
    ...
    public CubesatAttitudeQuaternionPointingNode withStatus(String newStatus) {
        return new CubesatAttitudeQuaternionPointingNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

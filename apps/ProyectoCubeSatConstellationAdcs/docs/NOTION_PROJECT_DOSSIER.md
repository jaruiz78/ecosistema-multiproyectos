# 🏛️ NOTION DOSSIER: ProyectoCubeSatConstellationAdcs

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCubeSatConstellationAdcs
* **Entidad Dominio**: CubesatAttitudeQuaternionPointingNode
* **Descripción**: Control de Apuntamiento de Alta Precision para Constelaciones CubeSat

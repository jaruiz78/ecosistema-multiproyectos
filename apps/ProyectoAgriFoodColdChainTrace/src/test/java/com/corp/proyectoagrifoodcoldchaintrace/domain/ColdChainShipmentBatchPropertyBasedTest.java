package com.corp.proyectoagrifoodcoldchaintrace.domain;
...
class ColdChainShipmentBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ColdChainShipmentBatch entity = new ColdChainShipmentBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ColdChainShipmentBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

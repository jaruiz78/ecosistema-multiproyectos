package com.corp.proyectoagrifoodcoldchaintrace.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ColdChainShipmentBatch.
 * 
 ...
 */
public record ColdChainShipmentBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ColdChainShipmentBatch withStatus(String newStatus) {
        return new ColdChainShipmentBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

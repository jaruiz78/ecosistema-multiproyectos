package com.corp.proyectohapticculturaltelepresence.domain;
...
class HapticExperienceStreamTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HapticExperienceStreamToken entity = new HapticExperienceStreamToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HapticExperienceStreamToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

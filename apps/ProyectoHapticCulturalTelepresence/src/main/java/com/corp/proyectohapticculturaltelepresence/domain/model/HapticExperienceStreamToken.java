package com.corp.proyectohapticculturaltelepresence.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HapticExperienceStreamToken.
 * 
 ...
 */
public record HapticExperienceStreamToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HapticExperienceStreamToken {
    ...
    public HapticExperienceStreamToken withStatus(String newStatus) {
        return new HapticExperienceStreamToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectosubmarinevolcanomonitoring.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: VolcanicHydroacousticSeismicNode.
 * 
 ...
 */
public record VolcanicHydroacousticSeismicNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public VolcanicHydroacousticSeismicNode {
    ...
    public VolcanicHydroacousticSeismicNode withStatus(String newStatus) {
        return new VolcanicHydroacousticSeismicNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectosubmarinevolcanomonitoring.domain;
...
class VolcanicHydroacousticSeismicNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            VolcanicHydroacousticSeismicNode entity = new VolcanicHydroacousticSeismicNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new VolcanicHydroacousticSeismicNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

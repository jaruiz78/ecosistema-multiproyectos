package com.corp.proyectoacousticmetamaterialshield.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AcousticScatteringCancellationNode.
 * 
 ...
 */
public record AcousticScatteringCancellationNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AcousticScatteringCancellationNode {
    ...
    public AcousticScatteringCancellationNode withStatus(String newStatus) {
        return new AcousticScatteringCancellationNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

...
class AcousticScatteringCancellationNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AcousticScatteringCancellationNode entity = new AcousticScatteringCancellationNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AcousticScatteringCancellationNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

# 🏛️ NOTION DOSSIER: ProyectoSuperconductingGridProtection

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoSuperconductingGridProtection
* **Entidad Dominio**: HtsFaultCurrentLimiterNode
* **Descripción**: Proteccion de Redes Electricas de Alta Tension con Limitadores Superconductores (HTS-FCL)

package com.corp.proyectosuperconductinggridprotection.domain;
...
class HtsFaultCurrentLimiterNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HtsFaultCurrentLimiterNode entity = new HtsFaultCurrentLimiterNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HtsFaultCurrentLimiterNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

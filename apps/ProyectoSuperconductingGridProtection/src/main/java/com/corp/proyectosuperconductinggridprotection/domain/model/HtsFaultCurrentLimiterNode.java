package com.corp.proyectosuperconductinggridprotection.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HtsFaultCurrentLimiterNode.
 * 
 ...
 */
public record HtsFaultCurrentLimiterNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HtsFaultCurrentLimiterNode {
    ...
    public HtsFaultCurrentLimiterNode withStatus(String newStatus) {
        return new HtsFaultCurrentLimiterNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

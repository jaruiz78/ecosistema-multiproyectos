package com.corp.proyectobiometricprivacysovereignauth.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EncryptedBiometricVectorDistanceNode.
 * 
 ...
 */
public record EncryptedBiometricVectorDistanceNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EncryptedBiometricVectorDistanceNode {
    ...
    public EncryptedBiometricVectorDistanceNode withStatus(String newStatus) {
        return new EncryptedBiometricVectorDistanceNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectobiometricprivacysovereignauth.domain;
...
class EncryptedBiometricVectorDistanceNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EncryptedBiometricVectorDistanceNode entity = new EncryptedBiometricVectorDistanceNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EncryptedBiometricVectorDistanceNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

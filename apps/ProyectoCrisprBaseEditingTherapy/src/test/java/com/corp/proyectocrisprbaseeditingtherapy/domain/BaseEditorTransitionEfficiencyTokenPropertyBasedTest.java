package com.corp.proyectocrisprbaseeditingtherapy.domain;
...
class BaseEditorTransitionEfficiencyTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BaseEditorTransitionEfficiencyToken entity = new BaseEditorTransitionEfficiencyToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BaseEditorTransitionEfficiencyToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

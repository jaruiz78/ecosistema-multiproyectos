package com.corp.proyectocrisprbaseeditingtherapy.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: BaseEditorTransitionEfficiencyToken.
 * 
 ...
 */
public record BaseEditorTransitionEfficiencyToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BaseEditorTransitionEfficiencyToken {
    ...
    public BaseEditorTransitionEfficiencyToken withStatus(String newStatus) {
        return new BaseEditorTransitionEfficiencyToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

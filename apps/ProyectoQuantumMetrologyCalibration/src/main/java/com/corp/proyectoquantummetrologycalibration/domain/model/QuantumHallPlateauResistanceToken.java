package com.corp.proyectoquantummetrologycalibration.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: QuantumHallPlateauResistanceToken.
 * 
 ...
 */
public record QuantumHallPlateauResistanceToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public QuantumHallPlateauResistanceToken {
    ...
    public QuantumHallPlateauResistanceToken withStatus(String newStatus) {
        return new QuantumHallPlateauResistanceToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoautonomousmaglevfreight.domain;
...
class MaglevFreightTrainTrackNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MaglevFreightTrainTrackNode entity = new MaglevFreightTrainTrackNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MaglevFreightTrainTrackNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

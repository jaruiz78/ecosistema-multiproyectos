package com.corp.proyectoautonomousmaglevfreight.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MaglevFreightTrainTrackNode.
 * 
 ...
 */
public record MaglevFreightTrainTrackNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MaglevFreightTrainTrackNode {
    ...
    public MaglevFreightTrainTrackNode withStatus(String newStatus) {
        return new MaglevFreightTrainTrackNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

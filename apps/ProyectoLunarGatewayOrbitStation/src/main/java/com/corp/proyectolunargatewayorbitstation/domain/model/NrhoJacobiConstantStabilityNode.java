package com.corp.proyectolunargatewayorbitstation.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: NrhoJacobiConstantStabilityNode.
 * 
 ...
 */
public record NrhoJacobiConstantStabilityNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public NrhoJacobiConstantStabilityNode {
    ...
    public NrhoJacobiConstantStabilityNode withStatus(String newStatus) {
        return new NrhoJacobiConstantStabilityNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

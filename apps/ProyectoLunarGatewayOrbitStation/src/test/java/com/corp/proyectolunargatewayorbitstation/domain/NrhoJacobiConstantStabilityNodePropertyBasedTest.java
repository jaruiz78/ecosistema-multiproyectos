package com.corp.proyectolunargatewayorbitstation.domain;
...
class NrhoJacobiConstantStabilityNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            NrhoJacobiConstantStabilityNode entity = new NrhoJacobiConstantStabilityNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new NrhoJacobiConstantStabilityNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectobacterialquoruminhibition.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AutoinducerSignalingBlockadeNode.
 * 
 ...
 */
public record AutoinducerSignalingBlockadeNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AutoinducerSignalingBlockadeNode {
    ...
    public AutoinducerSignalingBlockadeNode withStatus(String newStatus) {
        return new AutoinducerSignalingBlockadeNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

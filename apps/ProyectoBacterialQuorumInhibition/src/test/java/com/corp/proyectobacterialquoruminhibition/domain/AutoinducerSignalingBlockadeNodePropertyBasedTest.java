package com.corp.proyectobacterialquoruminhibition.domain;
...
class AutoinducerSignalingBlockadeNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AutoinducerSignalingBlockadeNode entity = new AutoinducerSignalingBlockadeNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AutoinducerSignalingBlockadeNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

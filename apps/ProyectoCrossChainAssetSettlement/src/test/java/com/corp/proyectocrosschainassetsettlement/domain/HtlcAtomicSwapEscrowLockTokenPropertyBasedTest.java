...
class HtlcAtomicSwapEscrowLockTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HtlcAtomicSwapEscrowLockToken entity = new HtlcAtomicSwapEscrowLockToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HtlcAtomicSwapEscrowLockToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

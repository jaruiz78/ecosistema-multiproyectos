package com.corp.proyectocrosschainassetsettlement.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HtlcAtomicSwapEscrowLockToken.
 * 
 ...
 */
public record HtlcAtomicSwapEscrowLockToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HtlcAtomicSwapEscrowLockToken {
    ...
    public HtlcAtomicSwapEscrowLockToken withStatus(String newStatus) {
        return new HtlcAtomicSwapEscrowLockToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

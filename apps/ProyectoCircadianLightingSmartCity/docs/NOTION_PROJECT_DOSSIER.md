# 🏛️ NOTION DOSSIER: ProyectoCircadianLightingSmartCity

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCircadianLightingSmartCity
* **Entidad Dominio**: CircadianLightingMelanopicNode
* **Descripción**: Alumbrado Inteligente Centrado en el Ser Humano (HCL) para Ciudades y Hospitales

package com.corp.proyectocircadianlightingsmartcity.domain;
...
class CircadianLightingMelanopicNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CircadianLightingMelanopicNode entity = new CircadianLightingMelanopicNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CircadianLightingMelanopicNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectocircadianlightingsmartcity.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CircadianLightingMelanopicNode.
 * 
 ...
 */
public record CircadianLightingMelanopicNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CircadianLightingMelanopicNode {
    ...
    public CircadianLightingMelanopicNode withStatus(String newStatus) {
        return new CircadianLightingMelanopicNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

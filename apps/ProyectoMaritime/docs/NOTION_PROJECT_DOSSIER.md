# 🏛️ NOTION DOSSIER: ProyectoMaritime

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoMaritime
* **Entidad Dominio**: Maritime
* **Descripción**: Microservicio Vertical Especializado en Maritime para el Ecosistema Corporativo.

package com.corp.proyectoprecisionbiofermentationtwin.domain;
...
class FermentationBioreactorVesselNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            FermentationBioreactorVesselNode entity = new FermentationBioreactorVesselNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new FermentationBioreactorVesselNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

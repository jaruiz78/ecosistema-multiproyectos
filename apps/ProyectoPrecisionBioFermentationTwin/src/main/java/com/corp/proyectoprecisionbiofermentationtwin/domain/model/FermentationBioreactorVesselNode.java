package com.corp.proyectoprecisionbiofermentationtwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: FermentationBioreactorVesselNode.
 * 
 ...
 */
public record FermentationBioreactorVesselNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public FermentationBioreactorVesselNode {
    ...
    public FermentationBioreactorVesselNode withStatus(String newStatus) {
        return new FermentationBioreactorVesselNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

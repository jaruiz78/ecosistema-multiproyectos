package com.corp.proyectoquantumdottandemsolar.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: QuantumDotSolarCellBatch.
 * 
 ...
 */
public record QuantumDotSolarCellBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public QuantumDotSolarCellBatch {
    ...
    public QuantumDotSolarCellBatch withStatus(String newStatus) {
        return new QuantumDotSolarCellBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

...
class QuantumDotSolarCellBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            QuantumDotSolarCellBatch entity = new QuantumDotSolarCellBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new QuantumDotSolarCellBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

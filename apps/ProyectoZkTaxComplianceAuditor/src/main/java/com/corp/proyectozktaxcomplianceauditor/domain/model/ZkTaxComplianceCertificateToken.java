package com.corp.proyectozktaxcomplianceauditor.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ZkTaxComplianceCertificateToken.
 * 
 ...
 */
public record ZkTaxComplianceCertificateToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ZkTaxComplianceCertificateToken {
    ...
    public ZkTaxComplianceCertificateToken withStatus(String newStatus) {
        return new ZkTaxComplianceCertificateToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

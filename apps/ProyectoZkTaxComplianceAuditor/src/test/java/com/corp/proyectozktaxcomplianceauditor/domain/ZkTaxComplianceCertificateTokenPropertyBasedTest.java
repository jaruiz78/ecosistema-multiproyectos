package com.corp.proyectozktaxcomplianceauditor.domain;
...
class ZkTaxComplianceCertificateTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ZkTaxComplianceCertificateToken entity = new ZkTaxComplianceCertificateToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ZkTaxComplianceCertificateToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoplanetaryaerocapturemission.domain;
...
class AerocapturePeakHeatFluxTrajectoryNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AerocapturePeakHeatFluxTrajectoryNode entity = new AerocapturePeakHeatFluxTrajectoryNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AerocapturePeakHeatFluxTrajectoryNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

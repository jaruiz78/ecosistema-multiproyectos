package com.corp.proyectoplanetaryaerocapturemission.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AerocapturePeakHeatFluxTrajectoryNode.
 * 
 ...
 */
public record AerocapturePeakHeatFluxTrajectoryNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AerocapturePeakHeatFluxTrajectoryNode {
    ...
    public AerocapturePeakHeatFluxTrajectoryNode withStatus(String newStatus) {
        return new AerocapturePeakHeatFluxTrajectoryNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoxenotransplantationimmunetwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: XenoOrganCompatibilityScoreToken.
 * 
 ...
 */
public record XenoOrganCompatibilityScoreToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public XenoOrganCompatibilityScoreToken {
    ...
    public XenoOrganCompatibilityScoreToken withStatus(String newStatus) {
        return new XenoOrganCompatibilityScoreToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoxenotransplantationimmunetwin.domain;
...
class XenoOrganCompatibilityScoreTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            XenoOrganCompatibilityScoreToken entity = new XenoOrganCompatibilityScoreToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new XenoOrganCompatibilityScoreToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

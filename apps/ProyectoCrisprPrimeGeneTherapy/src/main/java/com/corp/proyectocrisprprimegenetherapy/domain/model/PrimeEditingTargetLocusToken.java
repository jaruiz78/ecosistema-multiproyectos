package com.corp.proyectocrisprprimegenetherapy.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PrimeEditingTargetLocusToken.
 * 
 ...
 */
public record PrimeEditingTargetLocusToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PrimeEditingTargetLocusToken {
    ...
    public PrimeEditingTargetLocusToken withStatus(String newStatus) {
        return new PrimeEditingTargetLocusToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectocrisprprimegenetherapy.domain;
...
class PrimeEditingTargetLocusTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PrimeEditingTargetLocusToken entity = new PrimeEditingTargetLocusToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PrimeEditingTargetLocusToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

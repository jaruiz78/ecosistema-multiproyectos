...
class ZkCreditEligibilityProofTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ZkCreditEligibilityProofToken entity = new ZkCreditEligibilityProofToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ZkCreditEligibilityProofToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

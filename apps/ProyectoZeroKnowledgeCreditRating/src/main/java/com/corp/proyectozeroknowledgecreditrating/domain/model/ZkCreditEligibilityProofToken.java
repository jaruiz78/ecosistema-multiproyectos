package com.corp.proyectozeroknowledgecreditrating.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ZkCreditEligibilityProofToken.
 * 
 ...
 */
public record ZkCreditEligibilityProofToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ZkCreditEligibilityProofToken {
    ...
    public ZkCreditEligibilityProofToken withStatus(String newStatus) {
        return new ZkCreditEligibilityProofToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

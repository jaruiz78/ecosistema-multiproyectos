package com.corp.proyectolandslidedebrisflowhazard.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DebrisFlowRunoutVelocityImpactNode.
 * 
 ...
 */
public record DebrisFlowRunoutVelocityImpactNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DebrisFlowRunoutVelocityImpactNode {
    ...
    public DebrisFlowRunoutVelocityImpactNode withStatus(String newStatus) {
        return new DebrisFlowRunoutVelocityImpactNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

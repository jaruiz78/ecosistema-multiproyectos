package com.corp.proyectolandslidedebrisflowhazard.domain;
...
class DebrisFlowRunoutVelocityImpactNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DebrisFlowRunoutVelocityImpactNode entity = new DebrisFlowRunoutVelocityImpactNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DebrisFlowRunoutVelocityImpactNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

# 🏛️ NOTION DOSSIER: ProyectoLandslideDebrisFlowHazard

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoLandslideDebrisFlowHazard
* **Entidad Dominio**: DebrisFlowRunoutVelocityImpactNode
* **Descripción**: Zonificacion de Riesgo y Alerta de Deslizamientos de Ladera

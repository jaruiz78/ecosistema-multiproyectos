# 🏛️ NOTION DOSSIER: ProyectoNeuromorphicEdgeSNN

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoNeuromorphicEdgeSNN
* **Entidad Dominio**: NeuromorphicSpikeEventNode
* **Descripción**: Red Neuronal Neuromorfica por Pulsos para Inferencia de Ultra-Bajo Consumo en Drones

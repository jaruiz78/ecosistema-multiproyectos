package com.corp.proyectoneuromorphicedgesnn.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: NeuromorphicSpikeEventNode.
 * 
 ...
 */
public record NeuromorphicSpikeEventNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public NeuromorphicSpikeEventNode {
    ...
    public NeuromorphicSpikeEventNode withStatus(String newStatus) {
        return new NeuromorphicSpikeEventNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

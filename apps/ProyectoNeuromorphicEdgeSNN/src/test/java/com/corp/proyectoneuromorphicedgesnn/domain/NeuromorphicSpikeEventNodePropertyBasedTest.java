package com.corp.proyectoneuromorphicedgesnn.domain;
...
class NeuromorphicSpikeEventNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            NeuromorphicSpikeEventNode entity = new NeuromorphicSpikeEventNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new NeuromorphicSpikeEventNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

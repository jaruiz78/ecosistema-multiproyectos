package com.corp.proyectodualairdefense.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DualAirDefense.
...
public record DualAirDefense(
    ...
    public DualAirDefense withStatus(String newStatus) {
        return new DualAirDefense(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🚀 ProyectoDualAirDefense: Percepción Aérea Pasiva y Malla de Sensores
...
## 1. Visión General
Vertical para la triangulación acústica y de radiofrecuencia de vectores aéreos no tripulados.

### Bounded Context & Dominio
* **Dominio Principal:** Sensores acústicos/RF, vectores de aproximación, alerta temprana.

package com.corp.proyectoomnisystemicplanetarytwin.domain;
...
class PlanetaryTensorsNexusNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PlanetaryTensorsNexusNode entity = new PlanetaryTensorsNexusNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PlanetaryTensorsNexusNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

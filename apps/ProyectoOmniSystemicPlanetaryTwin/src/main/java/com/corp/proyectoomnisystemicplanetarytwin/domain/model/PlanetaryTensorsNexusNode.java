package com.corp.proyectoomnisystemicplanetarytwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PlanetaryTensorsNexusNode.
 * 
 ...
 */
public record PlanetaryTensorsNexusNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PlanetaryTensorsNexusNode {
    ...
    public PlanetaryTensorsNexusNode withStatus(String newStatus) {
        return new PlanetaryTensorsNexusNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

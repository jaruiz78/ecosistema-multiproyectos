package com.corp.proyectoprecisionsoilregen.domain;
...
class SoilCarbonMeasurementPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SoilCarbonMeasurement entity = new SoilCarbonMeasurement(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SoilCarbonMeasurement(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

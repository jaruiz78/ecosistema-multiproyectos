package com.corp.proyectoprecisionsoilregen.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SoilCarbonMeasurement.
 * 
 ...
 */
public record SoilCarbonMeasurement(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SoilCarbonMeasurement withStatus(String newStatus) {
        return new SoilCarbonMeasurement(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

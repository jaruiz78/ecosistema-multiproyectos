package com.corp.proyectoseamlessintermodalhub.domain;
...
class SeamlessIntermodalHubDomainTest {

    @Test
    @DisplayName("Debe crear la entidad SeamlessIntermodalHub con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new SeamlessIntermodalHub(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

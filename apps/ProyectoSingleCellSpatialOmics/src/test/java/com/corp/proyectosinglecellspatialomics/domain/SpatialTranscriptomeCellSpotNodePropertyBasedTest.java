package com.corp.proyectosinglecellspatialomics.domain;
...
class SpatialTranscriptomeCellSpotNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SpatialTranscriptomeCellSpotNode entity = new SpatialTranscriptomeCellSpotNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SpatialTranscriptomeCellSpotNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

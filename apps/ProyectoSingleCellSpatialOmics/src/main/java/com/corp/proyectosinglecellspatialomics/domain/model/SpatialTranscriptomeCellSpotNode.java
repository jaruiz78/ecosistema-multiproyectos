package com.corp.proyectosinglecellspatialomics.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SpatialTranscriptomeCellSpotNode.
 * 
 ...
 */
public record SpatialTranscriptomeCellSpotNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SpatialTranscriptomeCellSpotNode {
    ...
    public SpatialTranscriptomeCellSpotNode withStatus(String newStatus) {
        return new SpatialTranscriptomeCellSpotNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectomemristoranalogcompute.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MemristorCrossbarSynapseNode.
 * 
 ...
 */
public record MemristorCrossbarSynapseNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MemristorCrossbarSynapseNode {
    ...
    public MemristorCrossbarSynapseNode withStatus(String newStatus) {
        return new MemristorCrossbarSynapseNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

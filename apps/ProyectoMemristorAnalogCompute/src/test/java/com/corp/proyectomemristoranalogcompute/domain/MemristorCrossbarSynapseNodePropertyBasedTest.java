package com.corp.proyectomemristoranalogcompute.domain;
...
class MemristorCrossbarSynapseNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MemristorCrossbarSynapseNode entity = new MemristorCrossbarSynapseNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MemristorCrossbarSynapseNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectodroneairspace.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DroneFlightRoute.
 * 
 ...
 */
public record DroneFlightRoute(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DroneFlightRoute withStatus(String newStatus) {
        return new DroneFlightRoute(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

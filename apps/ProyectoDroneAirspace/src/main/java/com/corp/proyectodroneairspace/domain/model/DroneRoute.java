...
/**
 * Entidad de Dominio Puro: DroneRoute.
 * 
...
public record DroneRoute(
    ...
    public DroneRoute withStatus(String newStatus) {
        return new DroneRoute(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoagrowaterai.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: WaterIrrigationPlan.
 * 
 ...
 */
public record WaterIrrigationPlan(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public WaterIrrigationPlan withStatus(String newStatus) {
        return new WaterIrrigationPlan(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

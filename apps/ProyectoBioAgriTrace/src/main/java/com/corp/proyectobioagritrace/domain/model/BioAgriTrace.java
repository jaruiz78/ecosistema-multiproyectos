...
/**
 * Entidad de Dominio Puro: BioAgriTrace.
...
public record BioAgriTrace(
    ...
    public BioAgriTrace withStatus(String newStatus) {
        return new BioAgriTrace(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectobioagritrace.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: BioAgriGenomicSample.
 * 
 ...
 */
public record BioAgriGenomicSample(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BioAgriGenomicSample withStatus(String newStatus) {
        return new BioAgriGenomicSample(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

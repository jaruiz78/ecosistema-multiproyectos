package com.corp.proyectobioagritrace.domain;
...
class BioAgriGenomicSamplePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BioAgriGenomicSample entity = new BioAgriGenomicSample(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BioAgriGenomicSample(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

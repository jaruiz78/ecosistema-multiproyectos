package com.corp.proyectosegitturdtistandard.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SegitturDtiStandard.
 ...
 */
public record SegitturDtiStandard(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SegitturDtiStandard withStatus(String newStatus) {
        return new SegitturDtiStandard(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

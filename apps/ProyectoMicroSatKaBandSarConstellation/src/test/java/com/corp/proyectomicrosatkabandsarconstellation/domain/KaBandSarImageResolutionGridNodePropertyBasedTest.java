...
class KaBandSarImageResolutionGridNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            KaBandSarImageResolutionGridNode entity = new KaBandSarImageResolutionGridNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new KaBandSarImageResolutionGridNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

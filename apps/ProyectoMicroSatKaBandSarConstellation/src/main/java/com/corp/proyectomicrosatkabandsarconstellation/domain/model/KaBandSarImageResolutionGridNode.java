package com.corp.proyectomicrosatkabandsarconstellation.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: KaBandSarImageResolutionGridNode.
 * 
 ...
 */
public record KaBandSarImageResolutionGridNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public KaBandSarImageResolutionGridNode {
    ...
    public KaBandSarImageResolutionGridNode withStatus(String newStatus) {
        return new KaBandSarImageResolutionGridNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

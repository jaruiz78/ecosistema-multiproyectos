package com.corp.proyectoautonomousmaritimefreighter.domain;
...
class MassVesselCollisionAvoidanceNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MassVesselCollisionAvoidanceNode entity = new MassVesselCollisionAvoidanceNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MassVesselCollisionAvoidanceNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

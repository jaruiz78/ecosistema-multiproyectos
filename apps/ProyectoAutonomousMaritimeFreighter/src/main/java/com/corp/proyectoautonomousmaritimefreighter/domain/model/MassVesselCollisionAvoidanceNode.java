package com.corp.proyectoautonomousmaritimefreighter.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MassVesselCollisionAvoidanceNode.
 * 
 ...
 */
public record MassVesselCollisionAvoidanceNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MassVesselCollisionAvoidanceNode {
    ...
    public MassVesselCollisionAvoidanceNode withStatus(String newStatus) {
        return new MassVesselCollisionAvoidanceNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

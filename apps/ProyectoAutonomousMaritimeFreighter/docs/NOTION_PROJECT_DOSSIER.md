# 🏛️ NOTION DOSSIER: ProyectoAutonomousMaritimeFreighter

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoAutonomousMaritimeFreighter
* **Entidad Dominio**: MassVesselCollisionAvoidanceNode
* **Descripción**: Buques Mercantes Oceanicos Autonomos con Evasion de Colisiones COLREGs

package com.corp.proyectofleetcoldchain.domain;
...
class FleetColdChainDomainTest {

    @Test
    @DisplayName("Debe crear la entidad FleetColdChain con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new FleetColdChain(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

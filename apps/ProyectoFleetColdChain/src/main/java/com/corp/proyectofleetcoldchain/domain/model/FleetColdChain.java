package com.corp.proyectofleetcoldchain.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: FleetColdChain.
...
public record FleetColdChain(
    ...
    public FleetColdChain withStatus(String newStatus) {
        return new FleetColdChain(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

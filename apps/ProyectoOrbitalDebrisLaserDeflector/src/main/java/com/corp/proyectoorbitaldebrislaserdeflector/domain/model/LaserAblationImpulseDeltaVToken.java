package com.corp.proyectoorbitaldebrislaserdeflector.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: LaserAblationImpulseDeltaVToken.
 * 
 ...
 */
public record LaserAblationImpulseDeltaVToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public LaserAblationImpulseDeltaVToken {
    ...
    public LaserAblationImpulseDeltaVToken withStatus(String newStatus) {
        return new LaserAblationImpulseDeltaVToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

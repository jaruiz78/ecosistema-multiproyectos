...
class LaserAblationImpulseDeltaVTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            LaserAblationImpulseDeltaVToken entity = new LaserAblationImpulseDeltaVToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new LaserAblationImpulseDeltaVToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

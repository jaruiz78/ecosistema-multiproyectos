package com.corp.proyectosolidstatebatterystorage.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SolidStateElectrolyteCellBatch.
 * 
 ...
 */
public record SolidStateElectrolyteCellBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SolidStateElectrolyteCellBatch {
    ...
    public SolidStateElectrolyteCellBatch withStatus(String newStatus) {
        return new SolidStateElectrolyteCellBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

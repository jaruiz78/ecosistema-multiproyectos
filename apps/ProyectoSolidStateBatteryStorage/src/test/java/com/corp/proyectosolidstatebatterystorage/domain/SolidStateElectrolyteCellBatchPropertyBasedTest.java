package com.corp.proyectosolidstatebatterystorage.domain;
...
class SolidStateElectrolyteCellBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SolidStateElectrolyteCellBatch entity = new SolidStateElectrolyteCellBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SolidStateElectrolyteCellBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

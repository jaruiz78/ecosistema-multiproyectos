package com.corp.proyectohealthfederatedclinical.domain;
...
class ClinicalTrialEnclavePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ClinicalTrialEnclave entity = new ClinicalTrialEnclave(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ClinicalTrialEnclave(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

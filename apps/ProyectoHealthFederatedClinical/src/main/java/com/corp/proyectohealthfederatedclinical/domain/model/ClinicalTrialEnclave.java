package com.corp.proyectohealthfederatedclinical.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ClinicalTrialEnclave.
 * 
 ...
 */
public record ClinicalTrialEnclave(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ClinicalTrialEnclave withStatus(String newStatus) {
        return new ClinicalTrialEnclave(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

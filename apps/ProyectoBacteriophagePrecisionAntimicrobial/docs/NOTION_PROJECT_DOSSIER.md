# 🏛️ NOTION DOSSIER: ProyectoBacteriophagePrecisionAntimicrobial

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoBacteriophagePrecisionAntimicrobial
* **Entidad Dominio**: EndolysinLyticActivityScoreToken
* **Descripción**: Antimicrobianos Enzimaticos de Precision basados en Endolisinas de Fagos

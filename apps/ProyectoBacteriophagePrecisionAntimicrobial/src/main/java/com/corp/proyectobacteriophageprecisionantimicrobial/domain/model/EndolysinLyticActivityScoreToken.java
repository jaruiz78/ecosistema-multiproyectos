package com.corp.proyectobacteriophageprecisionantimicrobial.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EndolysinLyticActivityScoreToken.
 * 
 ...
 */
public record EndolysinLyticActivityScoreToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EndolysinLyticActivityScoreToken {
    ...
    public EndolysinLyticActivityScoreToken withStatus(String newStatus) {
        return new EndolysinLyticActivityScoreToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

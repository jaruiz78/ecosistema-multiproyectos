...
class EndolysinLyticActivityScoreTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EndolysinLyticActivityScoreToken entity = new EndolysinLyticActivityScoreToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EndolysinLyticActivityScoreToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectorutassenderismogr.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: RutasSenderismoGR.
 ...
 */
public record RutasSenderismoGR(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public RutasSenderismoGR withStatus(String newStatus) {
        return new RutasSenderismoGR(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

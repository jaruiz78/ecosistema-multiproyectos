package com.corp.proyectohyperloopintercitycorridor.domain;
...
class HyperloopPodTelemetryTelemetryNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HyperloopPodTelemetryTelemetryNode entity = new HyperloopPodTelemetryTelemetryNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HyperloopPodTelemetryTelemetryNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectohyperloopintercitycorridor.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HyperloopPodTelemetryTelemetryNode.
 * 
 ...
 */
public record HyperloopPodTelemetryTelemetryNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HyperloopPodTelemetryTelemetryNode {
    ...
    public HyperloopPodTelemetryTelemetryNode withStatus(String newStatus) {
        return new HyperloopPodTelemetryTelemetryNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

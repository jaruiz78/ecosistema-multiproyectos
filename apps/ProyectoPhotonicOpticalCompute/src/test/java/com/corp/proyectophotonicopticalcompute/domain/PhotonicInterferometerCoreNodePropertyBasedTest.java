package com.corp.proyectophotonicopticalcompute.domain;
...
class PhotonicInterferometerCoreNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PhotonicInterferometerCoreNode entity = new PhotonicInterferometerCoreNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PhotonicInterferometerCoreNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

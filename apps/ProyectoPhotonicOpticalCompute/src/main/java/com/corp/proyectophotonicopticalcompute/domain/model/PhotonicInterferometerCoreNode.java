package com.corp.proyectophotonicopticalcompute.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PhotonicInterferometerCoreNode.
 * 
 ...
 */
public record PhotonicInterferometerCoreNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PhotonicInterferometerCoreNode {
    ...
    public PhotonicInterferometerCoreNode withStatus(String newStatus) {
        return new PhotonicInterferometerCoreNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

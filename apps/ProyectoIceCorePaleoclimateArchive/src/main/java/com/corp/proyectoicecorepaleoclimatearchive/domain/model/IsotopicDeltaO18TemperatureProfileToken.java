package com.corp.proyectoicecorepaleoclimatearchive.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: IsotopicDeltaO18TemperatureProfileToken.
 * 
 ...
 */
public record IsotopicDeltaO18TemperatureProfileToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public IsotopicDeltaO18TemperatureProfileToken {
    ...
    public IsotopicDeltaO18TemperatureProfileToken withStatus(String newStatus) {
        return new IsotopicDeltaO18TemperatureProfileToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

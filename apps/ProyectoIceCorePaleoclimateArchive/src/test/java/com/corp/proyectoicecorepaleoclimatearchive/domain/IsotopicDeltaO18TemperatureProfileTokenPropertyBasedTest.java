...
class IsotopicDeltaO18TemperatureProfileTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            IsotopicDeltaO18TemperatureProfileToken entity = new IsotopicDeltaO18TemperatureProfileToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new IsotopicDeltaO18TemperatureProfileToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectopermafrostthawmonitor.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PermafrostThawDepthSubsidenceNode.
 * 
 ...
 */
public record PermafrostThawDepthSubsidenceNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PermafrostThawDepthSubsidenceNode {
    ...
    public PermafrostThawDepthSubsidenceNode withStatus(String newStatus) {
        return new PermafrostThawDepthSubsidenceNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

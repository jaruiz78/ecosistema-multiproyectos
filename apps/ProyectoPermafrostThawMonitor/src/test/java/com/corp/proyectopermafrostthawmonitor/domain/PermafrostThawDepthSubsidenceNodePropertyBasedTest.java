package com.corp.proyectopermafrostthawmonitor.domain;
...
class PermafrostThawDepthSubsidenceNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PermafrostThawDepthSubsidenceNode entity = new PermafrostThawDepthSubsidenceNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PermafrostThawDepthSubsidenceNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

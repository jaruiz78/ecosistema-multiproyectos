# 🏛️ NOTION DOSSIER: ProyectoPermafrostThawMonitor

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoPermafrostThawMonitor
* **Entidad Dominio**: PermafrostThawDepthSubsidenceNode
* **Descripción**: Monitoreo Geofisico de Deshielo de Permafrost y Subsidencia del Terreno

package com.corp.proyectoelectrodynamictetherdeorbit.domain;
...
class TetherLorentzDragForceDeorbitNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            TetherLorentzDragForceDeorbitNode entity = new TetherLorentzDragForceDeorbitNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new TetherLorentzDragForceDeorbitNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

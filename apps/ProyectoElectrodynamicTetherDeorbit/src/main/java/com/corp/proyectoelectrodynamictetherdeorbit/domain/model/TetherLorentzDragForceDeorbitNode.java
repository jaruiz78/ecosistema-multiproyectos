package com.corp.proyectoelectrodynamictetherdeorbit.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: TetherLorentzDragForceDeorbitNode.
 * 
 ...
 */
public record TetherLorentzDragForceDeorbitNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public TetherLorentzDragForceDeorbitNode {
    ...
    public TetherLorentzDragForceDeorbitNode withStatus(String newStatus) {
        return new TetherLorentzDragForceDeorbitNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoElectrodynamicTetherDeorbit

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoElectrodynamicTetherDeorbit
* **Entidad Dominio**: TetherLorentzDragForceDeorbitNode
* **Descripción**: Desorbitado Pasivo de Satelites mediante Cables Electro-Dinamicos

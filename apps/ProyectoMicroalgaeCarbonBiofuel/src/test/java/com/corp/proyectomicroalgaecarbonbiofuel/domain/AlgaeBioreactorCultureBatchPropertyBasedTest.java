package com.corp.proyectomicroalgaecarbonbiofuel.domain;
...
class AlgaeBioreactorCultureBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AlgaeBioreactorCultureBatch entity = new AlgaeBioreactorCultureBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AlgaeBioreactorCultureBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectomicroalgaecarbonbiofuel.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AlgaeBioreactorCultureBatch.
 * 
 ...
 */
public record AlgaeBioreactorCultureBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AlgaeBioreactorCultureBatch {
    ...
    public AlgaeBioreactorCultureBatch withStatus(String newStatus) {
        return new AlgaeBioreactorCultureBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

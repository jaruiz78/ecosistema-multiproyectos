# 🏛️ NOTION DOSSIER: ProyectoMicroalgaeCarbonBiofuel

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoMicroalgaeCarbonBiofuel
* **Entidad Dominio**: AlgaeBioreactorCultureBatch
* **Descripción**: Fotobiorreactores de Microalgas para Fijacion de CO2 y Produccion de Biocombustibles

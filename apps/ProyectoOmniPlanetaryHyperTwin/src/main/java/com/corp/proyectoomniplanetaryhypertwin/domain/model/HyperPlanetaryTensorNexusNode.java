package com.corp.proyectoomniplanetaryhypertwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HyperPlanetaryTensorNexusNode.
 * 
 ...
 */
public record HyperPlanetaryTensorNexusNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HyperPlanetaryTensorNexusNode {
    ...
    public HyperPlanetaryTensorNexusNode withStatus(String newStatus) {
        return new HyperPlanetaryTensorNexusNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoomniplanetaryhypertwin.domain;
...
class HyperPlanetaryTensorNexusNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HyperPlanetaryTensorNexusNode entity = new HyperPlanetaryTensorNexusNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HyperPlanetaryTensorNexusNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectostemcellorgantissuebioprinting.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: BioinkScaffoldPerfusionGridNode.
 * 
 ...
 */
public record BioinkScaffoldPerfusionGridNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BioinkScaffoldPerfusionGridNode {
    ...
    public BioinkScaffoldPerfusionGridNode withStatus(String newStatus) {
        return new BioinkScaffoldPerfusionGridNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectostemcellorgantissuebioprinting.domain;
...
class BioinkScaffoldPerfusionGridNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BioinkScaffoldPerfusionGridNode entity = new BioinkScaffoldPerfusionGridNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BioinkScaffoldPerfusionGridNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

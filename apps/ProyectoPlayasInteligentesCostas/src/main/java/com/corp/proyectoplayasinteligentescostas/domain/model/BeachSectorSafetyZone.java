...
/**
 * Entidad de Dominio Puro: BeachSectorSafetyZone.
 * 
 ...
 */
public record BeachSectorSafetyZone(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BeachSectorSafetyZone withStatus(String newStatus) {
        return new BeachSectorSafetyZone(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

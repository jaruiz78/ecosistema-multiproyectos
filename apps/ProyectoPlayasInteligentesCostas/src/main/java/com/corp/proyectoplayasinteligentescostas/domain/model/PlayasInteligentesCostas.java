package com.corp.proyectoplayasinteligentescostas.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PlayasInteligentesCostas.
 ...
 */
public record PlayasInteligentesCostas(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PlayasInteligentesCostas {
    ...
    public PlayasInteligentesCostas withStatus(String newStatus) {
        return new PlayasInteligentesCostas(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

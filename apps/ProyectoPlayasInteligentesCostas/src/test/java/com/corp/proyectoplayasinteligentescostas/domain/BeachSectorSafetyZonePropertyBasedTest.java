...
class BeachSectorSafetyZonePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BeachSectorSafetyZone entity = new BeachSectorSafetyZone(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BeachSectorSafetyZone(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectopostquantumcertificateauthority.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PqHybridX509CertificateToken.
 * 
 ...
 */
public record PqHybridX509CertificateToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PqHybridX509CertificateToken {
    ...
    public PqHybridX509CertificateToken withStatus(String newStatus) {
        return new PqHybridX509CertificateToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

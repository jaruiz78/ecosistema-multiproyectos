package com.corp.proyectopostquantumcertificateauthority.domain;
...
class PqHybridX509CertificateTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PqHybridX509CertificateToken entity = new PqHybridX509CertificateToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PqHybridX509CertificateToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

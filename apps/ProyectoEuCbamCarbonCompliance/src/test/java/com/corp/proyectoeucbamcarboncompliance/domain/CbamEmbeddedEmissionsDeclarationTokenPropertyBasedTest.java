package com.corp.proyectoeucbamcarboncompliance.domain;
...
class CbamEmbeddedEmissionsDeclarationTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CbamEmbeddedEmissionsDeclarationToken entity = new CbamEmbeddedEmissionsDeclarationToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CbamEmbeddedEmissionsDeclarationToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

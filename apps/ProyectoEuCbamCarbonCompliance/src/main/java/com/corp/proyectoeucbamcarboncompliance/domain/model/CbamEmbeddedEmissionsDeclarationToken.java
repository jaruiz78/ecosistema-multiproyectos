package com.corp.proyectoeucbamcarboncompliance.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CbamEmbeddedEmissionsDeclarationToken.
 * 
 ...
 */
public record CbamEmbeddedEmissionsDeclarationToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CbamEmbeddedEmissionsDeclarationToken {
    ...
    public CbamEmbeddedEmissionsDeclarationToken withStatus(String newStatus) {
        return new CbamEmbeddedEmissionsDeclarationToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

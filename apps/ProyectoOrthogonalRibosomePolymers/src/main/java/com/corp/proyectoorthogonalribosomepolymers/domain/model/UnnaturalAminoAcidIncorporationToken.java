package com.corp.proyectoorthogonalribosomepolymers.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: UnnaturalAminoAcidIncorporationToken.
 * 
 ...
 */
public record UnnaturalAminoAcidIncorporationToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public UnnaturalAminoAcidIncorporationToken {
    ...
    public UnnaturalAminoAcidIncorporationToken withStatus(String newStatus) {
        return new UnnaturalAminoAcidIncorporationToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

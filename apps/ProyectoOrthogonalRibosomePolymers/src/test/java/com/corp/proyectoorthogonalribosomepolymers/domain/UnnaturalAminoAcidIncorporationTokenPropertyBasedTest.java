package com.corp.proyectoorthogonalribosomepolymers.domain;
...
class UnnaturalAminoAcidIncorporationTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            UnnaturalAminoAcidIncorporationToken entity = new UnnaturalAminoAcidIncorporationToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new UnnaturalAminoAcidIncorporationToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

...
class GeothermalBoreholeHeatExchangerNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            GeothermalBoreholeHeatExchangerNode entity = new GeothermalBoreholeHeatExchangerNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new GeothermalBoreholeHeatExchangerNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

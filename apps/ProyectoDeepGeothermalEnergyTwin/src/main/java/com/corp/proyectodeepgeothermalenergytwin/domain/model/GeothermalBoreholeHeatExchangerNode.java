package com.corp.proyectodeepgeothermalenergytwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GeothermalBoreholeHeatExchangerNode.
 * 
 ...
 */
public record GeothermalBoreholeHeatExchangerNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public GeothermalBoreholeHeatExchangerNode {
    ...
    public GeothermalBoreholeHeatExchangerNode withStatus(String newStatus) {
        return new GeothermalBoreholeHeatExchangerNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

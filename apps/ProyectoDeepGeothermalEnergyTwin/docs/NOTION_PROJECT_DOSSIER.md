# 🏛️ NOTION DOSSIER: ProyectoDeepGeothermalEnergyTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoDeepGeothermalEnergyTwin
* **Entidad Dominio**: GeothermalBoreholeHeatExchangerNode
* **Descripción**: Gemelo Digital de Sistemas Geotermicos Estimulados Profundos (EGS) y Generacion de Vapor

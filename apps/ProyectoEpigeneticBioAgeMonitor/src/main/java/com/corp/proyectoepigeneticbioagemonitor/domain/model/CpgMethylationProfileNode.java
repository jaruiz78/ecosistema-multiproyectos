package com.corp.proyectoepigeneticbioagemonitor.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CpgMethylationProfileNode.
 * 
 ...
 */
public record CpgMethylationProfileNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CpgMethylationProfileNode {
    ...
    public CpgMethylationProfileNode withStatus(String newStatus) {
        return new CpgMethylationProfileNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

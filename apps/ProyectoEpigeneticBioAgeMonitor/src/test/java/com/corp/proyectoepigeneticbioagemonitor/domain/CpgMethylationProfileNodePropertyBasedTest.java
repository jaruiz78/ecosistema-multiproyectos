package com.corp.proyectoepigeneticbioagemonitor.domain;
...
class CpgMethylationProfileNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CpgMethylationProfileNode entity = new CpgMethylationProfileNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CpgMethylationProfileNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

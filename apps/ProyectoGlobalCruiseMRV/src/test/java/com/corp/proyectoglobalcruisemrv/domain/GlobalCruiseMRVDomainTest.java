package com.corp.proyectoglobalcruisemrv.domain;
...
class GlobalCruiseMRVDomainTest {

    @Test
    @DisplayName("Debe crear la entidad GlobalCruiseMRV con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new GlobalCruiseMRV(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

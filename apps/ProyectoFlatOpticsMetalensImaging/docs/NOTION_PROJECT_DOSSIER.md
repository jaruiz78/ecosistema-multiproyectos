# 🏛️ NOTION DOSSIER: ProyectoFlatOpticsMetalensImaging

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoFlatOpticsMetalensImaging
* **Entidad Dominio**: MetalensPhaseProfileMatrixBatch
* **Descripción**: Optica Plana y Metalentes Dielectricas para Micro-Satelites y Drones

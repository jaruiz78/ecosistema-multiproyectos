package com.corp.proyectoflatopticsmetalensimaging.domain;
...
class MetalensPhaseProfileMatrixBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MetalensPhaseProfileMatrixBatch entity = new MetalensPhaseProfileMatrixBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MetalensPhaseProfileMatrixBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoflatopticsmetalensimaging.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MetalensPhaseProfileMatrixBatch.
 * 
 ...
 */
public record MetalensPhaseProfileMatrixBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MetalensPhaseProfileMatrixBatch {
    ...
    public MetalensPhaseProfileMatrixBatch withStatus(String newStatus) {
        return new MetalensPhaseProfileMatrixBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

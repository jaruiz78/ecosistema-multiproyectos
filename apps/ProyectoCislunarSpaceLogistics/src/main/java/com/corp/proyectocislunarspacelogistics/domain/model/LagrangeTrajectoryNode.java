...
/**
 * Entidad de Dominio Puro: LagrangeTrajectoryNode.
 * 
 ...
 */
public record LagrangeTrajectoryNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public LagrangeTrajectoryNode withStatus(String newStatus) {
        return new LagrangeTrajectoryNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

...
class LagrangeTrajectoryNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            LagrangeTrajectoryNode entity = new LagrangeTrajectoryNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new LagrangeTrajectoryNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectocoastalsurgeflooddefense.domain;
...
class StormSurgeElevationForecastNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            StormSurgeElevationForecastNode entity = new StormSurgeElevationForecastNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new StormSurgeElevationForecastNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

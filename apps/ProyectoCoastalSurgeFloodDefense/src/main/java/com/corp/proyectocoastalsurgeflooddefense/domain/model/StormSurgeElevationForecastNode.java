package com.corp.proyectocoastalsurgeflooddefense.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: StormSurgeElevationForecastNode.
 * 
 ...
 */
public record StormSurgeElevationForecastNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public StormSurgeElevationForecastNode {
    ...
    public StormSurgeElevationForecastNode withStatus(String newStatus) {
        return new StormSurgeElevationForecastNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoenoturismorutasvino.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: VineyardParcelBooking.
 * 
 ...
 */
public record VineyardParcelBooking(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public VineyardParcelBooking withStatus(String newStatus) {
        return new VineyardParcelBooking(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

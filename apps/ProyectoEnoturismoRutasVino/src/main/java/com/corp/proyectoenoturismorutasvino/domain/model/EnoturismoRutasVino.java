...
/**
 * Entidad de Dominio Puro: EnoturismoRutasVino.
 ...
 */
public record EnoturismoRutasVino(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EnoturismoRutasVino withStatus(String newStatus) {
        return new EnoturismoRutasVino(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

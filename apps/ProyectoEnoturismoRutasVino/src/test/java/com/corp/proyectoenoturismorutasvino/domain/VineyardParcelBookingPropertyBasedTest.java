...
class VineyardParcelBookingPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            VineyardParcelBooking entity = new VineyardParcelBooking(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new VineyardParcelBooking(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

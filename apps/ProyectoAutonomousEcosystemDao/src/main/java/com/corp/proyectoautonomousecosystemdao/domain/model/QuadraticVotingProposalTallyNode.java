package com.corp.proyectoautonomousecosystemdao.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: QuadraticVotingProposalTallyNode.
 * 
 ...
 */
public record QuadraticVotingProposalTallyNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public QuadraticVotingProposalTallyNode {
    ...
    public QuadraticVotingProposalTallyNode withStatus(String newStatus) {
        return new QuadraticVotingProposalTallyNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

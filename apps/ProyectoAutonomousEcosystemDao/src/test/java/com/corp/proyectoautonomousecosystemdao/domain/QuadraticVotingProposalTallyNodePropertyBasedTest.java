package com.corp.proyectoautonomousecosystemdao.domain;
...
class QuadraticVotingProposalTallyNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            QuadraticVotingProposalTallyNode entity = new QuadraticVotingProposalTallyNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new QuadraticVotingProposalTallyNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

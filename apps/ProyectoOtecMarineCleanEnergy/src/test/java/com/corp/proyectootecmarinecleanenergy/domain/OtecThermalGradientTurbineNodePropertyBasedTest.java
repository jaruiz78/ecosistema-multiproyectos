package com.corp.proyectootecmarinecleanenergy.domain;
...
class OtecThermalGradientTurbineNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            OtecThermalGradientTurbineNode entity = new OtecThermalGradientTurbineNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new OtecThermalGradientTurbineNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

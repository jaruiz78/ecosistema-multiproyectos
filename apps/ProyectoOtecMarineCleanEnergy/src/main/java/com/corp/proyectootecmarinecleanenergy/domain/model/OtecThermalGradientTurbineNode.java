package com.corp.proyectootecmarinecleanenergy.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: OtecThermalGradientTurbineNode.
 * 
 ...
 */
public record OtecThermalGradientTurbineNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public OtecThermalGradientTurbineNode {
    ...
    public OtecThermalGradientTurbineNode withStatus(String newStatus) {
        return new OtecThermalGradientTurbineNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

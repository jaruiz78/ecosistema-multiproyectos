package com.corp.proyectohyporheicwaterpurification.domain;
...
class HyporheicNitrateDenitrificationNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HyporheicNitrateDenitrificationNode entity = new HyporheicNitrateDenitrificationNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HyporheicNitrateDenitrificationNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectohyporheicwaterpurification.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HyporheicNitrateDenitrificationNode.
 * 
 ...
 */
public record HyporheicNitrateDenitrificationNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HyporheicNitrateDenitrificationNode {
    ...
    public HyporheicNitrateDenitrificationNode withStatus(String newStatus) {
        return new HyporheicNitrateDenitrificationNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoCyanobacteriaBioNitrogenFertilizer

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCyanobacteriaBioNitrogenFertilizer
* **Entidad Dominio**: HeterocystNitrogenaseFluxNode
* **Descripción**: Biofertilizantes Fototroficos de Nitrogeno con Cianobacterias

package com.corp.proyectocyanobacteriabionitrogenfertilizer.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HeterocystNitrogenaseFluxNode.
 * 
 ...
 */
public record HeterocystNitrogenaseFluxNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HeterocystNitrogenaseFluxNode {
    ...
    public HeterocystNitrogenaseFluxNode withStatus(String newStatus) {
        return new HeterocystNitrogenaseFluxNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

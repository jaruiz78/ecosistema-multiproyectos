package com.corp.proyectoreusablerocketlandingtwin.domain;
...
class RocketRetroLandingTrajectoryNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            RocketRetroLandingTrajectoryNode entity = new RocketRetroLandingTrajectoryNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new RocketRetroLandingTrajectoryNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

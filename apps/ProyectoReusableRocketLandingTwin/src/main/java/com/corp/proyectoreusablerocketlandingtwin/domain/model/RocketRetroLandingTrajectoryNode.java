package com.corp.proyectoreusablerocketlandingtwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: RocketRetroLandingTrajectoryNode.
 * 
 ...
 */
public record RocketRetroLandingTrajectoryNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public RocketRetroLandingTrajectoryNode {
    ...
    public RocketRetroLandingTrajectoryNode withStatus(String newStatus) {
        return new RocketRetroLandingTrajectoryNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

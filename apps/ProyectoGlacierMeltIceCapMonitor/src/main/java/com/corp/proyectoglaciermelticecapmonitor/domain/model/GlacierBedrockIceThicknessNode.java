package com.corp.proyectoglaciermelticecapmonitor.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GlacierBedrockIceThicknessNode.
 * 
 ...
 */
public record GlacierBedrockIceThicknessNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public GlacierBedrockIceThicknessNode {
    ...
    public GlacierBedrockIceThicknessNode withStatus(String newStatus) {
        return new GlacierBedrockIceThicknessNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

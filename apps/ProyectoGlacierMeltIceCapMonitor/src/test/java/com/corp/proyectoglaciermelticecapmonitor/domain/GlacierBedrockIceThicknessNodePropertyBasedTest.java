package com.corp.proyectoglaciermelticecapmonitor.domain;
...
class GlacierBedrockIceThicknessNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            GlacierBedrockIceThicknessNode entity = new GlacierBedrockIceThicknessNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new GlacierBedrockIceThicknessNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

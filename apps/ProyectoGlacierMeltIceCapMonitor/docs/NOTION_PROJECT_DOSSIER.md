# 🏛️ NOTION DOSSIER: ProyectoGlacierMeltIceCapMonitor

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoGlacierMeltIceCapMonitor
* **Entidad Dominio**: GlacierBedrockIceThicknessNode
* **Descripción**: Monitorizacion Radar de Deshielo Glaciar y Dinamica de Masas de Hielo Polar

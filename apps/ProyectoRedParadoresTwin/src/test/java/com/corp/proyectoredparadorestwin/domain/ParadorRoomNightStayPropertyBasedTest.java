package com.corp.proyectoredparadorestwin.domain;
...
class ParadorRoomNightStayPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ParadorRoomNightStay entity = new ParadorRoomNightStay(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ParadorRoomNightStay(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

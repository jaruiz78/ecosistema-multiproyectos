...
/**
 * Entidad de Dominio Puro: ParadorRoomNightStay.
 * 
 ...
 */
public record ParadorRoomNightStay(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ParadorRoomNightStay withStatus(String newStatus) {
        return new ParadorRoomNightStay(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectographenedesalcleanwater.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GrapheneNanoporeMembraneBatch.
 * 
 ...
 */
public record GrapheneNanoporeMembraneBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public GrapheneNanoporeMembraneBatch {
    ...
    public GrapheneNanoporeMembraneBatch withStatus(String newStatus) {
        return new GrapheneNanoporeMembraneBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectocgraspatialaccelerator.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CgraComputeMeshTileNode.
 * 
 ...
 */
public record CgraComputeMeshTileNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CgraComputeMeshTileNode {
    ...
    public CgraComputeMeshTileNode withStatus(String newStatus) {
        return new CgraComputeMeshTileNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectocgraspatialaccelerator.domain;
...
class CgraComputeMeshTileNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CgraComputeMeshTileNode entity = new CgraComputeMeshTileNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CgraComputeMeshTileNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

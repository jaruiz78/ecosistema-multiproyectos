# 🏛️ NOTION DOSSIER: ProyectoCgraSpatialAccelerator

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCgraSpatialAccelerator
* **Entidad Dominio**: CgraComputeMeshTileNode
* **Descripción**: Aceleradores Espaciales CGRA para Inferencia Tensorial de Baja Potencia

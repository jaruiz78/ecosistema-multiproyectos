package com.corp.proyectophagedisplaydirectedevolution.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PhageDisplayAffinityEnrichmentToken.
 * 
 ...
 */
public record PhageDisplayAffinityEnrichmentToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PhageDisplayAffinityEnrichmentToken {
    ...
    public PhageDisplayAffinityEnrichmentToken withStatus(String newStatus) {
        return new PhageDisplayAffinityEnrichmentToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

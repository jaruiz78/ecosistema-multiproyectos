package com.corp.proyectophagedisplaydirectedevolution.domain;
...
class PhageDisplayAffinityEnrichmentTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PhageDisplayAffinityEnrichmentToken entity = new PhageDisplayAffinityEnrichmentToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PhageDisplayAffinityEnrichmentToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectohydrogenfuelcelllongrangedrone.domain;
...
class PemFuelCellStackEfficiencyNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PemFuelCellStackEfficiencyNode entity = new PemFuelCellStackEfficiencyNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PemFuelCellStackEfficiencyNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

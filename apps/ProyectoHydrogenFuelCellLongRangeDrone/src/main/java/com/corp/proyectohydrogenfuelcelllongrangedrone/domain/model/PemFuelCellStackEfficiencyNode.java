package com.corp.proyectohydrogenfuelcelllongrangedrone.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PemFuelCellStackEfficiencyNode.
 * 
 ...
 */
public record PemFuelCellStackEfficiencyNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PemFuelCellStackEfficiencyNode {
    ...
    public PemFuelCellStackEfficiencyNode withStatus(String newStatus) {
        return new PemFuelCellStackEfficiencyNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

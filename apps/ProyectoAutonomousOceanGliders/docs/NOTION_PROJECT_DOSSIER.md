# 🏛️ NOTION DOSSIER: ProyectoAutonomousOceanGliders

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoAutonomousOceanGliders
* **Entidad Dominio**: AuvSubmarineTrackWaypointNode
* **Descripción**: Flota de Planeadores Submarinos Autonomos (AUV) para Exploracion Oceanografica

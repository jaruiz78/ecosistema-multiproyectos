package com.corp.proyectoautonomousoceangliders.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AuvSubmarineTrackWaypointNode.
 * 
 ...
 */
public record AuvSubmarineTrackWaypointNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AuvSubmarineTrackWaypointNode {
    ...
    public AuvSubmarineTrackWaypointNode withStatus(String newStatus) {
        return new AuvSubmarineTrackWaypointNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoautonomousoceangliders.domain;
...
class AuvSubmarineTrackWaypointNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AuvSubmarineTrackWaypointNode entity = new AuvSubmarineTrackWaypointNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AuvSubmarineTrackWaypointNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

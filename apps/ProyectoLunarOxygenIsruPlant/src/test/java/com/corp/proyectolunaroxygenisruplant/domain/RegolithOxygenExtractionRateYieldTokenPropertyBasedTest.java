package com.corp.proyectolunaroxygenisruplant.domain;
...
class RegolithOxygenExtractionRateYieldTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            RegolithOxygenExtractionRateYieldToken entity = new RegolithOxygenExtractionRateYieldToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new RegolithOxygenExtractionRateYieldToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

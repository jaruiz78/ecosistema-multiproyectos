package com.corp.proyectolunaroxygenisruplant.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: RegolithOxygenExtractionRateYieldToken.
 * 
 ...
 */
public record RegolithOxygenExtractionRateYieldToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public RegolithOxygenExtractionRateYieldToken {
    ...
    public RegolithOxygenExtractionRateYieldToken withStatus(String newStatus) {
        return new RegolithOxygenExtractionRateYieldToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

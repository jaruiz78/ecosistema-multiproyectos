...
/**
 * Entidad de Dominio Puro: Energia.
...
public record Energia(
    ...
    public Energia withStatus(String newStatus) {
        return new Energia(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

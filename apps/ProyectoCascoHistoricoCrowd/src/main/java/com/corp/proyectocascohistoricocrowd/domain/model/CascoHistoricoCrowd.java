package com.corp.proyectocascohistoricocrowd.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CascoHistoricoCrowd.
 ...
 */
public record CascoHistoricoCrowd(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CascoHistoricoCrowd withStatus(String newStatus) {
        return new CascoHistoricoCrowd(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

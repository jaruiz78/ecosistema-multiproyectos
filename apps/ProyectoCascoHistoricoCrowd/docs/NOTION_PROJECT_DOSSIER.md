# 🏛️ NOTION DOSSIER: ProyectoCascoHistoricoCrowd

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCascoHistoricoCrowd
* **Entidad Dominio**: CascoHistoricoCrowd
* **Descripción**: Microservicio Vertical Especializado en CascoHistoricoCrowd para el Ecosistema Corporativo.

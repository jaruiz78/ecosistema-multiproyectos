# 🏛️ NOTION DOSSIER: ProyectoStratosphericAerosolLidarNetwork

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoStratosphericAerosolLidarNetwork
* **Entidad Dominio**: AerosolBackscatterExtinctionProfileNode
* **Descripción**: Red de Lidar Estratosferico para Monitorizacion de Aerosoles y Clima

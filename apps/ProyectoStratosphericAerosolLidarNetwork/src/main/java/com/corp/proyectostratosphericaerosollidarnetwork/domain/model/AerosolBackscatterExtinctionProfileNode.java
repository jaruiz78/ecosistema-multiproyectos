package com.corp.proyectostratosphericaerosollidarnetwork.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AerosolBackscatterExtinctionProfileNode.
 * 
 ...
 */
public record AerosolBackscatterExtinctionProfileNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AerosolBackscatterExtinctionProfileNode {
    ...
    public AerosolBackscatterExtinctionProfileNode withStatus(String newStatus) {
        return new AerosolBackscatterExtinctionProfileNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectostratosphericaerosollidarnetwork.domain;
...
class AerosolBackscatterExtinctionProfileNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AerosolBackscatterExtinctionProfileNode entity = new AerosolBackscatterExtinctionProfileNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AerosolBackscatterExtinctionProfileNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoatomicforcenanotopography.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AfmCantileverDeflectionScanNode.
 * 
 ...
 */
public record AfmCantileverDeflectionScanNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AfmCantileverDeflectionScanNode {
    ...
    public AfmCantileverDeflectionScanNode withStatus(String newStatus) {
        return new AfmCantileverDeflectionScanNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoatomicforcenanotopography.domain;
...
class AfmCantileverDeflectionScanNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AfmCantileverDeflectionScanNode entity = new AfmCantileverDeflectionScanNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AfmCantileverDeflectionScanNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

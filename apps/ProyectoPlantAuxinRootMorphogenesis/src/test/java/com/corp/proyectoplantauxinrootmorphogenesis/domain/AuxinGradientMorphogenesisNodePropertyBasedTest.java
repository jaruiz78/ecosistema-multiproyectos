package com.corp.proyectoplantauxinrootmorphogenesis.domain;
...
class AuxinGradientMorphogenesisNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AuxinGradientMorphogenesisNode entity = new AuxinGradientMorphogenesisNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AuxinGradientMorphogenesisNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoplantauxinrootmorphogenesis.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AuxinGradientMorphogenesisNode.
 * 
 ...
 */
public record AuxinGradientMorphogenesisNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AuxinGradientMorphogenesisNode {
    ...
    public AuxinGradientMorphogenesisNode withStatus(String newStatus) {
        return new AuxinGradientMorphogenesisNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

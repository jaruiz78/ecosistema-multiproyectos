package com.corp.proyectosuborbitalspacetourismtwin.domain;
...
class SpaceTourismPassengerGForceNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SpaceTourismPassengerGForceNode entity = new SpaceTourismPassengerGForceNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SpaceTourismPassengerGForceNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

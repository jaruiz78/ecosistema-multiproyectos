package com.corp.proyectosuborbitalspacetourismtwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SpaceTourismPassengerGForceNode.
 * 
 ...
 */
public record SpaceTourismPassengerGForceNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SpaceTourismPassengerGForceNode {
    ...
    public SpaceTourismPassengerGForceNode withStatus(String newStatus) {
        return new SpaceTourismPassengerGForceNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

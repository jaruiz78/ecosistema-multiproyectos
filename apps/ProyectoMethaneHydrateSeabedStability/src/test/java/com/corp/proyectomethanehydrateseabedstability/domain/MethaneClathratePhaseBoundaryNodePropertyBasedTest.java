package com.corp.proyectomethanehydrateseabedstability.domain;
...
class MethaneClathratePhaseBoundaryNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MethaneClathratePhaseBoundaryNode entity = new MethaneClathratePhaseBoundaryNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MethaneClathratePhaseBoundaryNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectomethanehydrateseabedstability.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MethaneClathratePhaseBoundaryNode.
 * 
 ...
 */
public record MethaneClathratePhaseBoundaryNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MethaneClathratePhaseBoundaryNode {
    ...
    public MethaneClathratePhaseBoundaryNode withStatus(String newStatus) {
        return new MethaneClathratePhaseBoundaryNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

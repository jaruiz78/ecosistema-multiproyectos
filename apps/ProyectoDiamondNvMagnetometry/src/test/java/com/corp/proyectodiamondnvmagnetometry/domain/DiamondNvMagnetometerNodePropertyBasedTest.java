package com.corp.proyectodiamondnvmagnetometry.domain;
...
class DiamondNvMagnetometerNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DiamondNvMagnetometerNode entity = new DiamondNvMagnetometerNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DiamondNvMagnetometerNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

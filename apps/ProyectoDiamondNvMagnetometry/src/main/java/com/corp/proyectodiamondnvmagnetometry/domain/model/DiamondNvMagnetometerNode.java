package com.corp.proyectodiamondnvmagnetometry.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DiamondNvMagnetometerNode.
 * 
 ...
 */
public record DiamondNvMagnetometerNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DiamondNvMagnetometerNode {
    ...
    public DiamondNvMagnetometerNode withStatus(String newStatus) {
        return new DiamondNvMagnetometerNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

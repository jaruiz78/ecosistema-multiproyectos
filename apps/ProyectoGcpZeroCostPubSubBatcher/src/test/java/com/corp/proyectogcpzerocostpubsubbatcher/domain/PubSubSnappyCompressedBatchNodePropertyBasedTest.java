package com.corp.proyectogcpzerocostpubsubbatcher.domain;
...
class PubSubSnappyCompressedBatchNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PubSubSnappyCompressedBatchNode entity = new PubSubSnappyCompressedBatchNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PubSubSnappyCompressedBatchNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

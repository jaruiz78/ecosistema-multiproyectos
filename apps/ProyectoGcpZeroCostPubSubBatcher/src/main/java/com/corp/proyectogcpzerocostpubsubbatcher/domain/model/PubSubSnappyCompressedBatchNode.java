package com.corp.proyectogcpzerocostpubsubbatcher.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PubSubSnappyCompressedBatchNode.
 * 
 ...
 */
public record PubSubSnappyCompressedBatchNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PubSubSnappyCompressedBatchNode {
    ...
    public PubSubSnappyCompressedBatchNode withStatus(String newStatus) {
        return new PubSubSnappyCompressedBatchNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoquantumsatellitesar.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: InSarDisplacementTrackNode.
 * 
 ...
 */
public record InSarDisplacementTrackNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public InSarDisplacementTrackNode {
    ...
    public InSarDisplacementTrackNode withStatus(String newStatus) {
        return new InSarDisplacementTrackNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoTruckPlatooningHighwayCorridor

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoTruckPlatooningHighwayCorridor
* **Entidad Dominio**: TruckPlatoonVehicleLeaderNode
* **Descripción**: Pelotones Autonomos de Camiones de Mercancias con Comunicacion V2V CACC

package com.corp.proyectotruckplatooninghighwaycorridor.domain;
...
class TruckPlatoonVehicleLeaderNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            TruckPlatoonVehicleLeaderNode entity = new TruckPlatoonVehicleLeaderNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new TruckPlatoonVehicleLeaderNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectotruckplatooninghighwaycorridor.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: TruckPlatoonVehicleLeaderNode.
 * 
 ...
 */
public record TruckPlatoonVehicleLeaderNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public TruckPlatoonVehicleLeaderNode {
    ...
    public TruckPlatoonVehicleLeaderNode withStatus(String newStatus) {
        return new TruckPlatoonVehicleLeaderNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

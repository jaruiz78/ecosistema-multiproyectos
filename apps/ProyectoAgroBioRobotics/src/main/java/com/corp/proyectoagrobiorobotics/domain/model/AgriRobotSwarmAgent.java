...
/**
 * Entidad de Dominio Puro: AgriRobotSwarmAgent.
 * 
 ...
 */
public record AgriRobotSwarmAgent(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AgriRobotSwarmAgent withStatus(String newStatus) {
        return new AgriRobotSwarmAgent(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

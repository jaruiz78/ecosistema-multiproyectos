...
class AgriRobotSwarmAgentPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AgriRobotSwarmAgent entity = new AgriRobotSwarmAgent(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AgriRobotSwarmAgent(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

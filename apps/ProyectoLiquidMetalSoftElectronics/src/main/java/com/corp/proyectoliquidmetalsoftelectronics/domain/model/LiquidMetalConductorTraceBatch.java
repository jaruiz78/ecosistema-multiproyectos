package com.corp.proyectoliquidmetalsoftelectronics.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: LiquidMetalConductorTraceBatch.
 * 
 ...
 */
public record LiquidMetalConductorTraceBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public LiquidMetalConductorTraceBatch {
    ...
    public LiquidMetalConductorTraceBatch withStatus(String newStatus) {
        return new LiquidMetalConductorTraceBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

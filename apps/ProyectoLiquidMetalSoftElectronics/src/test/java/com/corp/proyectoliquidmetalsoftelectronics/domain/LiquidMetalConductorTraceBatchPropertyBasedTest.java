package com.corp.proyectoliquidmetalsoftelectronics.domain;
...
class LiquidMetalConductorTraceBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            LiquidMetalConductorTraceBatch entity = new LiquidMetalConductorTraceBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new LiquidMetalConductorTraceBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

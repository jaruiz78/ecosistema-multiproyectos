package com.corp.proyectocryoagrifoodlogistics.domain;
...
class CryogenicTelemetryBatchNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CryogenicTelemetryBatchNode entity = new CryogenicTelemetryBatchNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CryogenicTelemetryBatchNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectocryoagrifoodlogistics.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CryogenicTelemetryBatchNode.
 * 
 ...
 */
public record CryogenicTelemetryBatchNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CryogenicTelemetryBatchNode {
    ...
    public CryogenicTelemetryBatchNode withStatus(String newStatus) {
        return new CryogenicTelemetryBatchNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

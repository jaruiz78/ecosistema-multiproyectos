package com.corp.proyectocatastrofes.domain;
...
class CatastrofesDomainTest {

    @Test
    @DisplayName("Debe crear la entidad Catastrofes con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new Catastrofes(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

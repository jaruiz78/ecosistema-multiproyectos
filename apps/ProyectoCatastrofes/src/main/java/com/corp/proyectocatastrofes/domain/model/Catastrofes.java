package com.corp.proyectocatastrofes.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: Catastrofes.
...
public record Catastrofes(
    ...
    public Catastrofes withStatus(String newStatus) {
        return new Catastrofes(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🚀 ProyectoCatastrofes: Simulación de Emergencias y Autómatas Celulares
...
## 1. Visión General
Vertical para la predicción de propagación de incendios e inundaciones y rutas de evacuación rápida.

### Bounded Context & Dominio
* **Dominio Principal:** Frentes de fuego, celdas de evacuación H3, gestión de albergues.

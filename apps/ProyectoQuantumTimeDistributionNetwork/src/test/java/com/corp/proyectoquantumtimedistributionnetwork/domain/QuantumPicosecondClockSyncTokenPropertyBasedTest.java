package com.corp.proyectoquantumtimedistributionnetwork.domain;
...
class QuantumPicosecondClockSyncTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            QuantumPicosecondClockSyncToken entity = new QuantumPicosecondClockSyncToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new QuantumPicosecondClockSyncToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

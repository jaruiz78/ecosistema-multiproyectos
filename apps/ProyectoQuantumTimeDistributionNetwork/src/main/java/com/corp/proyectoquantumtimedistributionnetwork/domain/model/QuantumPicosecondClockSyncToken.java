package com.corp.proyectoquantumtimedistributionnetwork.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: QuantumPicosecondClockSyncToken.
 * 
 ...
 */
public record QuantumPicosecondClockSyncToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public QuantumPicosecondClockSyncToken {
    ...
    public QuantumPicosecondClockSyncToken withStatus(String newStatus) {
        return new QuantumPicosecondClockSyncToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

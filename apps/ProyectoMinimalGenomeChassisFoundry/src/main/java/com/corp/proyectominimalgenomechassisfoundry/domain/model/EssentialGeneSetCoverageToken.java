package com.corp.proyectominimalgenomechassisfoundry.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EssentialGeneSetCoverageToken.
 * 
 ...
 */
public record EssentialGeneSetCoverageToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EssentialGeneSetCoverageToken {
    ...
    public EssentialGeneSetCoverageToken withStatus(String newStatus) {
        return new EssentialGeneSetCoverageToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectominimalgenomechassisfoundry.domain;
...
class EssentialGeneSetCoverageTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EssentialGeneSetCoverageToken entity = new EssentialGeneSetCoverageToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EssentialGeneSetCoverageToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

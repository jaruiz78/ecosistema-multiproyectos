package com.corp.proyectoparametricweatherinsurance.domain;
...
class ParametricInsurancePolicyPayoutTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ParametricInsurancePolicyPayoutToken entity = new ParametricInsurancePolicyPayoutToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ParametricInsurancePolicyPayoutToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

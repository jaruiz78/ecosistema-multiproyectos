package com.corp.proyectoparametricweatherinsurance.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ParametricInsurancePolicyPayoutToken.
 * 
 ...
 */
public record ParametricInsurancePolicyPayoutToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ParametricInsurancePolicyPayoutToken {
    ...
    public ParametricInsurancePolicyPayoutToken withStatus(String newStatus) {
        return new ParametricInsurancePolicyPayoutToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

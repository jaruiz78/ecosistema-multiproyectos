# 🏛️ NOTION DOSSIER: ProyectoParametricWeatherInsurance

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoParametricWeatherInsurance
* **Entidad Dominio**: ParametricInsurancePolicyPayoutToken
* **Descripción**: Seguros Parametricos Climatologicos con Liquidacion Instantanea para Regantes

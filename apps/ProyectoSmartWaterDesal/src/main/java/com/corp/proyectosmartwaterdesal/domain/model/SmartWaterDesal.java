package com.corp.proyectosmartwaterdesal.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SmartWaterDesal.
...
public record SmartWaterDesal(
    ...
    public SmartWaterDesal withStatus(String newStatus) {
        return new SmartWaterDesal(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

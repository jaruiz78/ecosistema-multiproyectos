package com.corp.proyectographenefastchargestorage.domain;
...
class GrapheneSupercapacitorCellBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            GrapheneSupercapacitorCellBatch entity = new GrapheneSupercapacitorCellBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new GrapheneSupercapacitorCellBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

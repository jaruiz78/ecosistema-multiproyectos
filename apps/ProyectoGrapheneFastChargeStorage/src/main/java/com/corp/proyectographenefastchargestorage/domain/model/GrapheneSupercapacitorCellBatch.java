package com.corp.proyectographenefastchargestorage.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GrapheneSupercapacitorCellBatch.
 * 
 ...
 */
public record GrapheneSupercapacitorCellBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public GrapheneSupercapacitorCellBatch {
    ...
    public GrapheneSupercapacitorCellBatch withStatus(String newStatus) {
        return new GrapheneSupercapacitorCellBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

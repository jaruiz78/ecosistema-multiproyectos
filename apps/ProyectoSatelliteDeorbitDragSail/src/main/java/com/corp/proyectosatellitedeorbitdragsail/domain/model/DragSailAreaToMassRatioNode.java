package com.corp.proyectosatellitedeorbitdragsail.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DragSailAreaToMassRatioNode.
 * 
 ...
 */
public record DragSailAreaToMassRatioNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DragSailAreaToMassRatioNode {
    ...
    public DragSailAreaToMassRatioNode withStatus(String newStatus) {
        return new DragSailAreaToMassRatioNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

...
class DragSailAreaToMassRatioNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DragSailAreaToMassRatioNode entity = new DragSailAreaToMassRatioNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DragSailAreaToMassRatioNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

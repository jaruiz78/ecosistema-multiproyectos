# 🏛️ NOTION DOSSIER: ProyectoSatelliteDeorbitDragSail

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoSatelliteDeorbitDragSail
* **Entidad Dominio**: DragSailAreaToMassRatioNode
* **Descripción**: Velas Aerodinamicas de Desorbitado Limpio al Final de Vida Util

package com.corp.proyectomyceliumbioconstruction.domain;
...
class MyceliumCompositeStructuralBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MyceliumCompositeStructuralBatch entity = new MyceliumCompositeStructuralBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MyceliumCompositeStructuralBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

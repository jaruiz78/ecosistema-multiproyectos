package com.corp.proyectomyceliumbioconstruction.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MyceliumCompositeStructuralBatch.
 * 
 ...
 */
public record MyceliumCompositeStructuralBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MyceliumCompositeStructuralBatch {
    ...
    public MyceliumCompositeStructuralBatch withStatus(String newStatus) {
        return new MyceliumCompositeStructuralBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

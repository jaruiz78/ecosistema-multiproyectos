# 🏛️ NOTION DOSSIER: ProyectoMyceliumBioConstruction

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoMyceliumBioConstruction
* **Entidad Dominio**: MyceliumCompositeStructuralBatch
* **Descripción**: Materiales de Construccion Circulares y Aislantes Termicos basados en Micelio

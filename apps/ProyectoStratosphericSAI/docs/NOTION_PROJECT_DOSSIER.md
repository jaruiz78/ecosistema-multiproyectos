# 🏛️ NOTION DOSSIER: ProyectoStratosphericSAI

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoStratosphericSAI
* **Entidad Dominio**: AerosolInjectionPlume
* **Descripción**: Modelado estocástico de inyección de aerosoles estratosféricos y albedo solar planetario

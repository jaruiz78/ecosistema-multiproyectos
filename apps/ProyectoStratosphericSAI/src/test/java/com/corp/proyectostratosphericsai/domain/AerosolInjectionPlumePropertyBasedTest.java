package com.corp.proyectostratosphericsai.domain;
...
class AerosolInjectionPlumePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AerosolInjectionPlume entity = new AerosolInjectionPlume(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AerosolInjectionPlume(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

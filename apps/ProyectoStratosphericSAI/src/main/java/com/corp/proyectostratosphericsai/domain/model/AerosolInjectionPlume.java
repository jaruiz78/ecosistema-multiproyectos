package com.corp.proyectostratosphericsai.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AerosolInjectionPlume.
 * 
 ...
 */
public record AerosolInjectionPlume(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AerosolInjectionPlume withStatus(String newStatus) {
        return new AerosolInjectionPlume(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

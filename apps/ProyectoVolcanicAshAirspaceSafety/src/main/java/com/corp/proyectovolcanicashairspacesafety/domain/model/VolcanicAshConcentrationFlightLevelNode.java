package com.corp.proyectovolcanicashairspacesafety.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: VolcanicAshConcentrationFlightLevelNode.
 * 
 ...
 */
public record VolcanicAshConcentrationFlightLevelNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public VolcanicAshConcentrationFlightLevelNode {
    ...
    public VolcanicAshConcentrationFlightLevelNode withStatus(String newStatus) {
        return new VolcanicAshConcentrationFlightLevelNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

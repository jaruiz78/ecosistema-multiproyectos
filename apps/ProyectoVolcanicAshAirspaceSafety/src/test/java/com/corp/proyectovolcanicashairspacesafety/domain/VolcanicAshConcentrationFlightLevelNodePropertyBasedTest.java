package com.corp.proyectovolcanicashairspacesafety.domain;
...
class VolcanicAshConcentrationFlightLevelNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            VolcanicAshConcentrationFlightLevelNode entity = new VolcanicAshConcentrationFlightLevelNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new VolcanicAshConcentrationFlightLevelNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

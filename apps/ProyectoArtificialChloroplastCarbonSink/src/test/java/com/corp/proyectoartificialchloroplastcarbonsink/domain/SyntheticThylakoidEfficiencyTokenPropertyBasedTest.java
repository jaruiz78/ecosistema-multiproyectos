package com.corp.proyectoartificialchloroplastcarbonsink.domain;
...
class SyntheticThylakoidEfficiencyTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SyntheticThylakoidEfficiencyToken entity = new SyntheticThylakoidEfficiencyToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SyntheticThylakoidEfficiencyToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

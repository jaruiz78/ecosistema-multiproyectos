package com.corp.proyectoartificialchloroplastcarbonsink.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SyntheticThylakoidEfficiencyToken.
 * 
 ...
 */
public record SyntheticThylakoidEfficiencyToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SyntheticThylakoidEfficiencyToken {
    ...
    public SyntheticThylakoidEfficiencyToken withStatus(String newStatus) {
        return new SyntheticThylakoidEfficiencyToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

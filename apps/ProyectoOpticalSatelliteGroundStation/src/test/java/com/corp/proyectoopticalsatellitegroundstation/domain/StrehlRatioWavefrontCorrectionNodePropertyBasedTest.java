package com.corp.proyectoopticalsatellitegroundstation.domain;
...
class StrehlRatioWavefrontCorrectionNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            StrehlRatioWavefrontCorrectionNode entity = new StrehlRatioWavefrontCorrectionNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new StrehlRatioWavefrontCorrectionNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

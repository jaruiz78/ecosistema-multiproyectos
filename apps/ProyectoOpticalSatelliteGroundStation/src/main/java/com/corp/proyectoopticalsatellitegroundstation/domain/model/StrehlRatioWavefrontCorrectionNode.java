package com.corp.proyectoopticalsatellitegroundstation.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: StrehlRatioWavefrontCorrectionNode.
 * 
 ...
 */
public record StrehlRatioWavefrontCorrectionNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public StrehlRatioWavefrontCorrectionNode {
    ...
    public StrehlRatioWavefrontCorrectionNode withStatus(String newStatus) {
        return new StrehlRatioWavefrontCorrectionNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

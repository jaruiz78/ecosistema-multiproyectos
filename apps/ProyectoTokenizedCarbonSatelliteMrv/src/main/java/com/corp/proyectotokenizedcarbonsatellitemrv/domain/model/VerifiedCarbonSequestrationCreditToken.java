package com.corp.proyectotokenizedcarbonsatellitemrv.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: VerifiedCarbonSequestrationCreditToken.
 * 
 ...
 */
public record VerifiedCarbonSequestrationCreditToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public VerifiedCarbonSequestrationCreditToken {
    ...
    public VerifiedCarbonSequestrationCreditToken withStatus(String newStatus) {
        return new VerifiedCarbonSequestrationCreditToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

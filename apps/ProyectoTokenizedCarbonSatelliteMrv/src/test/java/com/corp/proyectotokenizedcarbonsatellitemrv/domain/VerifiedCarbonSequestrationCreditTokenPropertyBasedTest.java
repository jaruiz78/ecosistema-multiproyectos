...
class VerifiedCarbonSequestrationCreditTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            VerifiedCarbonSequestrationCreditToken entity = new VerifiedCarbonSequestrationCreditToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new VerifiedCarbonSequestrationCreditToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

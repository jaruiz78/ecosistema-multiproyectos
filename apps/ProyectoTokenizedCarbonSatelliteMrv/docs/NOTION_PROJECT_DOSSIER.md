# 🏛️ NOTION DOSSIER: ProyectoTokenizedCarbonSatelliteMrv

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoTokenizedCarbonSatelliteMrv
* **Entidad Dominio**: VerifiedCarbonSequestrationCreditToken
* **Descripción**: Emision y Liquidacion de Creditos de Carbono Tokenizados con Auditoria Satelital

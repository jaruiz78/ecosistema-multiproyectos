# 🏛️ NOTION DOSSIER: ProyectoAtmosphericWaterHarvesting

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoAtmosphericWaterHarvesting
* **Entidad Dominio**: MofWaterAdsorptionChamberNode
* **Descripción**: Generacion Atmosferica de Agua Potable mediante Materiales Porosos MOF en Climas Aridos

package com.corp.proyectoatmosphericwaterharvesting.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MofWaterAdsorptionChamberNode.
 * 
 ...
 */
public record MofWaterAdsorptionChamberNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MofWaterAdsorptionChamberNode {
    ...
    public MofWaterAdsorptionChamberNode withStatus(String newStatus) {
        return new MofWaterAdsorptionChamberNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoatmosphericwaterharvesting.domain;
...
class MofWaterAdsorptionChamberNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MofWaterAdsorptionChamberNode entity = new MofWaterAdsorptionChamberNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MofWaterAdsorptionChamberNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

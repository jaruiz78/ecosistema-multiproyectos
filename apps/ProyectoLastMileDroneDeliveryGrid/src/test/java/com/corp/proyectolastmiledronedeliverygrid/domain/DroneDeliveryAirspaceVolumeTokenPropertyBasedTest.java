package com.corp.proyectolastmiledronedeliverygrid.domain;
...
class DroneDeliveryAirspaceVolumeTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DroneDeliveryAirspaceVolumeToken entity = new DroneDeliveryAirspaceVolumeToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DroneDeliveryAirspaceVolumeToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectolastmiledronedeliverygrid.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DroneDeliveryAirspaceVolumeToken.
 * 
 ...
 */
public record DroneDeliveryAirspaceVolumeToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DroneDeliveryAirspaceVolumeToken {
    ...
    public DroneDeliveryAirspaceVolumeToken withStatus(String newStatus) {
        return new DroneDeliveryAirspaceVolumeToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectospintronicterahertzemitter.domain;
...
class SpintronicThzPulseWaveformNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SpintronicThzPulseWaveformNode entity = new SpintronicThzPulseWaveformNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SpintronicThzPulseWaveformNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectospintronicterahertzemitter.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SpintronicThzPulseWaveformNode.
 * 
 ...
 */
public record SpintronicThzPulseWaveformNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SpintronicThzPulseWaveformNode {
    ...
    public SpintronicThzPulseWaveformNode withStatus(String newStatus) {
        return new SpintronicThzPulseWaveformNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

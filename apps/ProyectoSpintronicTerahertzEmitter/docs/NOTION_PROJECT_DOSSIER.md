# 🏛️ NOTION DOSSIER: ProyectoSpintronicTerahertzEmitter

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoSpintronicTerahertzEmitter
* **Entidad Dominio**: SpintronicThzPulseWaveformNode
* **Descripción**: Fuentes de Radiacion Terahercica Espintronica para Inspeccion No Destructiva

...
class MicrogravityGProfileAccelerationNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MicrogravityGProfileAccelerationNode entity = new MicrogravityGProfileAccelerationNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MicrogravityGProfileAccelerationNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

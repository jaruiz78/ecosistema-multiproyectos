package com.corp.proyectomicrogravitybiotechlaboratory.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MicrogravityGProfileAccelerationNode.
 * 
 ...
 */
public record MicrogravityGProfileAccelerationNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MicrogravityGProfileAccelerationNode {
    ...
    public MicrogravityGProfileAccelerationNode withStatus(String newStatus) {
        return new MicrogravityGProfileAccelerationNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

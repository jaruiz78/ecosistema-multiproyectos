package com.corp.proyectotaxcomplianceledger.domain;
...
class TaxComplianceLedgerDomainTest {

    @Test
    @DisplayName("Debe crear la entidad TaxComplianceLedger con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new TaxComplianceLedger(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

package com.corp.proyectotaxcomplianceledger.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: TaxComplianceLedger.
 ...
 */
public record TaxComplianceLedger(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public TaxComplianceLedger withStatus(String newStatus) {
        return new TaxComplianceLedger(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

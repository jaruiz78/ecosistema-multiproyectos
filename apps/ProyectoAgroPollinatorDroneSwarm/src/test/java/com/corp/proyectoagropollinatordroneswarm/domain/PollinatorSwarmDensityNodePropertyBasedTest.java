...
class PollinatorSwarmDensityNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PollinatorSwarmDensityNode entity = new PollinatorSwarmDensityNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PollinatorSwarmDensityNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

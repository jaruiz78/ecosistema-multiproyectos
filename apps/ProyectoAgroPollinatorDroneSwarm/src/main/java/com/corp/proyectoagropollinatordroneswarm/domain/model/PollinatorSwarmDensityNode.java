package com.corp.proyectoagropollinatordroneswarm.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PollinatorSwarmDensityNode.
 * 
 ...
 */
public record PollinatorSwarmDensityNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PollinatorSwarmDensityNode {
    ...
    public PollinatorSwarmDensityNode withStatus(String newStatus) {
        return new PollinatorSwarmDensityNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

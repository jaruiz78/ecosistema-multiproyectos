# 🏛️ NOTION DOSSIER: ProyectoAgroPollinatorDroneSwarm

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoAgroPollinatorDroneSwarm
* **Entidad Dominio**: PollinatorSwarmDensityNode
* **Descripción**: Monitorizacion Bioacustica de Polinizadores y Enjambres de Micro-Drones Agricolas

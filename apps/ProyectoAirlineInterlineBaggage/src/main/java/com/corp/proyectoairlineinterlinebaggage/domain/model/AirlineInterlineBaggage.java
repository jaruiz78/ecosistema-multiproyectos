package com.corp.proyectoairlineinterlinebaggage.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AirlineInterlineBaggage.
 ...
 */
public record AirlineInterlineBaggage(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AirlineInterlineBaggage {
    ...
    public AirlineInterlineBaggage withStatus(String newStatus) {
        return new AirlineInterlineBaggage(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🚀 ProyectoV2G: Integración Vehículo-a-Red (Vehicle-to-Grid)
...
## 1. Visión General
Vertical para la bidireccionalidad de carga y descarga de flotas eléctricas en apoyo a la red.

### Bounded Context & Dominio
* **Dominio Principal:** Cargadores bidireccionales, incentivos tarifarios, degradación de batería.

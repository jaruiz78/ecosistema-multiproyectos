package com.corp.proyectophytoremediationsoilclean.domain;
...
class HeavyMetalBioaccumulationFactorNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HeavyMetalBioaccumulationFactorNode entity = new HeavyMetalBioaccumulationFactorNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HeavyMetalBioaccumulationFactorNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

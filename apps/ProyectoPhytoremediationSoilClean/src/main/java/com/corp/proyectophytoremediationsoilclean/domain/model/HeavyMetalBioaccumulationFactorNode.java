package com.corp.proyectophytoremediationsoilclean.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HeavyMetalBioaccumulationFactorNode.
 * 
 ...
 */
public record HeavyMetalBioaccumulationFactorNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HeavyMetalBioaccumulationFactorNode {
    ...
    public HeavyMetalBioaccumulationFactorNode withStatus(String newStatus) {
        return new HeavyMetalBioaccumulationFactorNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

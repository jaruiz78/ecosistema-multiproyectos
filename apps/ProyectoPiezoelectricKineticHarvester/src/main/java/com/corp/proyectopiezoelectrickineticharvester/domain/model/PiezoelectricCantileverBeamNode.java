package com.corp.proyectopiezoelectrickineticharvester.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PiezoelectricCantileverBeamNode.
 * 
 ...
 */
public record PiezoelectricCantileverBeamNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PiezoelectricCantileverBeamNode {
    ...
    public PiezoelectricCantileverBeamNode withStatus(String newStatus) {
        return new PiezoelectricCantileverBeamNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

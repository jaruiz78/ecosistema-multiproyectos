package com.corp.proyectopiezoelectrickineticharvester.domain;
...
class PiezoelectricCantileverBeamNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PiezoelectricCantileverBeamNode entity = new PiezoelectricCantileverBeamNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PiezoelectricCantileverBeamNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectolightningflashnowcastinggrid.domain;
...
class LightningFlashRateDensityNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            LightningFlashRateDensityNode entity = new LightningFlashRateDensityNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new LightningFlashRateDensityNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectolightningflashnowcastinggrid.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: LightningFlashRateDensityNode.
 * 
 ...
 */
public record LightningFlashRateDensityNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public LightningFlashRateDensityNode {
    ...
    public LightningFlashRateDensityNode withStatus(String newStatus) {
        return new LightningFlashRateDensityNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoLightningFlashNowcastingGrid

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoLightningFlashNowcastingGrid
* **Entidad Dominio**: LightningFlashRateDensityNode
* **Descripción**: Nowcasting de Rayos y Proteccion de Parques Eolicos y Solares

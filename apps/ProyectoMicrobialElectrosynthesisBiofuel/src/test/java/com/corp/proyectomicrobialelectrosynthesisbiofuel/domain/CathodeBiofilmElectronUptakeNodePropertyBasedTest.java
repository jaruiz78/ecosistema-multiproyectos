...
class CathodeBiofilmElectronUptakeNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CathodeBiofilmElectronUptakeNode entity = new CathodeBiofilmElectronUptakeNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CathodeBiofilmElectronUptakeNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

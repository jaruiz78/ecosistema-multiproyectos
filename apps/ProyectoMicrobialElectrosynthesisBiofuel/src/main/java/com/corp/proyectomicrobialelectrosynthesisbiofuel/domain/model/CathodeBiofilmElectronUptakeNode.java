package com.corp.proyectomicrobialelectrosynthesisbiofuel.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CathodeBiofilmElectronUptakeNode.
 * 
 ...
 */
public record CathodeBiofilmElectronUptakeNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CathodeBiofilmElectronUptakeNode {
    ...
    public CathodeBiofilmElectronUptakeNode withStatus(String newStatus) {
        return new CathodeBiofilmElectronUptakeNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🚀 ProyectoDefensa: Mallas Tácticas Air-Gapped y Comunicaciones Seguras
...
## 1. Visión General
Vertical de Sistemas Duales y defensa táctica resiliente para despliegues desconectados con cifrado post-cuántico.

### Bounded Context & Dominio
* **Dominio Principal:** Nodos tácticos, enrutamiento en malla ad-hoc, cifrado Kyber/Dilithium.
* **Integración Base:** Hereda de [`corp-spring-boot-starter`](file:///home/jaruiz/Desarrollo/corp-spring-boot-starter).
* **Enlace de Estado / Ledger:** `core-interstellar-mesh`.

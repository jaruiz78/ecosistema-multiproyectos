...
/**
 * Entidad de Dominio Puro: Defensa.
...
public record Defensa(
    ...
    public Defensa withStatus(String newStatus) {
        return new Defensa(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

...
/**
 * Entidad de Dominio Puro: EcotasaSoberanaTax.
 ...
 */
public record EcotasaSoberanaTax(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EcotasaSoberanaTax withStatus(String newStatus) {
        return new EcotasaSoberanaTax(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoecotasasoberanatax.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SovereignEcoTaxAssessment.
 * 
 ...
 */
public record SovereignEcoTaxAssessment(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SovereignEcoTaxAssessment {
    ...
    public SovereignEcoTaxAssessment withStatus(String newStatus) {
        return new SovereignEcoTaxAssessment(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

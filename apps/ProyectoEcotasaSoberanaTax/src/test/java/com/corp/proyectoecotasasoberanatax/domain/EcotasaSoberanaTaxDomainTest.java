...
class EcotasaSoberanaTaxDomainTest {

    @Test
    @DisplayName("Debe crear la entidad EcotasaSoberanaTax con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new EcotasaSoberanaTax(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

package com.corp.proyectoecotasasoberanatax.domain;
...
class SovereignEcoTaxAssessmentPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SovereignEcoTaxAssessment entity = new SovereignEcoTaxAssessment(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SovereignEcoTaxAssessment(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

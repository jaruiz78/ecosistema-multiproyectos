# 🏛️ NOTION DOSSIER: ProyectoFiestasInteresTuristico

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoFiestasInteresTuristico
* **Entidad Dominio**: FiestasInteresTuristico
* **Descripción**: Microservicio Vertical Especializado en FiestasInteresTuristico para el Ecosistema Corporativo.

package com.corp.proyectofiestasinteresturistico.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: FiestasInteresTuristico.
 ...
 */
public record FiestasInteresTuristico(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public FiestasInteresTuristico {
    ...
    public FiestasInteresTuristico withStatus(String newStatus) {
        return new FiestasInteresTuristico(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

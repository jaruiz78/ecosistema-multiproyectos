package com.corp.proyectoneuralbciaccessibilitycontrol.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: BciNeuralMotorIntentEventNode.
 * 
 ...
 */
public record BciNeuralMotorIntentEventNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BciNeuralMotorIntentEventNode {
    ...
    public BciNeuralMotorIntentEventNode withStatus(String newStatus) {
        return new BciNeuralMotorIntentEventNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

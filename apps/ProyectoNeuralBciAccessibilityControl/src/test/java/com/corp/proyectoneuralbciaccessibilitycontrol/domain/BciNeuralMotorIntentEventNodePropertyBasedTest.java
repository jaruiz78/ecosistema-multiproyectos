...
class BciNeuralMotorIntentEventNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BciNeuralMotorIntentEventNode entity = new BciNeuralMotorIntentEventNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BciNeuralMotorIntentEventNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

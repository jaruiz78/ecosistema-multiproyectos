 ...
 * Verifica invariantes y comportamiento de HydrogenProductionBatch sin dependencias externas.
 */
class HydrogenProductionBatchDomainTest {
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new HydrogenProductionBatch(
            "item-002",
            "tenant-alpha",
            "Invalid Asset",
            -10.0,

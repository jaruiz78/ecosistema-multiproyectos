...
/**
 * Entidad de Dominio Puro: HydrogenProductionBatch.
 * 
 ...
 */
public record HydrogenProductionBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HydrogenProductionBatch {
    ...
    public HydrogenProductionBatch withStatus(String newStatus) {
        return new HydrogenProductionBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoPlasmonicSurfaceBiosensors

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoPlasmonicSurfaceBiosensors
* **Entidad Dominio**: PlasmonicResonanceShiftToken
* **Descripción**: Deteccion Molecular Ultra-Sensible mediante Biometria Plasmonica SPR

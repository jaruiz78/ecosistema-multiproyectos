package com.corp.proyectoplasmonicsurfacebiosensors.domain;
...
class PlasmonicResonanceShiftTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PlasmonicResonanceShiftToken entity = new PlasmonicResonanceShiftToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PlasmonicResonanceShiftToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

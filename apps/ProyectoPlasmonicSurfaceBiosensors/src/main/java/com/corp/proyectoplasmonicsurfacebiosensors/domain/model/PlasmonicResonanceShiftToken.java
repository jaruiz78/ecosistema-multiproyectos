package com.corp.proyectoplasmonicsurfacebiosensors.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PlasmonicResonanceShiftToken.
 * 
 ...
 */
public record PlasmonicResonanceShiftToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PlasmonicResonanceShiftToken {
    ...
    public PlasmonicResonanceShiftToken withStatus(String newStatus) {
        return new PlasmonicResonanceShiftToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

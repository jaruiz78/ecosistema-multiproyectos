package com.corp.proyectoexosomenanovesicletherapeutics.domain;
...
class ExosomeSurfaceMarkerTropismNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ExosomeSurfaceMarkerTropismNode entity = new ExosomeSurfaceMarkerTropismNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ExosomeSurfaceMarkerTropismNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

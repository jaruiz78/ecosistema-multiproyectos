package com.corp.proyectoexosomenanovesicletherapeutics.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ExosomeSurfaceMarkerTropismNode.
 * 
 ...
 */
public record ExosomeSurfaceMarkerTropismNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ExosomeSurfaceMarkerTropismNode {
    ...
    public ExosomeSurfaceMarkerTropismNode withStatus(String newStatus) {
        return new ExosomeSurfaceMarkerTropismNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

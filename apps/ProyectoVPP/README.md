# 🚀 ProyectoVPP: Centrales Eléctricas Virtuales y Agregación de Baterías
...
## 1. Visión General
Vertical de agregación de recursos distribuidos (DERs), almacenamiento BESS y mitigación de picos de red.

### Bounded Context & Dominio
* **Dominio Principal:** Baterías industriales, estado de carga (SoC), rampas de potencia.

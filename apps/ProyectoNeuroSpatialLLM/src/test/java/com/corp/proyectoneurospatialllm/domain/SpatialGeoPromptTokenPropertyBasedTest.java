package com.corp.proyectoneurospatialllm.domain;
...
class SpatialGeoPromptTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SpatialGeoPromptToken entity = new SpatialGeoPromptToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SpatialGeoPromptToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoneurospatialllm.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SpatialGeoPromptToken.
 * 
 ...
 */
public record SpatialGeoPromptToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SpatialGeoPromptToken withStatus(String newStatus) {
        return new SpatialGeoPromptToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

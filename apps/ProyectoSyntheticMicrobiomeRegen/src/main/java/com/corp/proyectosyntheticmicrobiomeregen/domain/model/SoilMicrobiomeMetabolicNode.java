package com.corp.proyectosyntheticmicrobiomeregen.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SoilMicrobiomeMetabolicNode.
 * 
 ...
 */
public record SoilMicrobiomeMetabolicNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SoilMicrobiomeMetabolicNode {
    ...
    public SoilMicrobiomeMetabolicNode withStatus(String newStatus) {
        return new SoilMicrobiomeMetabolicNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

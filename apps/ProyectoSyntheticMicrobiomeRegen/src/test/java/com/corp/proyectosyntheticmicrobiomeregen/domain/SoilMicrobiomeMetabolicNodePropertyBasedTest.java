package com.corp.proyectosyntheticmicrobiomeregen.domain;
...
class SoilMicrobiomeMetabolicNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SoilMicrobiomeMetabolicNode entity = new SoilMicrobiomeMetabolicNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SoilMicrobiomeMetabolicNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

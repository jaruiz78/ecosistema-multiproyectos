package com.corp.proyectoindustrialmicrogridmpc.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: IndustrialMicrogridMPC.
 ...
 */
public record IndustrialMicrogridMPC(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public IndustrialMicrogridMPC withStatus(String newStatus) {
        return new IndustrialMicrogridMPC(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoIndustrialMicrogridMPC

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoIndustrialMicrogridMPC
* **Entidad Dominio**: IndustrialMicrogridMPC
* **Descripción**: Microservicio Vertical Especializado en IndustrialMicrogridMPC para el Ecosistema Corporativo.

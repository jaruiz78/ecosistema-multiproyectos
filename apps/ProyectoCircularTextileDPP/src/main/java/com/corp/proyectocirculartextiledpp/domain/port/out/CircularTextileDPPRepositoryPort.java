package com.corp.proyectocirculartextiledpp.domain.port.out;
 ...
 */
public interface CircularTextileDPPRepositoryPort {
    CircularTextileDPP save(CircularTextileDPP entity);
    Optional<CircularTextileDPP> findById(String id, String tenantId);
}

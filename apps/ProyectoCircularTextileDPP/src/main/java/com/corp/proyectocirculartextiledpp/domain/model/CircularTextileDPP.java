package com.corp.proyectocirculartextiledpp.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CircularTextileDPP.
 ...
 */
public record CircularTextileDPP(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CircularTextileDPP withStatus(String newStatus) {
        return new CircularTextileDPP(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

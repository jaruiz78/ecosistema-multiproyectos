package com.corp.proyectocirculartextiledpp.domain;
...
class CircularTextileDPPDomainTest {

    @Test
    @DisplayName("Debe crear la entidad CircularTextileDPP con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new CircularTextileDPP(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

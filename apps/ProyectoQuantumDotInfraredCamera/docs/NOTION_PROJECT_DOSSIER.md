# 🏛️ NOTION DOSSIER: ProyectoQuantumDotInfraredCamera

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoQuantumDotInfraredCamera
* **Entidad Dominio**: QdipInfraredPixelMatrixBatch
* **Descripción**: Camaras Multiespectrales Infrarrojas de Puntos Cuanticos para Drones Agricolas

package com.corp.proyectoquantumdotinfraredcamera.domain;
...
class QdipInfraredPixelMatrixBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            QdipInfraredPixelMatrixBatch entity = new QdipInfraredPixelMatrixBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new QdipInfraredPixelMatrixBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectosmartstreetlightingv2g.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SmartStreetLightingV2G.
 ...
 */
public record SmartStreetLightingV2G(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SmartStreetLightingV2G withStatus(String newStatus) {
        return new SmartStreetLightingV2G(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

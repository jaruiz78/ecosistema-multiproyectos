package com.corp.proyectomiceconferencetwin.domain;
...
class MiceConferenceTwinDomainTest {

    @Test
    @DisplayName("Debe crear la entidad MiceConferenceTwin con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new MiceConferenceTwin(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

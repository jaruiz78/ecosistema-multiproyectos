package com.corp.proyectocloudalbedomicrophysicstwin.domain;
...
class CcnSupersaturationActivationCurveNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CcnSupersaturationActivationCurveNode entity = new CcnSupersaturationActivationCurveNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CcnSupersaturationActivationCurveNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

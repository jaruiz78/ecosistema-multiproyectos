package com.corp.proyectocloudalbedomicrophysicstwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CcnSupersaturationActivationCurveNode.
 * 
 ...
 */
public record CcnSupersaturationActivationCurveNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CcnSupersaturationActivationCurveNode {
    ...
    public CcnSupersaturationActivationCurveNode withStatus(String newStatus) {
        return new CcnSupersaturationActivationCurveNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoGeothermalLithiumExtraction

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoGeothermalLithiumExtraction
* **Entidad Dominio**: GeothermalBrineLithiumYieldToken
* **Descripción**: Extraccion Directa de Litio Sostenible a partir de Salmueras Geotermicas Profundas

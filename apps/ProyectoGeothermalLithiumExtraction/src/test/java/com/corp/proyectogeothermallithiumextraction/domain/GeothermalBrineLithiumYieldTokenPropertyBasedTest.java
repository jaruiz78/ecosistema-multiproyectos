...
class GeothermalBrineLithiumYieldTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            GeothermalBrineLithiumYieldToken entity = new GeothermalBrineLithiumYieldToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new GeothermalBrineLithiumYieldToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

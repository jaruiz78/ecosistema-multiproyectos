package com.corp.proyectogeothermallithiumextraction.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GeothermalBrineLithiumYieldToken.
 * 
 ...
 */
public record GeothermalBrineLithiumYieldToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public GeothermalBrineLithiumYieldToken {
    ...
    public GeothermalBrineLithiumYieldToken withStatus(String newStatus) {
        return new GeothermalBrineLithiumYieldToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

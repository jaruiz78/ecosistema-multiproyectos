package com.corp.proyectofractionalrealestaterwa.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: RealEstateNotarizedTitleToken.
 * 
 ...
 */
public record RealEstateNotarizedTitleToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public RealEstateNotarizedTitleToken {
    ...
    public RealEstateNotarizedTitleToken withStatus(String newStatus) {
        return new RealEstateNotarizedTitleToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

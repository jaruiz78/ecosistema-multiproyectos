package com.corp.proyectofractionalrealestaterwa.domain;
...
class RealEstateNotarizedTitleTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            RealEstateNotarizedTitleToken entity = new RealEstateNotarizedTitleToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new RealEstateNotarizedTitleToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoprogrammableofflinecbdc.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: OfflineCbdcSpendProofToken.
 * 
 ...
 */
public record OfflineCbdcSpendProofToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public OfflineCbdcSpendProofToken {
    ...
    public OfflineCbdcSpendProofToken withStatus(String newStatus) {
        return new OfflineCbdcSpendProofToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoprogrammableofflinecbdc.domain;
...
class OfflineCbdcSpendProofTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            OfflineCbdcSpendProofToken entity = new OfflineCbdcSpendProofToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new OfflineCbdcSpendProofToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

# 🏛️ NOTION DOSSIER: ProyectoProgrammableOfflineCbdc

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoProgrammableOfflineCbdc
* **Entidad Dominio**: OfflineCbdcSpendProofToken
* **Descripción**: CBDC Programable con Pagos Offline Seguros y Liquidacion Inmediata

package com.corp.proyectoquantumentropyrngnetwork.domain;
...
class QrngEntropySourceBlockTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            QrngEntropySourceBlockToken entity = new QrngEntropySourceBlockToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new QrngEntropySourceBlockToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

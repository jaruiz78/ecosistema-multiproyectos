package com.corp.proyectoquantumentropyrngnetwork.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: QrngEntropySourceBlockToken.
 * 
 ...
 */
public record QrngEntropySourceBlockToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public QrngEntropySourceBlockToken {
    ...
    public QrngEntropySourceBlockToken withStatus(String newStatus) {
        return new QrngEntropySourceBlockToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

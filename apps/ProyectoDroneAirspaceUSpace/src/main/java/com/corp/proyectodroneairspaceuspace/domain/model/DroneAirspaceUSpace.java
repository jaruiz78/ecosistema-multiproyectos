package com.corp.proyectodroneairspaceuspace.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DroneAirspaceUSpace.
 ...
 */
public record DroneAirspaceUSpace(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DroneAirspaceUSpace withStatus(String newStatus) {
        return new DroneAirspaceUSpace(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoSubSurfaceGeoTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoSubSurfaceGeoTwin
* **Entidad Dominio**: SubSurfaceGeoTwin
* **Descripción**: Microservicio Vertical Especializado en SubSurfaceGeoTwin para el Ecosistema Corporativo.

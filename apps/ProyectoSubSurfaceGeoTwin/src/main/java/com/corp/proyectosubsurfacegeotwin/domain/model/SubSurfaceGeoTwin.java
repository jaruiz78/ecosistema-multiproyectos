package com.corp.proyectosubsurfacegeotwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SubSurfaceGeoTwin.
 ...
 */
public record SubSurfaceGeoTwin(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SubSurfaceGeoTwin withStatus(String newStatus) {
        return new SubSurfaceGeoTwin(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

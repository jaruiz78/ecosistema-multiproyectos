# 🏛️ NOTION DOSSIER: ProyectoEidas2DigitalIdentityWallet

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoEidas2DigitalIdentityWallet
* **Entidad Dominio**: VerifiableCredentialStatusListToken
* **Descripción**: Billetera Soberana Europea eIDAS 2.0 para Ciudadanos y Empresas

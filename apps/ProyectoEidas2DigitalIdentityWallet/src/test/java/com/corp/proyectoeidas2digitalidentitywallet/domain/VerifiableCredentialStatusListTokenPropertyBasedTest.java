...
class VerifiableCredentialStatusListTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            VerifiableCredentialStatusListToken entity = new VerifiableCredentialStatusListToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new VerifiableCredentialStatusListToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

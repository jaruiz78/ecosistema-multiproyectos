package com.corp.proyectoeidas2digitalidentitywallet.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: VerifiableCredentialStatusListToken.
 * 
 ...
 */
public record VerifiableCredentialStatusListToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public VerifiableCredentialStatusListToken {
    ...
    public VerifiableCredentialStatusListToken withStatus(String newStatus) {
        return new VerifiableCredentialStatusListToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

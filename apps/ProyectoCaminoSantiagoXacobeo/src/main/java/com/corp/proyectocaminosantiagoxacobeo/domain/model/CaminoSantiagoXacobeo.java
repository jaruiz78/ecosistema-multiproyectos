package com.corp.proyectocaminosantiagoxacobeo.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CaminoSantiagoXacobeo.
 ...
 */
public record CaminoSantiagoXacobeo(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CaminoSantiagoXacobeo withStatus(String newStatus) {
        return new CaminoSantiagoXacobeo(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

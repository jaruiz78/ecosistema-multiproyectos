...
class HyphalNutrientFluxTranslocationNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HyphalNutrientFluxTranslocationNode entity = new HyphalNutrientFluxTranslocationNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HyphalNutrientFluxTranslocationNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectomycorrhizalnetworkagronomy.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HyphalNutrientFluxTranslocationNode.
 * 
 ...
 */
public record HyphalNutrientFluxTranslocationNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HyphalNutrientFluxTranslocationNode {
    ...
    public HyphalNutrientFluxTranslocationNode withStatus(String newStatus) {
        return new HyphalNutrientFluxTranslocationNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

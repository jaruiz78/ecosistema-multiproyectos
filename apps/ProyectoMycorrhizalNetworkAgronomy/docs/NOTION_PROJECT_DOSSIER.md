# 🏛️ NOTION DOSSIER: ProyectoMycorrhizalNetworkAgronomy

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoMycorrhizalNetworkAgronomy
* **Entidad Dominio**: HyphalNutrientFluxTranslocationNode
* **Descripción**: Biofertilizacion por Dinamica de Transporte en Redes de Micorrizas

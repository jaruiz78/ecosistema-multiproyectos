package com.corp.proyectodragfreegeodesymission.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: TestMassDisplacementResidualAccelerationNode.
 * 
 ...
 */
public record TestMassDisplacementResidualAccelerationNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public TestMassDisplacementResidualAccelerationNode {
    ...
    public TestMassDisplacementResidualAccelerationNode withStatus(String newStatus) {
        return new TestMassDisplacementResidualAccelerationNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

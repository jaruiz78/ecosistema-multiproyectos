package com.corp.proyectodragfreegeodesymission.domain;
...
class TestMassDisplacementResidualAccelerationNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            TestMassDisplacementResidualAccelerationNode entity = new TestMassDisplacementResidualAccelerationNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new TestMassDisplacementResidualAccelerationNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

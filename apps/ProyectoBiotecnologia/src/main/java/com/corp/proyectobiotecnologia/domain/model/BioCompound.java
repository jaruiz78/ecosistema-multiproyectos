...
/**
 * Entidad de Dominio Puro: BioCompound.
 * 
...
public record BioCompound(
    ...
    public BioCompound withStatus(String newStatus) {
        return new BioCompound(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectobiotecnologia.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: Biotecnologia.
...
public record Biotecnologia(
    ...
    public Biotecnologia withStatus(String newStatus) {
        return new Biotecnologia(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

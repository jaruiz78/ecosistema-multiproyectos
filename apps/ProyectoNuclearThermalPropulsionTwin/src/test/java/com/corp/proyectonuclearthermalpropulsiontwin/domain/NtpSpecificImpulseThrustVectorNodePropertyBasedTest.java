...
class NtpSpecificImpulseThrustVectorNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            NtpSpecificImpulseThrustVectorNode entity = new NtpSpecificImpulseThrustVectorNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new NtpSpecificImpulseThrustVectorNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

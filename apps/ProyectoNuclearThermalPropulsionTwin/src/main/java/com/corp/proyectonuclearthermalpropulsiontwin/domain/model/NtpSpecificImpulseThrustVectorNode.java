package com.corp.proyectonuclearthermalpropulsiontwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: NtpSpecificImpulseThrustVectorNode.
 * 
 ...
 */
public record NtpSpecificImpulseThrustVectorNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public NtpSpecificImpulseThrustVectorNode {
    ...
    public NtpSpecificImpulseThrustVectorNode withStatus(String newStatus) {
        return new NtpSpecificImpulseThrustVectorNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

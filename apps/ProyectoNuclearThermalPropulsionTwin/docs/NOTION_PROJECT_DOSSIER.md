# 🏛️ NOTION DOSSIER: ProyectoNuclearThermalPropulsionTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoNuclearThermalPropulsionTwin
* **Entidad Dominio**: NtpSpecificImpulseThrustVectorNode
* **Descripción**: Propulsion Termica Nuclear para Viajes Interplanetarios de Alta Velocidad

package com.corp.proyectowildfiresmokehealthalert.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SmokePlumePm25ConcentrationGridNode.
 * 
 ...
 */
public record SmokePlumePm25ConcentrationGridNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SmokePlumePm25ConcentrationGridNode {
    ...
    public SmokePlumePm25ConcentrationGridNode withStatus(String newStatus) {
        return new SmokePlumePm25ConcentrationGridNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

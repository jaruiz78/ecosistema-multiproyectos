# 🏛️ NOTION DOSSIER: ProyectoWildfireSmokeHealthAlert

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoWildfireSmokeHealthAlert
* **Entidad Dominio**: SmokePlumePm25ConcentrationGridNode
* **Descripción**: Pronostico de Dispersion de Humo de Incendios y Salud Publica

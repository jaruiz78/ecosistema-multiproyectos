# 🏛️ NOTION DOSSIER: ProyectoAptamerDiagnosticBiosensors

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoAptamerDiagnosticBiosensors
* **Entidad Dominio**: AptamerDissociationConstantKdToken
* **Descripción**: Biosensores Diagnosticos basados en Aptameros Sinteticos SELEX

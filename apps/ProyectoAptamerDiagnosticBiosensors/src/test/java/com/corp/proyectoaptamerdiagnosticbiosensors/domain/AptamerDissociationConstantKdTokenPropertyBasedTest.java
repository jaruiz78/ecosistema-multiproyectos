package com.corp.proyectoaptamerdiagnosticbiosensors.domain;
...
class AptamerDissociationConstantKdTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AptamerDissociationConstantKdToken entity = new AptamerDissociationConstantKdToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AptamerDissociationConstantKdToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

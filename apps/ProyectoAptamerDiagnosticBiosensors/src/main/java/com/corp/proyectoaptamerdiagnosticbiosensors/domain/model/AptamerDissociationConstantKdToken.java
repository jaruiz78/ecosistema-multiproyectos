package com.corp.proyectoaptamerdiagnosticbiosensors.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AptamerDissociationConstantKdToken.
 * 
 ...
 */
public record AptamerDissociationConstantKdToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AptamerDissociationConstantKdToken {
    ...
    public AptamerDissociationConstantKdToken withStatus(String newStatus) {
        return new AptamerDissociationConstantKdToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

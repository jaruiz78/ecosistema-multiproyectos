package com.corp.proyectorivermorphodynamicsbasintwin.domain;
...
class BedloadSedimentTransportRateNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BedloadSedimentTransportRateNode entity = new BedloadSedimentTransportRateNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BedloadSedimentTransportRateNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

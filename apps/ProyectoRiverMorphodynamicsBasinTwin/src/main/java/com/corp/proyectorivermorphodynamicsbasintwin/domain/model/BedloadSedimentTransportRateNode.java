package com.corp.proyectorivermorphodynamicsbasintwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: BedloadSedimentTransportRateNode.
 * 
 ...
 */
public record BedloadSedimentTransportRateNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BedloadSedimentTransportRateNode {
    ...
    public BedloadSedimentTransportRateNode withStatus(String newStatus) {
        return new BedloadSedimentTransportRateNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

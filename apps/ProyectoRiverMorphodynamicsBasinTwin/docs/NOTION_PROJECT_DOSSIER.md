# 🏛️ NOTION DOSSIER: ProyectoRiverMorphodynamicsBasinTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoRiverMorphodynamicsBasinTwin
* **Entidad Dominio**: BedloadSedimentTransportRateNode
* **Descripción**: Morfodinamica Fluvial y Gestion de Sedimentos en Embalses

package com.corp.proyectomagnetocaloricgreencooling.domain;
...
class MagnetocaloricRegeneratorBedNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MagnetocaloricRegeneratorBedNode entity = new MagnetocaloricRegeneratorBedNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MagnetocaloricRegeneratorBedNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

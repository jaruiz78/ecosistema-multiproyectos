package com.corp.proyectomagnetocaloricgreencooling.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MagnetocaloricRegeneratorBedNode.
 * 
 ...
 */
public record MagnetocaloricRegeneratorBedNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MagnetocaloricRegeneratorBedNode {
    ...
    public MagnetocaloricRegeneratorBedNode withStatus(String newStatus) {
        return new MagnetocaloricRegeneratorBedNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

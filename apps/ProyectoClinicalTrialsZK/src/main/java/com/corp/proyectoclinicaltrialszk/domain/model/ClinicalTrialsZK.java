package com.corp.proyectoclinicaltrialszk.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ClinicalTrialsZK.
 ...
 */
public record ClinicalTrialsZK(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ClinicalTrialsZK withStatus(String newStatus) {
        return new ClinicalTrialsZK(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

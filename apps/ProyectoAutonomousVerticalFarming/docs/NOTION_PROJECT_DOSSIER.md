# 🏛️ NOTION DOSSIER: ProyectoAutonomousVerticalFarming

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoAutonomousVerticalFarming
* **Entidad Dominio**: VerticalFarmCanopyGrowthNode
* **Descripción**: Granjas Verticales Urbanas Autonomas con Fotobiologia LED de Espectro Variable

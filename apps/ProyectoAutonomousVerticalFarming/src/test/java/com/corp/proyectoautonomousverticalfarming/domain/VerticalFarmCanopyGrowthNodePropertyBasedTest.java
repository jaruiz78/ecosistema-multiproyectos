package com.corp.proyectoautonomousverticalfarming.domain;
...
class VerticalFarmCanopyGrowthNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            VerticalFarmCanopyGrowthNode entity = new VerticalFarmCanopyGrowthNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new VerticalFarmCanopyGrowthNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

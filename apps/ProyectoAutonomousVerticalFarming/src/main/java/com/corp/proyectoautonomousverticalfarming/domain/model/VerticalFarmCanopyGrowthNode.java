package com.corp.proyectoautonomousverticalfarming.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: VerticalFarmCanopyGrowthNode.
 * 
 ...
 */
public record VerticalFarmCanopyGrowthNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public VerticalFarmCanopyGrowthNode {
    ...
    public VerticalFarmCanopyGrowthNode withStatus(String newStatus) {
        return new VerticalFarmCanopyGrowthNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

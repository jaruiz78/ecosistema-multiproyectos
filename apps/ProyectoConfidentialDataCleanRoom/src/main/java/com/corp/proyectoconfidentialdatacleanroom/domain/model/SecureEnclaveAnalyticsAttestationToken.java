package com.corp.proyectoconfidentialdatacleanroom.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SecureEnclaveAnalyticsAttestationToken.
 * 
 ...
 */
public record SecureEnclaveAnalyticsAttestationToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SecureEnclaveAnalyticsAttestationToken {
    ...
    public SecureEnclaveAnalyticsAttestationToken withStatus(String newStatus) {
        return new SecureEnclaveAnalyticsAttestationToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

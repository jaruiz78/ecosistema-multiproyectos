package com.corp.proyectoconfidentialdatacleanroom.domain;
...
class SecureEnclaveAnalyticsAttestationTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SecureEnclaveAnalyticsAttestationToken entity = new SecureEnclaveAnalyticsAttestationToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SecureEnclaveAnalyticsAttestationToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

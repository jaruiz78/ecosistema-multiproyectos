# 🏛️ NOTION DOSSIER: ProyectoInclusiveAccessibleTourism

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoInclusiveAccessibleTourism
* **Entidad Dominio**: AccessiblePoiNode
* **Descripción**: Plataforma de guiado y audiodescripción espacial 3D para turismo inclusivo y accesible

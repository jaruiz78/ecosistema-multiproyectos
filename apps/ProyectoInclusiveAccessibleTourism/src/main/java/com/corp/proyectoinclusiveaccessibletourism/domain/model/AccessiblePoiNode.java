package com.corp.proyectoinclusiveaccessibletourism.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AccessiblePoiNode.
 * 
 ...
 */
public record AccessiblePoiNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AccessiblePoiNode withStatus(String newStatus) {
        return new AccessiblePoiNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

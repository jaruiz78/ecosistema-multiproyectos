package com.corp.proyectoinclusiveaccessibletourism.domain;
...
class AccessiblePoiNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AccessiblePoiNode entity = new AccessiblePoiNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AccessiblePoiNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

# 🏛️ NOTION DOSSIER: ProyectoMangroveCoastalRestoration

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoMangroveCoastalRestoration
* **Entidad Dominio**: MangroveWetlandBiomassCellNode
* **Descripción**: Restauracion Ecologica de Manglares y Cuantificacion de Creditos de Carbono Costero

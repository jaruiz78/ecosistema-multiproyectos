package com.corp.proyectomangrovecoastalrestoration.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MangroveWetlandBiomassCellNode.
 * 
 ...
 */
public record MangroveWetlandBiomassCellNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MangroveWetlandBiomassCellNode {
    ...
    public MangroveWetlandBiomassCellNode withStatus(String newStatus) {
        return new MangroveWetlandBiomassCellNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

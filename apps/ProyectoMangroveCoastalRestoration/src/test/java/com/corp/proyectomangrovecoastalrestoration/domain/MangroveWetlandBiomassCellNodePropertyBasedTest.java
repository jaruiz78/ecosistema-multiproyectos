package com.corp.proyectomangrovecoastalrestoration.domain;
...
class MangroveWetlandBiomassCellNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MangroveWetlandBiomassCellNode entity = new MangroveWetlandBiomassCellNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MangroveWetlandBiomassCellNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

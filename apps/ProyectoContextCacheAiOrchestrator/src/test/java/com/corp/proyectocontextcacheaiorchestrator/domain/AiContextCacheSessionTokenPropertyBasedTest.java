package com.corp.proyectocontextcacheaiorchestrator.domain;
...
class AiContextCacheSessionTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AiContextCacheSessionToken entity = new AiContextCacheSessionToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AiContextCacheSessionToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectocontextcacheaiorchestrator.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AiContextCacheSessionToken.
 * 
 ...
 */
public record AiContextCacheSessionToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AiContextCacheSessionToken {
    ...
    public AiContextCacheSessionToken withStatus(String newStatus) {
        return new AiContextCacheSessionToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

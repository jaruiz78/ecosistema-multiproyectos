package com.corp.proyectodeepseabenthicecosystems.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HydrothermalVentBenthicZoneNode.
 * 
 ...
 */
public record HydrothermalVentBenthicZoneNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HydrothermalVentBenthicZoneNode {
    ...
    public HydrothermalVentBenthicZoneNode withStatus(String newStatus) {
        return new HydrothermalVentBenthicZoneNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectodeepseabenthicecosystems.domain;
...
class HydrothermalVentBenthicZoneNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HydrothermalVentBenthicZoneNode entity = new HydrothermalVentBenthicZoneNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HydrothermalVentBenthicZoneNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

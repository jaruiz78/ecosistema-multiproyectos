# 🏛️ NOTION DOSSIER: ProyectoCarbonLedger

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCarbonLedger
* **Entidad Dominio**: CarbonLedger
* **Descripción**: Microservicio Vertical Especializado en CarbonLedger para el Ecosistema Corporativo.

package com.corp.proyectocarbonledger.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CarbonLedger.
...
public record CarbonLedger(
    ...
    public CarbonLedger withStatus(String newStatus) {
        return new CarbonLedger(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

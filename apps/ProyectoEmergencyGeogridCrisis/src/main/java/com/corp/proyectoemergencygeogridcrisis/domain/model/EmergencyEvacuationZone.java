package com.corp.proyectoemergencygeogridcrisis.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EmergencyEvacuationZone.
 * 
 ...
 */
public record EmergencyEvacuationZone(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EmergencyEvacuationZone {
    ...
    public EmergencyEvacuationZone withStatus(String newStatus) {
        return new EmergencyEvacuationZone(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoemergencygeogridcrisis.domain;
...
class EmergencyEvacuationZonePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EmergencyEvacuationZone entity = new EmergencyEvacuationZone(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EmergencyEvacuationZone(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

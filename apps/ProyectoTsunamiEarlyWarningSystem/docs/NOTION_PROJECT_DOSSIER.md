# 🏛️ NOTION DOSSIER: ProyectoTsunamiEarlyWarningSystem

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoTsunamiEarlyWarningSystem
* **Entidad Dominio**: TsunamiWaveformPressureSensorNode
* **Descripción**: Sistema de Alerta Temprana de Tsunamis Oceanicos y Auscultacion por Boyas DART

package com.corp.proyectotsunamiearlywarningsystem.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: TsunamiWaveformPressureSensorNode.
 * 
 ...
 */
public record TsunamiWaveformPressureSensorNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public TsunamiWaveformPressureSensorNode {
    ...
    public TsunamiWaveformPressureSensorNode withStatus(String newStatus) {
        return new TsunamiWaveformPressureSensorNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

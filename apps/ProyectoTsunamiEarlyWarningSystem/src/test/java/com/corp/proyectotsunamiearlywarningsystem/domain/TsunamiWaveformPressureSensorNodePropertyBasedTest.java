package com.corp.proyectotsunamiearlywarningsystem.domain;
...
class TsunamiWaveformPressureSensorNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            TsunamiWaveformPressureSensorNode entity = new TsunamiWaveformPressureSensorNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new TsunamiWaveformPressureSensorNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

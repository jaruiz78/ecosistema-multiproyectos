# 🏛️ NOTION DOSSIER: ProyectoEuDigitalProductPassport

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoEuDigitalProductPassport
* **Entidad Dominio**: DigitalProductPassportRecordToken
* **Descripción**: Pasaporte Digital de Producto Europeo (DPP) para Trazabilidad de Economia Circular

package com.corp.proyectoeudigitalproductpassport.domain;
...
class DigitalProductPassportRecordTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DigitalProductPassportRecordToken entity = new DigitalProductPassportRecordToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DigitalProductPassportRecordToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

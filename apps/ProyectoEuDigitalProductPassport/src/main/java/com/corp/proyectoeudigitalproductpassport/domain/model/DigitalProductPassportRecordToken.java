package com.corp.proyectoeudigitalproductpassport.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DigitalProductPassportRecordToken.
 * 
 ...
 */
public record DigitalProductPassportRecordToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DigitalProductPassportRecordToken {
    ...
    public DigitalProductPassportRecordToken withStatus(String newStatus) {
        return new DigitalProductPassportRecordToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

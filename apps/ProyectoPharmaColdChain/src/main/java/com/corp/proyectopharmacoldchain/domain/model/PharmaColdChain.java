package com.corp.proyectopharmacoldchain.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PharmaColdChain.
...
public record PharmaColdChain(
    ...
    public PharmaColdChain withStatus(String newStatus) {
        return new PharmaColdChain(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

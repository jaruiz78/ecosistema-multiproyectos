# 🏛️ NOTION DOSSIER: ProyectoInterplanetaryDelayTolerantRelay

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoInterplanetaryDelayTolerantRelay
* **Entidad Dominio**: DtnBundleCustodyTransferToken
* **Descripción**: Red de Comunicaciones Interplanetarias Tolerante a Demoras (DTN)

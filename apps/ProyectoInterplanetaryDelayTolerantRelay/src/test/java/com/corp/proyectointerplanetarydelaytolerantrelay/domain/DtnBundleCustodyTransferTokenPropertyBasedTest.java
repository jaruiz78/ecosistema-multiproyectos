package com.corp.proyectointerplanetarydelaytolerantrelay.domain;
...
class DtnBundleCustodyTransferTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DtnBundleCustodyTransferToken entity = new DtnBundleCustodyTransferToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DtnBundleCustodyTransferToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectointerplanetarydelaytolerantrelay.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DtnBundleCustodyTransferToken.
 * 
 ...
 */
public record DtnBundleCustodyTransferToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DtnBundleCustodyTransferToken {
    ...
    public DtnBundleCustodyTransferToken withStatus(String newStatus) {
        return new DtnBundleCustodyTransferToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

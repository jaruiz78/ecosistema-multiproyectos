# AGENTS.md - Proyecto Independiente ProyectoSyntheticBiologyFoundry (Google Antigravity)

Este proyecto opera como un vertical especializado dentro del ecosistema Multi-Proyecto de Google Antigravity.
...
- **Auditoría Pre-Merge & Senado:** `@code-reviewer`, `@Zero-Trust-Security-Auditor`, `@test-engineer` -> `Consilium Romano`
...
4. **Grounded Javadoc Obligatorio:** Toda clase o record debe incluir `@see apps/VERTICALS_ARCHITECTURE_SPEC.md` y `@see docs/adr/...`.

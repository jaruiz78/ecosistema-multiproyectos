package com.corp.proyectosyntheticbiologyfoundry.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SyntheticBiologyFoundry.
 ...
 */
public record SyntheticBiologyFoundry(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SyntheticBiologyFoundry {
    ...
    public SyntheticBiologyFoundry withStatus(String newStatus) {
        return new SyntheticBiologyFoundry(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

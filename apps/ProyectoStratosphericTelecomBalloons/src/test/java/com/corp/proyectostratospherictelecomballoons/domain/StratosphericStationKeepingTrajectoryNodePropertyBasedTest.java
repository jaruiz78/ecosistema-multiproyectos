package com.corp.proyectostratospherictelecomballoons.domain;
...
class StratosphericStationKeepingTrajectoryNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            StratosphericStationKeepingTrajectoryNode entity = new StratosphericStationKeepingTrajectoryNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new StratosphericStationKeepingTrajectoryNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

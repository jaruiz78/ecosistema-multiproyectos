package com.corp.proyectostratospherictelecomballoons.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: StratosphericStationKeepingTrajectoryNode.
 * 
 ...
 */
public record StratosphericStationKeepingTrajectoryNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public StratosphericStationKeepingTrajectoryNode {
    ...
    public StratosphericStationKeepingTrajectoryNode withStatus(String newStatus) {
        return new StratosphericStationKeepingTrajectoryNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoquantumsecurebanking.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: QuantumVaultAccount.
 * 
 ...
 */
public record QuantumVaultAccount(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public QuantumVaultAccount withStatus(String newStatus) {
        return new QuantumVaultAccount(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

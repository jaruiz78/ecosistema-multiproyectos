package com.corp.proyectoquantumsecurebanking.domain;
...
class QuantumVaultAccountPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            QuantumVaultAccount entity = new QuantumVaultAccount(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new QuantumVaultAccount(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

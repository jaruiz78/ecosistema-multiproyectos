package com.corp.proyectohighpowersolarelectrictug.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SepXenonMassFlowThrustNode.
 * 
 ...
 */
public record SepXenonMassFlowThrustNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SepXenonMassFlowThrustNode {
    ...
    public SepXenonMassFlowThrustNode withStatus(String newStatus) {
        return new SepXenonMassFlowThrustNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectohighpowersolarelectrictug.domain;
...
class SepXenonMassFlowThrustNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SepXenonMassFlowThrustNode entity = new SepXenonMassFlowThrustNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SepXenonMassFlowThrustNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

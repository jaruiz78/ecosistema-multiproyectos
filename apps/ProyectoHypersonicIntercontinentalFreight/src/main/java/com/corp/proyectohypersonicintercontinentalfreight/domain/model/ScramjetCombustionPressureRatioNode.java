package com.corp.proyectohypersonicintercontinentalfreight.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ScramjetCombustionPressureRatioNode.
 * 
 ...
 */
public record ScramjetCombustionPressureRatioNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ScramjetCombustionPressureRatioNode {
    ...
    public ScramjetCombustionPressureRatioNode withStatus(String newStatus) {
        return new ScramjetCombustionPressureRatioNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

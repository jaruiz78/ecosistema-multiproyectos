...
class ScramjetCombustionPressureRatioNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ScramjetCombustionPressureRatioNode entity = new ScramjetCombustionPressureRatioNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ScramjetCombustionPressureRatioNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

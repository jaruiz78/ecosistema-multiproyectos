package com.corp.proyectocircularbiomassbiorefinery.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: BiomassFeedstockBatch.
 * 
 ...
 */
public record BiomassFeedstockBatch(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public BiomassFeedstockBatch withStatus(String newStatus) {
        return new BiomassFeedstockBatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

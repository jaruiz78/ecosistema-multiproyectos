package com.corp.proyectocircularbiomassbiorefinery.domain;
...
class BiomassFeedstockBatchPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            BiomassFeedstockBatch entity = new BiomassFeedstockBatch(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new BiomassFeedstockBatch(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

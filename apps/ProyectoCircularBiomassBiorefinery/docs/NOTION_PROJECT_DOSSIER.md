# 🏛️ NOTION DOSSIER: ProyectoCircularBiomassBiorefinery

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCircularBiomassBiorefinery
* **Entidad Dominio**: BiomassFeedstockBatch
* **Descripción**: Biorrefineria Circular de Biomasa y Valorizacion de Residuos Agricolas y Hoteleros

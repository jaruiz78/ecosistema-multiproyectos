...
/**
 * Entidad de Dominio Puro: Logistica.
...
public record Logistica(
    ...
    public Logistica withStatus(String newStatus) {
        return new Logistica(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoEcoTourismPassport

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoEcoTourismPassport
* **Entidad Dominio**: EcoTourismPassport
* **Descripción**: Microservicio Vertical Especializado en EcoTourismPassport para el Ecosistema Corporativo.

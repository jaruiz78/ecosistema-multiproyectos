package com.corp.proyectoecotourismpassport.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EcoTourismPassport.
...
public record EcoTourismPassport(
    ...
    public EcoTourismPassport withStatus(String newStatus) {
        return new EcoTourismPassport(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

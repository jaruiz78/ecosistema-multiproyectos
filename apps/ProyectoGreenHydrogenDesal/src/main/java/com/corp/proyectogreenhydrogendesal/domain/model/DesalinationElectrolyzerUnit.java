...
/**
 * Entidad de Dominio Puro: DesalinationElectrolyzerUnit.
 * 
 ...
 */
public record DesalinationElectrolyzerUnit(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DesalinationElectrolyzerUnit {
    ...
    public DesalinationElectrolyzerUnit withStatus(String newStatus) {
        return new DesalinationElectrolyzerUnit(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

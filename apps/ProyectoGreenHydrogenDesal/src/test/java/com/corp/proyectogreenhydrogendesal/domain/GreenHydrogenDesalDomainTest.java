...
class GreenHydrogenDesalDomainTest {

    @Test
    @DisplayName("Debe crear la entidad GreenHydrogenDesal con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new GreenHydrogenDesal(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

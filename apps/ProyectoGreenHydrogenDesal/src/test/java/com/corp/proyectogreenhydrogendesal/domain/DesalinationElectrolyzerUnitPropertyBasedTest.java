...
class DesalinationElectrolyzerUnitPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DesalinationElectrolyzerUnit entity = new DesalinationElectrolyzerUnit(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DesalinationElectrolyzerUnit(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

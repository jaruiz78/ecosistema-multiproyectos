package com.corp.proyectozkplonkproofofsolvency.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PlonkProofOfSolvencyAuditToken.
 * 
 ...
 */
public record PlonkProofOfSolvencyAuditToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PlonkProofOfSolvencyAuditToken {
    ...
    public PlonkProofOfSolvencyAuditToken withStatus(String newStatus) {
        return new PlonkProofOfSolvencyAuditToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

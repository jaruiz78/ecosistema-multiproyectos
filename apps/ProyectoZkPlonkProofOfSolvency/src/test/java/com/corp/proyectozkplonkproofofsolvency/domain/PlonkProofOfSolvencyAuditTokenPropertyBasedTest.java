package com.corp.proyectozkplonkproofofsolvency.domain;
...
class PlonkProofOfSolvencyAuditTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PlonkProofOfSolvencyAuditToken entity = new PlonkProofOfSolvencyAuditToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PlonkProofOfSolvencyAuditToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

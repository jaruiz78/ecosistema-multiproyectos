package com.corp.proyectofusionplasmatokamaktwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PlasmaMhdMagneticFluxNode.
 * 
 ...
 */
public record PlasmaMhdMagneticFluxNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PlasmaMhdMagneticFluxNode {
    ...
    public PlasmaMhdMagneticFluxNode withStatus(String newStatus) {
        return new PlasmaMhdMagneticFluxNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

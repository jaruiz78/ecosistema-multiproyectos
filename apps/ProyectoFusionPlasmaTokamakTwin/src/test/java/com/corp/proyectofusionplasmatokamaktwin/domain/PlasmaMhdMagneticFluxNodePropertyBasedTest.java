package com.corp.proyectofusionplasmatokamaktwin.domain;
...
class PlasmaMhdMagneticFluxNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PlasmaMhdMagneticFluxNode entity = new PlasmaMhdMagneticFluxNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PlasmaMhdMagneticFluxNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

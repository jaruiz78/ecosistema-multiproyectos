package com.corp.proyectohoteltwinrevpar.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HotelTwinRevPAR.
...
public record HotelTwinRevPAR(
    ...
    public HotelTwinRevPAR withStatus(String newStatus) {
        return new HotelTwinRevPAR(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoquantumsatellitesync.domain;
...
class QuantumSatelliteSyncDomainTest {

    @Test
    @DisplayName("Debe crear la entidad QuantumSatelliteSync con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new QuantumSatelliteSync(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

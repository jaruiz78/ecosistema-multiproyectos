package com.corp.proyectoagroenergyvpp.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AgroEnergyVPP.
...
public record AgroEnergyVPP(
    ...
    public AgroEnergyVPP withStatus(String newStatus) {
        return new AgroEnergyVPP(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

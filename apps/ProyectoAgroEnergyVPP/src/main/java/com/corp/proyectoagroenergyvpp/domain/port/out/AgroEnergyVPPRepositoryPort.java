package com.corp.proyectoagroenergyvpp.domain.port.out;
 ...
 */
public interface AgroEnergyVPPRepositoryPort {
    AgroEnergyVPP save(AgroEnergyVPP entity);
    Optional<AgroEnergyVPP> findById(String id, String tenantId);
}

package com.corp.proyectoagroenergyvpp.domain;
...
class AgroEnergyVPPDomainTest {

    @Test
    @DisplayName("Debe crear la entidad AgroEnergyVPP con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new AgroEnergyVPP(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

package com.corp.proyectogovprocurematch.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GovProcureMatch.
...
public record GovProcureMatch(
    ...
    public GovProcureMatch withStatus(String newStatus) {
        return new GovProcureMatch(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoecosystemdatamarketplace.domain;
...
class DataAssetContractTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DataAssetContractToken entity = new DataAssetContractToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DataAssetContractToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

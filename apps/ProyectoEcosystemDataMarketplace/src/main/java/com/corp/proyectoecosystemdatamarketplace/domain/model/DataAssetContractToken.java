package com.corp.proyectoecosystemdatamarketplace.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DataAssetContractToken.
 * 
 ...
 */
public record DataAssetContractToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DataAssetContractToken withStatus(String newStatus) {
        return new DataAssetContractToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

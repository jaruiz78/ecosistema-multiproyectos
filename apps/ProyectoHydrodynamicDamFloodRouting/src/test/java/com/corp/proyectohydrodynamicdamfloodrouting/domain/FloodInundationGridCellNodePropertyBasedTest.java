...
class FloodInundationGridCellNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            FloodInundationGridCellNode entity = new FloodInundationGridCellNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new FloodInundationGridCellNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

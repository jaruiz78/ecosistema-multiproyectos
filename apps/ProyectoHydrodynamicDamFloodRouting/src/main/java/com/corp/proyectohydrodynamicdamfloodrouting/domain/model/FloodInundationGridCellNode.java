package com.corp.proyectohydrodynamicdamfloodrouting.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: FloodInundationGridCellNode.
 * 
 ...
 */
public record FloodInundationGridCellNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public FloodInundationGridCellNode {
    ...
    public FloodInundationGridCellNode withStatus(String newStatus) {
        return new FloodInundationGridCellNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoHydrodynamicDamFloodRouting

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoHydrodynamicDamFloodRouting
* **Entidad Dominio**: FloodInundationGridCellNode
* **Descripción**: Modelizacion Hidrodinamica 2D de Rotura de Presas y Propagacion de Ondas de Crecida

package com.corp.proyectospaceisltelecommunications.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SpaceSatelliteIslNode.
 * 
 ...
 */
public record SpaceSatelliteIslNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SpaceSatelliteIslNode withStatus(String newStatus) {
        return new SpaceSatelliteIslNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

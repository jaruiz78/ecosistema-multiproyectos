package com.corp.proyectospaceisltelecommunications.domain;
...
class SpaceSatelliteIslNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SpaceSatelliteIslNode entity = new SpaceSatelliteIslNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SpaceSatelliteIslNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

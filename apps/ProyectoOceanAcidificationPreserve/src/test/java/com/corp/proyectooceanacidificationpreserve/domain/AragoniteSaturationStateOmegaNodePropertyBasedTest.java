...
class AragoniteSaturationStateOmegaNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AragoniteSaturationStateOmegaNode entity = new AragoniteSaturationStateOmegaNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AragoniteSaturationStateOmegaNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

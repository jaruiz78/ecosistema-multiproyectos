package com.corp.proyectooceanacidificationpreserve.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AragoniteSaturationStateOmegaNode.
 * 
 ...
 */
public record AragoniteSaturationStateOmegaNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AragoniteSaturationStateOmegaNode {
    ...
    public AragoniteSaturationStateOmegaNode withStatus(String newStatus) {
        return new AragoniteSaturationStateOmegaNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoOceanAcidificationPreserve

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoOceanAcidificationPreserve
* **Entidad Dominio**: AragoniteSaturationStateOmegaNode
* **Descripción**: Alerta Temprana de Acidificacion Oceanica y Proteccion de Marisqueo

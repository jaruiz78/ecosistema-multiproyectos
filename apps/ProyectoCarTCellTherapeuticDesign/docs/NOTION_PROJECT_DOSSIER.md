# 🏛️ NOTION DOSSIER: ProyectoCarTCellTherapeuticDesign

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCarTCellTherapeuticDesign
* **Entidad Dominio**: CarTScfvBindingAffinityToken
* **Descripción**: Inmunoterapia de Precision y Modelado Celular CAR-T

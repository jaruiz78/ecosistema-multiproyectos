package com.corp.proyectocartcelltherapeuticdesign.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CarTScfvBindingAffinityToken.
 * 
 ...
 */
public record CarTScfvBindingAffinityToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CarTScfvBindingAffinityToken {
    ...
    public CarTScfvBindingAffinityToken withStatus(String newStatus) {
        return new CarTScfvBindingAffinityToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

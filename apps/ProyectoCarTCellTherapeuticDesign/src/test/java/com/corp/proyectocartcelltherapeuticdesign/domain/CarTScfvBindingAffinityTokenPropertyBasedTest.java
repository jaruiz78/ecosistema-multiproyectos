package com.corp.proyectocartcelltherapeuticdesign.domain;
...
class CarTScfvBindingAffinityTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CarTScfvBindingAffinityToken entity = new CarTScfvBindingAffinityToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CarTScfvBindingAffinityToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

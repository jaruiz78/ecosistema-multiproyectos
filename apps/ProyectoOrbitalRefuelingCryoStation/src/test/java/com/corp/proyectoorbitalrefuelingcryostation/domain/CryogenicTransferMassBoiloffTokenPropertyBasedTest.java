package com.corp.proyectoorbitalrefuelingcryostation.domain;
...
class CryogenicTransferMassBoiloffTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CryogenicTransferMassBoiloffToken entity = new CryogenicTransferMassBoiloffToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CryogenicTransferMassBoiloffToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

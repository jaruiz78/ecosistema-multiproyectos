package com.corp.proyectoorbitalrefuelingcryostation.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CryogenicTransferMassBoiloffToken.
 * 
 ...
 */
public record CryogenicTransferMassBoiloffToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CryogenicTransferMassBoiloffToken {
    ...
    public CryogenicTransferMassBoiloffToken withStatus(String newStatus) {
        return new CryogenicTransferMassBoiloffToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

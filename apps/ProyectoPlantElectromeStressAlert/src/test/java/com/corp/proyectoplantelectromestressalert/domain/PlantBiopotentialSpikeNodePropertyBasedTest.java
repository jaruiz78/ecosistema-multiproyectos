package com.corp.proyectoplantelectromestressalert.domain;
...
class PlantBiopotentialSpikeNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PlantBiopotentialSpikeNode entity = new PlantBiopotentialSpikeNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PlantBiopotentialSpikeNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

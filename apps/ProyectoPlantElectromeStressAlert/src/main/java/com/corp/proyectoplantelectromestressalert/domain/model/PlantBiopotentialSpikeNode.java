package com.corp.proyectoplantelectromestressalert.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PlantBiopotentialSpikeNode.
 * 
 ...
 */
public record PlantBiopotentialSpikeNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PlantBiopotentialSpikeNode {
    ...
    public PlantBiopotentialSpikeNode withStatus(String newStatus) {
        return new PlantBiopotentialSpikeNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

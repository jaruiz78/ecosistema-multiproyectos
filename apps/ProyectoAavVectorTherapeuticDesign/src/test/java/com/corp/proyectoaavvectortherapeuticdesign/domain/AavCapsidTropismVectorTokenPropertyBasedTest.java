package com.corp.proyectoaavvectortherapeuticdesign.domain;
...
class AavCapsidTropismVectorTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AavCapsidTropismVectorToken entity = new AavCapsidTropismVectorToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AavCapsidTropismVectorToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoaavvectortherapeuticdesign.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AavCapsidTropismVectorToken.
 * 
 ...
 */
public record AavCapsidTropismVectorToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AavCapsidTropismVectorToken {
    ...
    public AavCapsidTropismVectorToken withStatus(String newStatus) {
        return new AavCapsidTropismVectorToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

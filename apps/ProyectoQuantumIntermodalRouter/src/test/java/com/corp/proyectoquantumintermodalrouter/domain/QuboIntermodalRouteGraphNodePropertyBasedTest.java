package com.corp.proyectoquantumintermodalrouter.domain;
...
class QuboIntermodalRouteGraphNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            QuboIntermodalRouteGraphNode entity = new QuboIntermodalRouteGraphNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new QuboIntermodalRouteGraphNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

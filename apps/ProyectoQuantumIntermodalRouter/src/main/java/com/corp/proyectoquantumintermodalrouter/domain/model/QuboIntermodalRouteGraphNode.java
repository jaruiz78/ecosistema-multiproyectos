package com.corp.proyectoquantumintermodalrouter.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: QuboIntermodalRouteGraphNode.
 * 
 ...
 */
public record QuboIntermodalRouteGraphNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public QuboIntermodalRouteGraphNode {
    ...
    public QuboIntermodalRouteGraphNode withStatus(String newStatus) {
        return new QuboIntermodalRouteGraphNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

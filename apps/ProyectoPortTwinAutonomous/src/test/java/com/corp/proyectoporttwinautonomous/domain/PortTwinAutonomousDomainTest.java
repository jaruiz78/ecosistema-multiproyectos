package com.corp.proyectoporttwinautonomous.domain;
...
class PortTwinAutonomousDomainTest {

    @Test
    @DisplayName("Debe crear la entidad PortTwinAutonomous con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new PortTwinAutonomous(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

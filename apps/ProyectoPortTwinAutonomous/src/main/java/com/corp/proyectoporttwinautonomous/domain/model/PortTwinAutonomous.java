package com.corp.proyectoporttwinautonomous.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PortTwinAutonomous.
 ...
 */
public record PortTwinAutonomous(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PortTwinAutonomous withStatus(String newStatus) {
        return new PortTwinAutonomous(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

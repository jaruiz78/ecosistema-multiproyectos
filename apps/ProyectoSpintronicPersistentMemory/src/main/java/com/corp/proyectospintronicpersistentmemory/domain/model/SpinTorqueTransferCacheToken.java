package com.corp.proyectospintronicpersistentmemory.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SpinTorqueTransferCacheToken.
 * 
 ...
 */
public record SpinTorqueTransferCacheToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SpinTorqueTransferCacheToken {
    ...
    public SpinTorqueTransferCacheToken withStatus(String newStatus) {
        return new SpinTorqueTransferCacheToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

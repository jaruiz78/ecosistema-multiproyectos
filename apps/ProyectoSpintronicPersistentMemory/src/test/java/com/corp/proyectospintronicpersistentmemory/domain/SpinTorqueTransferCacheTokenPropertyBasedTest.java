package com.corp.proyectospintronicpersistentmemory.domain;
...
class SpinTorqueTransferCacheTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SpinTorqueTransferCacheToken entity = new SpinTorqueTransferCacheToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SpinTorqueTransferCacheToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

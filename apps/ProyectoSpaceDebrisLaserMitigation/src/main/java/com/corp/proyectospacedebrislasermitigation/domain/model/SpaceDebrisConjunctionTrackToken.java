package com.corp.proyectospacedebrislasermitigation.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SpaceDebrisConjunctionTrackToken.
 * 
 ...
 */
public record SpaceDebrisConjunctionTrackToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SpaceDebrisConjunctionTrackToken {
    ...
    public SpaceDebrisConjunctionTrackToken withStatus(String newStatus) {
        return new SpaceDebrisConjunctionTrackToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

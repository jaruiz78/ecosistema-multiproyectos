package com.corp.proyectospacedebrislasermitigation.domain;
...
class SpaceDebrisConjunctionTrackTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SpaceDebrisConjunctionTrackToken entity = new SpaceDebrisConjunctionTrackToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SpaceDebrisConjunctionTrackToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectocoastalclifferosiondefense.domain;
...
class CliffRetreatErosionRateNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CliffRetreatErosionRateNode entity = new CliffRetreatErosionRateNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CliffRetreatErosionRateNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectocoastalclifferosiondefense.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CliffRetreatErosionRateNode.
 * 
 ...
 */
public record CliffRetreatErosionRateNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CliffRetreatErosionRateNode {
    ...
    public CliffRetreatErosionRateNode withStatus(String newStatus) {
        return new CliffRetreatErosionRateNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

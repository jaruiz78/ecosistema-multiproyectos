# 🏛️ NOTION DOSSIER: ProyectoCoastalCliffErosionDefense

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCoastalCliffErosionDefense
* **Entidad Dominio**: CliffRetreatErosionRateNode
* **Descripción**: Geomecanica de Erosion de Acantilados y Proteccion de Paseos Maritimos

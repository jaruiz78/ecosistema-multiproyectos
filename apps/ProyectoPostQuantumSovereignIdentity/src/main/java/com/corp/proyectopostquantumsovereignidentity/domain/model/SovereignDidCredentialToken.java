package com.corp.proyectopostquantumsovereignidentity.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SovereignDidCredentialToken.
 * 
 ...
 */
public record SovereignDidCredentialToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SovereignDidCredentialToken {
    ...
    public SovereignDidCredentialToken withStatus(String newStatus) {
        return new SovereignDidCredentialToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectopostquantumsovereignidentity.domain;
...
class SovereignDidCredentialTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SovereignDidCredentialToken entity = new SovereignDidCredentialToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SovereignDidCredentialToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

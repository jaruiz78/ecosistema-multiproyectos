...
class V2GChargingDispatchNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            V2GChargingDispatchNode entity = new V2GChargingDispatchNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new V2GChargingDispatchNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

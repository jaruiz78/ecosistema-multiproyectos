package com.corp.proyectourbanenergymobilitynexus.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: V2GChargingDispatchNode.
 * 
 ...
 */
public record V2GChargingDispatchNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public V2GChargingDispatchNode {
    ...
    public V2GChargingDispatchNode withStatus(String newStatus) {
        return new V2GChargingDispatchNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

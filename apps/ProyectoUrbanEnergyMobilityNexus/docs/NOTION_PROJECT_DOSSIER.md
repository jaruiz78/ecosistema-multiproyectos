# 🏛️ NOTION DOSSIER: ProyectoUrbanEnergyMobilityNexus

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoUrbanEnergyMobilityNexus
* **Entidad Dominio**: V2GChargingDispatchNode
* **Descripción**: Orquestador de Nexo Urbano Energia-Movilidad V2G y Microredes Hoteleras

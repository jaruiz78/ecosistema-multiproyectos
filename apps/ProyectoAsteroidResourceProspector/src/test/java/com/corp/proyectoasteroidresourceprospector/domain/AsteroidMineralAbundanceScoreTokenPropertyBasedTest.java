package com.corp.proyectoasteroidresourceprospector.domain;
...
class AsteroidMineralAbundanceScoreTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            AsteroidMineralAbundanceScoreToken entity = new AsteroidMineralAbundanceScoreToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new AsteroidMineralAbundanceScoreToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

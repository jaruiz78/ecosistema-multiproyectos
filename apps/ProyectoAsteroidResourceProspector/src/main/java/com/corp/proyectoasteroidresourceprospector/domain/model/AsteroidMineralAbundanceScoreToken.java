package com.corp.proyectoasteroidresourceprospector.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: AsteroidMineralAbundanceScoreToken.
 * 
 ...
 */
public record AsteroidMineralAbundanceScoreToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AsteroidMineralAbundanceScoreToken {
    ...
    public AsteroidMineralAbundanceScoreToken withStatus(String newStatus) {
        return new AsteroidMineralAbundanceScoreToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

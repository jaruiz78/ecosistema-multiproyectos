package com.corp.proyectopresatwinscada.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DamTelemetrySensorNode.
 * 
 ...
 */
public record DamTelemetrySensorNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DamTelemetrySensorNode withStatus(String newStatus) {
        return new DamTelemetrySensorNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

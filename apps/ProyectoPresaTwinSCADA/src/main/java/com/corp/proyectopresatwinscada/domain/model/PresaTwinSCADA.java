...
/**
 * Entidad de Dominio Puro: PresaTwinSCADA.
...
public record PresaTwinSCADA(
    ...
    public PresaTwinSCADA withStatus(String newStatus) {
        return new PresaTwinSCADA(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

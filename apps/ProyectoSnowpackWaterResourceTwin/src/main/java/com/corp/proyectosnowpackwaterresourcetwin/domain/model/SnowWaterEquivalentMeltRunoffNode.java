package com.corp.proyectosnowpackwaterresourcetwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SnowWaterEquivalentMeltRunoffNode.
 * 
 ...
 */
public record SnowWaterEquivalentMeltRunoffNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SnowWaterEquivalentMeltRunoffNode {
    ...
    public SnowWaterEquivalentMeltRunoffNode withStatus(String newStatus) {
        return new SnowWaterEquivalentMeltRunoffNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

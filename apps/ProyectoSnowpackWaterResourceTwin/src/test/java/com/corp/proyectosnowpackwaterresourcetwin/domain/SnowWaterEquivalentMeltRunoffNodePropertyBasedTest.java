package com.corp.proyectosnowpackwaterresourcetwin.domain;
...
class SnowWaterEquivalentMeltRunoffNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            SnowWaterEquivalentMeltRunoffNode entity = new SnowWaterEquivalentMeltRunoffNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new SnowWaterEquivalentMeltRunoffNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

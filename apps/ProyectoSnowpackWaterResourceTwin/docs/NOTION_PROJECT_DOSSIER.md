# 🏛️ NOTION DOSSIER: ProyectoSnowpackWaterResourceTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoSnowpackWaterResourceTwin
* **Entidad Dominio**: SnowWaterEquivalentMeltRunoffNode
* **Descripción**: Prediccion de Recursos Hidricos Nocionales y Caudal de Deshielo

...
class ShamirPqcKeyShardBundleTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ShamirPqcKeyShardBundleToken entity = new ShamirPqcKeyShardBundleToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ShamirPqcKeyShardBundleToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

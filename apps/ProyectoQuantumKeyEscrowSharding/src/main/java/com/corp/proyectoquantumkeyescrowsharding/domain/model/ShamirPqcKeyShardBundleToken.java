package com.corp.proyectoquantumkeyescrowsharding.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ShamirPqcKeyShardBundleToken.
 * 
 ...
 */
public record ShamirPqcKeyShardBundleToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ShamirPqcKeyShardBundleToken {
    ...
    public ShamirPqcKeyShardBundleToken withStatus(String newStatus) {
        return new ShamirPqcKeyShardBundleToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

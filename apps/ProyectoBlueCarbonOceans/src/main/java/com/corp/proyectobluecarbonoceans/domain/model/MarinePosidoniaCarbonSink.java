package com.corp.proyectobluecarbonoceans.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MarinePosidoniaCarbonSink.
 * 
 ...
 */
public record MarinePosidoniaCarbonSink(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MarinePosidoniaCarbonSink {
    ...
    public MarinePosidoniaCarbonSink withStatus(String newStatus) {
        return new MarinePosidoniaCarbonSink(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

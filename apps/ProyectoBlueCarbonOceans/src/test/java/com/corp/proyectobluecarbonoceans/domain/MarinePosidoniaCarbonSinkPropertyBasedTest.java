...
class MarinePosidoniaCarbonSinkPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MarinePosidoniaCarbonSink entity = new MarinePosidoniaCarbonSink(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MarinePosidoniaCarbonSink(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoastroturismostarlight.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: StarlightObservationPoint.
 * 
 ...
 */
public record StarlightObservationPoint(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public StarlightObservationPoint {
    ...
    public StarlightObservationPoint withStatus(String newStatus) {
        return new StarlightObservationPoint(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

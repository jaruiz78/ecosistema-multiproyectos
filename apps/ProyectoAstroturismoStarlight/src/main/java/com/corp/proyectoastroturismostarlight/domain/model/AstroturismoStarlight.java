...
/**
 * Entidad de Dominio Puro: AstroturismoStarlight.
 ...
 */
public record AstroturismoStarlight(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public AstroturismoStarlight withStatus(String newStatus) {
        return new AstroturismoStarlight(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

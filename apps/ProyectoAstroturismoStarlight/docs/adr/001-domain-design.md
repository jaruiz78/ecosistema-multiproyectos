# ADR 001: Domain Architecture for ProyectoAstroturismoStarlight
**Date:** 2026-08-15
**Status:** Approved by Consilium Romano

## Context
Se requiere cerrar la brecha funcional de `ProyectoAstroturismoStarlight` implementando lógica asintótica en O(1) u O(N log N) e inyección de arquitectura hexagonal pura.

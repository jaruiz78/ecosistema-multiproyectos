# 🏛️ NOTION DOSSIER: ProyectoTourismCarryingCapacityTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoTourismCarryingCapacityTwin
* **Entidad Dominio**: EcologicalCarryingCapacityAlertNode
* **Descripción**: Gemelo Digital de Capacidad de Carga Ecologica y Gestion de Sobreturismo en Destinos

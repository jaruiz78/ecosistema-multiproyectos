package com.corp.proyectotourismcarryingcapacitytwin.domain;
...
class EcologicalCarryingCapacityAlertNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EcologicalCarryingCapacityAlertNode entity = new EcologicalCarryingCapacityAlertNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EcologicalCarryingCapacityAlertNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

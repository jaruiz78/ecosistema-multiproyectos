package com.corp.proyectotourismcarryingcapacitytwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EcologicalCarryingCapacityAlertNode.
 * 
 ...
 */
public record EcologicalCarryingCapacityAlertNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EcologicalCarryingCapacityAlertNode {
    ...
    public EcologicalCarryingCapacityAlertNode withStatus(String newStatus) {
        return new EcologicalCarryingCapacityAlertNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

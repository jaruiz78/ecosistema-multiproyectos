package com.corp.proyectodenovoproteinenzymedesign.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EnzymaticBiocatalystDesignToken.
 * 
 ...
 */
public record EnzymaticBiocatalystDesignToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EnzymaticBiocatalystDesignToken {
    ...
    public EnzymaticBiocatalystDesignToken withStatus(String newStatus) {
        return new EnzymaticBiocatalystDesignToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

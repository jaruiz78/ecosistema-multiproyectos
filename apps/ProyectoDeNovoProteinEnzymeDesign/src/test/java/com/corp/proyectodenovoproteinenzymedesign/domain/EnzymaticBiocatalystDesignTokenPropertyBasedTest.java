...
class EnzymaticBiocatalystDesignTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EnzymaticBiocatalystDesignToken entity = new EnzymaticBiocatalystDesignToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EnzymaticBiocatalystDesignToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

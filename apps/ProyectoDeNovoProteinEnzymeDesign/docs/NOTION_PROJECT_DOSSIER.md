# 🏛️ NOTION DOSSIER: ProyectoDeNovoProteinEnzymeDesign

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoDeNovoProteinEnzymeDesign
* **Entidad Dominio**: EnzymaticBiocatalystDesignToken
* **Descripción**: Diseno Computacional De Novo de Enzimas y Biocatalizadores para Biorrefinerias

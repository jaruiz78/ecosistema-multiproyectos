 ...
 * Verifica invariantes y comportamiento de AgriSupplyTrack sin dependencias externas.
 */
class AgriSupplyTrackDomainTest {
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new AgriSupplyTrack(
            "item-002",
            "tenant-alpha",
            "Invalid Asset",
            -10.0,

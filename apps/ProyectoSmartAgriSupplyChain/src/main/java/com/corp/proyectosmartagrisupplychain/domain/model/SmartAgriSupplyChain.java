package com.corp.proyectosmartagrisupplychain.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SmartAgriSupplyChain.
 ...
 */
public record SmartAgriSupplyChain(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SmartAgriSupplyChain withStatus(String newStatus) {
        return new SmartAgriSupplyChain(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

...
/**
 * Entidad de Dominio Puro: AgriSupplyTrack.
 * 
...
public record AgriSupplyTrack(
    ...
    public AgriSupplyTrack withStatus(String newStatus) {
        return new AgriSupplyTrack(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

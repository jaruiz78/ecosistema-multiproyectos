# 🏛️ NOTION DOSSIER: ProyectoElectronicBillOfLadingEpcis

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoElectronicBillOfLadingEpcis
* **Entidad Dominio**: EpcisShippingEventRecordToken
* **Descripción**: Conocimientos de Embarque Maritimo y Aduanero Digitales eBL

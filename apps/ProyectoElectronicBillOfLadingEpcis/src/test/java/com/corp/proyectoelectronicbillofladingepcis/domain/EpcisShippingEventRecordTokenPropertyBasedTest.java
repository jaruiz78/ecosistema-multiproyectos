package com.corp.proyectoelectronicbillofladingepcis.domain;
...
class EpcisShippingEventRecordTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            EpcisShippingEventRecordToken entity = new EpcisShippingEventRecordToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new EpcisShippingEventRecordToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

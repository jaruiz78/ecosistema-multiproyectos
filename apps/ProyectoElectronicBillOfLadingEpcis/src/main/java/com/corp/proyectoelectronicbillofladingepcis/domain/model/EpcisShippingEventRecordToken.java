package com.corp.proyectoelectronicbillofladingepcis.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: EpcisShippingEventRecordToken.
 * 
 ...
 */
public record EpcisShippingEventRecordToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public EpcisShippingEventRecordToken {
    ...
    public EpcisShippingEventRecordToken withStatus(String newStatus) {
        return new EpcisShippingEventRecordToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

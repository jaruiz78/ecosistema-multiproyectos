package com.corp.proyectozerotrustotmesh.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ZeroTrustOTMesh.
...
public record ZeroTrustOTMesh(
    ...
    public ZeroTrustOTMesh withStatus(String newStatus) {
        return new ZeroTrustOTMesh(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

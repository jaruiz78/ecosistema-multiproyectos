package com.corp.proyectomarinebioacousticssonar.domain;
...
class HydrophoneAcousticPulseNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            HydrophoneAcousticPulseNode entity = new HydrophoneAcousticPulseNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new HydrophoneAcousticPulseNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectomarinebioacousticssonar.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: HydrophoneAcousticPulseNode.
 * 
 ...
 */
public record HydrophoneAcousticPulseNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public HydrophoneAcousticPulseNode {
    ...
    public HydrophoneAcousticPulseNode withStatus(String newStatus) {
        return new HydrophoneAcousticPulseNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

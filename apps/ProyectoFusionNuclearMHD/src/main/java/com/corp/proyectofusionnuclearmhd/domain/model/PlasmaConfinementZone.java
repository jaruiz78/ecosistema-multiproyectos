package com.corp.proyectofusionnuclearmhd.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: PlasmaConfinementZone.
 * 
 ...
 */
public record PlasmaConfinementZone(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public PlasmaConfinementZone withStatus(String newStatus) {
        return new PlasmaConfinementZone(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

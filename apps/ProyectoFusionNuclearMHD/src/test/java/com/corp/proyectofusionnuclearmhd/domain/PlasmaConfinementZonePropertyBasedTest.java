package com.corp.proyectofusionnuclearmhd.domain;
...
class PlasmaConfinementZonePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            PlasmaConfinementZone entity = new PlasmaConfinementZone(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new PlasmaConfinementZone(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectospaceweathergriddefense.domain;
...
class GicTransformerNeutralCurrentAlertNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            GicTransformerNeutralCurrentAlertNode entity = new GicTransformerNeutralCurrentAlertNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new GicTransformerNeutralCurrentAlertNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

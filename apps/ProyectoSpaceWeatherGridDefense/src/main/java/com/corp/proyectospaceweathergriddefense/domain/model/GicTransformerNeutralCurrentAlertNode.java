package com.corp.proyectospaceweathergriddefense.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GicTransformerNeutralCurrentAlertNode.
 * 
 ...
 */
public record GicTransformerNeutralCurrentAlertNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public GicTransformerNeutralCurrentAlertNode {
    ...
    public GicTransformerNeutralCurrentAlertNode withStatus(String newStatus) {
        return new GicTransformerNeutralCurrentAlertNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

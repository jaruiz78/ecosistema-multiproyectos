...
class DistrictThermalSubstationNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DistrictThermalSubstationNode entity = new DistrictThermalSubstationNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DistrictThermalSubstationNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

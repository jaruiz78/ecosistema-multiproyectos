package com.corp.proyectodistrictheatingcoolingtwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: DistrictThermalSubstationNode.
 * 
 ...
 */
public record DistrictThermalSubstationNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DistrictThermalSubstationNode {
    ...
    public DistrictThermalSubstationNode withStatus(String newStatus) {
        return new DistrictThermalSubstationNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

# 🏛️ NOTION DOSSIER: ProyectoDistrictHeatingCoolingTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoDistrictHeatingCoolingTwin
* **Entidad Dominio**: DistrictThermalSubstationNode
* **Descripción**: Gemelo Digital de Redes Termicas Urbanas de 5a Generacion (5GDHC) para Paradores y Ciudades

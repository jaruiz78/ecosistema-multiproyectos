...
class DestinationCapacityZonePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            DestinationCapacityZone entity = new DestinationCapacityZone(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new DestinationCapacityZone(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

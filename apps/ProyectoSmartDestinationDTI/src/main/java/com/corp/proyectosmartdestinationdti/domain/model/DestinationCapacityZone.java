...
/**
 * Entidad de Dominio Puro: DestinationCapacityZone.
 * 
 ...
 */
public record DestinationCapacityZone(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public DestinationCapacityZone {
    ...
    public DestinationCapacityZone withStatus(String newStatus) {
        return new DestinationCapacityZone(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

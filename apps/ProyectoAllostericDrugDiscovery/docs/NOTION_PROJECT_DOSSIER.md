# 🏛️ NOTION DOSSIER: ProyectoAllostericDrugDiscovery

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoAllostericDrugDiscovery
* **Entidad Dominio**: CrypticBindingPocketVolumeToken
* **Descripción**: Descubrimiento de Farmacos Alostericos de Alta Selectividad

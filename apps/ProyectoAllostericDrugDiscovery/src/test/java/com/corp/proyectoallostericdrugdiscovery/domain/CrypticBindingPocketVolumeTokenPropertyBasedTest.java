package com.corp.proyectoallostericdrugdiscovery.domain;
...
class CrypticBindingPocketVolumeTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            CrypticBindingPocketVolumeToken entity = new CrypticBindingPocketVolumeToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new CrypticBindingPocketVolumeToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

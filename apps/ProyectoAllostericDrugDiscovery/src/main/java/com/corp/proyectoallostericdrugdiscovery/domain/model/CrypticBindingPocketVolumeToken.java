package com.corp.proyectoallostericdrugdiscovery.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CrypticBindingPocketVolumeToken.
 * 
 ...
 */
public record CrypticBindingPocketVolumeToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CrypticBindingPocketVolumeToken {
    ...
    public CrypticBindingPocketVolumeToken withStatus(String newStatus) {
        return new CrypticBindingPocketVolumeToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

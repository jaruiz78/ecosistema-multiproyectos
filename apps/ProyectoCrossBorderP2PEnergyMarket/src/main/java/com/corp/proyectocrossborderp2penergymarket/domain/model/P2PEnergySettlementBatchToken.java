package com.corp.proyectocrossborderp2penergymarket.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: P2PEnergySettlementBatchToken.
 * 
 ...
 */
public record P2PEnergySettlementBatchToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public P2PEnergySettlementBatchToken {
    ...
    public P2PEnergySettlementBatchToken withStatus(String newStatus) {
        return new P2PEnergySettlementBatchToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

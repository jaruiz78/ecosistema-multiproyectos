# 🏛️ NOTION DOSSIER: ProyectoMantleGeodynamicsSimulator

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoMantleGeodynamicsSimulator
* **Entidad Dominio**: MantlePlumeThermalUpwellingNode
* **Descripción**: Simulacion Geodinamica de Conveccion Mantélica y Tectonica de Placas

package com.corp.proyectomantlegeodynamicssimulator.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: MantlePlumeThermalUpwellingNode.
 * 
 ...
 */
public record MantlePlumeThermalUpwellingNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public MantlePlumeThermalUpwellingNode {
    ...
    public MantlePlumeThermalUpwellingNode withStatus(String newStatus) {
        return new MantlePlumeThermalUpwellingNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

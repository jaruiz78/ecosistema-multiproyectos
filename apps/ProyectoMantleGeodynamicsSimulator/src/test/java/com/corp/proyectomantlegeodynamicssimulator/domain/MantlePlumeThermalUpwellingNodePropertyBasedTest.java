package com.corp.proyectomantlegeodynamicssimulator.domain;
...
class MantlePlumeThermalUpwellingNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MantlePlumeThermalUpwellingNode entity = new MantlePlumeThermalUpwellingNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new MantlePlumeThermalUpwellingNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

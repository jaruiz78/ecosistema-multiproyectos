# 🏛️ NOTION DOSSIER: ProyectoCircular

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCircular
* **Entidad Dominio**: Circular
* **Descripción**: Microservicio Vertical Especializado en Circular para el Ecosistema Corporativo.

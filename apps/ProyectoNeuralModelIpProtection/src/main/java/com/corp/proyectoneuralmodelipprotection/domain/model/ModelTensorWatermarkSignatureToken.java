package com.corp.proyectoneuralmodelipprotection.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: ModelTensorWatermarkSignatureToken.
 * 
 ...
 */
public record ModelTensorWatermarkSignatureToken(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public ModelTensorWatermarkSignatureToken {
    ...
    public ModelTensorWatermarkSignatureToken withStatus(String newStatus) {
        return new ModelTensorWatermarkSignatureToken(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

package com.corp.proyectoneuralmodelipprotection.domain;
...
class ModelTensorWatermarkSignatureTokenPropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            ModelTensorWatermarkSignatureToken entity = new ModelTensorWatermarkSignatureToken(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new ModelTensorWatermarkSignatureToken(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

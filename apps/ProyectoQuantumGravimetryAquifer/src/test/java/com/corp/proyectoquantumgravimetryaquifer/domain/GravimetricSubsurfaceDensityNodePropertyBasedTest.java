package com.corp.proyectoquantumgravimetryaquifer.domain;
...
class GravimetricSubsurfaceDensityNodePropertyBasedTest {
    ...
    void propertyTestValidValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            GravimetricSubsurfaceDensityNode entity = new GravimetricSubsurfaceDensityNode(id, tenant, "Desc " + i, val, "ACTIVE", Instant.now());
    ...
    void propertyTestNegativeValues() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            assertThatThrownBy(() -> new GravimetricSubsurfaceDensityNode(id, "tenant-test", "Invalid", negVal, "ACTIVE", Instant.now()))

package com.corp.proyectoquantumgravimetryaquifer.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: GravimetricSubsurfaceDensityNode.
 * 
 ...
 */
public record GravimetricSubsurfaceDensityNode(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public GravimetricSubsurfaceDensityNode {
    ...
    public GravimetricSubsurfaceDensityNode withStatus(String newStatus) {
        return new GravimetricSubsurfaceDensityNode(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

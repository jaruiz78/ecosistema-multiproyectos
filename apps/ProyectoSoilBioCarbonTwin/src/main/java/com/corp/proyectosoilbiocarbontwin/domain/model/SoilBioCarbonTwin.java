package com.corp.proyectosoilbiocarbontwin.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: SoilBioCarbonTwin.
 ...
 */
public record SoilBioCarbonTwin(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public SoilBioCarbonTwin withStatus(String newStatus) {
        return new SoilBioCarbonTwin(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

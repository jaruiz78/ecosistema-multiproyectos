# 🏛️ NOTION DOSSIER: ProyectoSoilBioCarbonTwin

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoSoilBioCarbonTwin
* **Entidad Dominio**: SoilBioCarbonTwin
* **Descripción**: Microservicio Vertical Especializado en SoilBioCarbonTwin para el Ecosistema Corporativo.

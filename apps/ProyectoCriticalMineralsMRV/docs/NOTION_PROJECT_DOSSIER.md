# 🏛️ NOTION DOSSIER: ProyectoCriticalMineralsMRV

## 1. Visión y Resumen Ejecutivo
* **Nombre**: ProyectoCriticalMineralsMRV
* **Entidad Dominio**: CriticalMineralsMRV
* **Descripción**: Microservicio Vertical Especializado en CriticalMineralsMRV para el Ecosistema Corporativo.

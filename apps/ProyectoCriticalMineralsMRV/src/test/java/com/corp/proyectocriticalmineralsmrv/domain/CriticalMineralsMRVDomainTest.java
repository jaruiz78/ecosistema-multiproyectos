package com.corp.proyectocriticalmineralsmrv.domain;
...
class CriticalMineralsMRVDomainTest {

    @Test
    @DisplayName("Debe crear la entidad CriticalMineralsMRV con invariantes válidos")
    ...
    void shouldRejectNegativeValue() {
        assertThatThrownBy(() -> new CriticalMineralsMRV(
            "id-002",
            "tenant-alpha",
            "Asset Title",
            -5.0,

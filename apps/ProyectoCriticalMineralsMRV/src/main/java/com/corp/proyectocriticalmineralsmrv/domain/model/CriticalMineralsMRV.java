package com.corp.proyectocriticalmineralsmrv.domain.model;

import java.time.Instant;
import java.util.Objects;

/**
 * Entidad de Dominio Puro: CriticalMineralsMRV.
 ...
 */
public record CriticalMineralsMRV(
    String id,
    String tenantId,
    String title,
    double value,
    ...
    public CriticalMineralsMRV withStatus(String newStatus) {
        return new CriticalMineralsMRV(this.id, this.tenantId, this.title, this.value, newStatus, this.createdAt);
    }
}

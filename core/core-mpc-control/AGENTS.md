# AGENTS.md - Core Algorítmico core-mpc-control (Google Antigravity)
...
2. **Java 25 & Virtual Threads:** Records inmutables, exclusión mutua mediante `ReentrantLock`.
...
5. **Testing Estricto:** Zero-Mockito con JUnit 5.

# Notion Project Dossier: core-govtech-ledger (Libro Mayor Inmutable y Árboles de Merkle)
...
* **Stack Tecnológico**: Java 25 / SHA-256 Merkle Trees / RLS

---

## 2. Visión General y Objetivos de Negocio
Registro soberano inmutable de transacciones y contratos.

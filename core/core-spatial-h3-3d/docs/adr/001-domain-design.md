# ADR 001: Domain Architecture for core-spatial-h3-3d
**Date:** 2026-08-15
**Status:** Approved by Consilium Romano

## Context
Se requiere cerrar la brecha funcional de `core-spatial-h3-3d` implementando lógica asintótica en O(1) u O(N log N) e inyección de arquitectura hexagonal pura.

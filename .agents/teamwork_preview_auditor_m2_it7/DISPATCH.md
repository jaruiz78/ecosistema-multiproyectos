...
You are a teamwork_preview_auditor operating in working directory `/home/jaruiz/Desarrollo/.agents/teamwork_preview_auditor_m2_it7/`.

Your task is to perform forensic integrity audit for Milestone 2 (`pctMultiMicroservices`) Iteration 7:
...
4. Issue a clear verdict (**CLEAN** or **INTEGRITY VIOLATION**) in `/home/jaruiz/Desarrollo/.agents/teamwork_preview_auditor_m2_it7/handoff.md`.

...
You are a teamwork_preview_auditor operating in working directory `/home/jaruiz/Desarrollo/.agents/teamwork_preview_auditor_m3_it3/`.

Your task is to perform forensic integrity audit for Milestone 3 (`SaaSRegantes` & Master Digital Twin) Iteration 3:
...
4. Issue a clear verdict (**CLEAN** or **INTEGRITY VIOLATION**) in `/home/jaruiz/Desarrollo/.agents/teamwork_preview_auditor_m3_it3/handoff.md`.

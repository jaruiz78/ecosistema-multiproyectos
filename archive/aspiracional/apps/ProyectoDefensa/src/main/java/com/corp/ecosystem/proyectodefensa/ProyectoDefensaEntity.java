...
@Entity
@Table(name = "proyectodefensa_data")
public class ProyectoDefensaEntity {
    ...
    public ProyectoDefensaEntity() {}
    public ProyectoDefensaEntity(String tenantId, double predictiveScore) {

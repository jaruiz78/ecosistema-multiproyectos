...
@Entity
@Table(name = "proyectotokenrwa_data")
public class ProyectoTokenRWAEntity {
    ...
    public ProyectoTokenRWAEntity() {}
    public ProyectoTokenRWAEntity(String tenantId, double predictiveScore) {

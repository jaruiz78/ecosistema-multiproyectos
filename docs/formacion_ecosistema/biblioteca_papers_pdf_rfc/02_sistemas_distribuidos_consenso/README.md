# 🏛️ Facultad II: Sistemas Distribuidos, Consenso & TLA+
## *Cátedra de Fuentes Primarias (MIT 6.5840 / UC Berkeley)*

---

### 📖 1. Descripción de la Cátedra
Papers de Lamport (Paxos/Relojes), Ongaro (Raft), Fischer-Lynch-Paterson (FLP), Castro-Liskov (PBFT) y especificaciones TLA+.

# 🏛️ Facultad I: Ingeniería de Software, DDD Puro & Teoría de Tipos
## *Cátedra de Fuentes Primarias (CMU / Stanford)*

---

### 📖 1. Descripción de la Cátedra
Papers sobre Hexagonal Architecture, Type Theory, Algebraic Data Types, TDD y Formal Verification (Coq/Isabelle).

# 🏛️ Facultad XII: Seguridad de Cadena de Suministro & GitOps
## *Cátedra de Fuentes Primarias (OpenSSF / CNCF)*

---

### 📖 1. Descripción de la Cátedra
Especificaciones SLSA v1.0, Sigstore/Cosign Architecture, CycloneDX/SPDX SBOMs y GitOps Reconciliation (ArgoCD).

# 🏛️ Facultad III: Runtime JVM, Compilación AOT & Memoria
## *Cátedra de Fuentes Primarias (OpenJDK / ETH Zurich)*

---

### 📖 1. Descripción de la Cátedra
JEPs de OpenJDK (Valhalla, Loom, Leyden, Panama), Papers de Garbage Collection (ZGC, C4) y Java Memory Model (JMM).

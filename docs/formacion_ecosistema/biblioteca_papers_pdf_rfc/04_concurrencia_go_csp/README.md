# 🏛️ Facultad IV: Concurrencia Go, Runtime CSP & Algoritmia
## *Cátedra de Fuentes Primarias (ITMO / Peking University)*

---

### 📖 1. Descripción de la Cátedra
Papers de Hoare (CSP), Planificador Go M:N work-stealing, Lock-Free Ring Buffers (LMAX Disruptor) y análisis de escapes.
